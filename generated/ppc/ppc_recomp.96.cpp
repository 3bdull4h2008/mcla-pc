...
PPC_WEAK_FUNC(sub_824C3770) {
	__imp__sub_824C3770(ctx, base);
}
...
loc_824C3AFC:
	...
	simde_mm_store_ps(v43.f32, simde_mm_mul_ps(simde_mm_load_ps(v46.f32), simde_mm_load_ps(v44.f32)));
	// stvx128 v43,r0,r9
	...
	// stvx128 v56,r30,r27
	simde_mm_store_si128((simde__m128i*)(base + ((r30.u32 + r27.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v56.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// stvx128 v55,r30,r28
	simde_mm_store_si128((simde__m128i*)(base + ((r30.u32 + r28.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v55.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// stvx128 v59,r30,r5
	simde_mm_store_si128((simde__m128i*)(base + ((r30.u32 + ctx.r5.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v59.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lfs f2,336(r31)
	ctx.fpscr.disableFlushModeUnconditional();
	...
	// lvx128 v13,r26,r27
	simde_mm_store_si128((simde__m128i*)ctx.v13.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r26.u32 + r27.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v11,v41,2
	simde_mm_store_si128((simde__m128i*)ctx.v11.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v41.u32), 0x55));
	// lvx128 v39,r0,r11
	...
	simde_mm_store_ps(ctx.v10.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(v40.f32)));
	// lvx128 v38,r0,r10
	...
	// vspltw128 v9,v39,0
	simde_mm_store_si128((simde__m128i*)ctx.v9.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v39.u32), 0xFF));
	// lvx128 v37,r0,r9
	...
	// vspltw128 v7,v39,1
	simde_mm_store_si128((simde__m128i*)ctx.v7.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v39.u32), 0xAA));
	// vmaddfp v6,v0,v9,v8
	...
	// vspltw128 v5,v38,1
	simde_mm_store_si128((simde__m128i*)ctx.v5.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v38.u32), 0xAA));
	// vmulfp128 v4,v0,v36
	simde_mm_store_ps(ctx.v4.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(v36.f32)));
	// vspltw128 v3,v37,1
	simde_mm_store_si128((simde__m128i*)ctx.v3.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v37.u32), 0xAA));
	// vmulfp128 v2,v0,v35
	simde_mm_store_ps(ctx.v2.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(v35.f32)));
	// vspltw128 v1,v39,2
	simde_mm_store_si128((simde__m128i*)ctx.v1.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v39.u32), 0x55));
	// vspltw128 v31,v38,2
	simde_mm_store_si128((simde__m128i*)v31.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v38.u32), 0x55));
	// lvx128 v0,r26,r28
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r26.u32 + r28.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v30,v37,2
	simde_mm_store_si128((simde__m128i*)v30.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v37.u32), 0x55));
	...
	// stvx128 v25,r0,r30
	simde_mm_store_si128((simde__m128i*)(base + ((r30.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v25.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// stvx128 v24,r0,r11
...
loc_824C3D6C:
	...
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(v32.f32, simde_mm_add_ps(simde_mm_load_ps(v34.f32), simde_mm_load_ps(v33.f32)));
	// stvx128 v32,r0,r7
...
PPC_WEAK_FUNC(sub_824C37B8) {
	__imp__sub_824C37B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C3DAC) {
	__imp__sub_824C3DAC(ctx, base);
}
...
loc_824C3F6C:
	...
	simde_mm_store_si128((simde__m128i*)v56.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v60.u32), 0x51));
	// lfs f31,3796(r9)
	...
	ctx.fpscr.enableFlushModeUnconditional();
	simde_mm_store_ps(v53.f32, simde_mm_mul_ps(simde_mm_load_ps(v57.f32), simde_mm_load_ps(v54.f32)));
	// addi r11,r31,304
	r11.s64 = r31.s64 + 304;
	// stvx128 v53,r0,r29
	...
	// stvx128 v56,r30,r28
	simde_mm_store_si128((simde__m128i*)(base + ((r30.u32 + r28.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v56.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// stvx128 v61,r30,r8
	...
	ctx.r7.s64 = r31.s64 + 224;
	// lvx128 v52,r0,r29
	simde_mm_store_si128((simde__m128i*)v52.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r29.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// cmplwi cr6,r26,0
	cr6.compare<uint32_t>(r26.u32, 0, xer);
	// stvx128 v52,r0,r7
	...
	simde_mm_store_si128((simde__m128i*)ctx.v8.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v12,v51,1
	simde_mm_store_si128((simde__m128i*)ctx.v12.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v51.u32), 0xAA));
	// lvx128 v13,r26,r27
	simde_mm_store_si128((simde__m128i*)ctx.v13.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r26.u32 + r27.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v11,v51,2
	simde_mm_store_si128((simde__m128i*)ctx.v11.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v51.u32), 0x55));
	// lvx128 v49,r0,r11
	...
	// vspltw128 v9,v49,0
	simde_mm_store_si128((simde__m128i*)ctx.v9.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v49.u32), 0xFF));
	// lvx128 v47,r0,r9
	...
	// vspltw128 v3,v47,1
	simde_mm_store_si128((simde__m128i*)ctx.v3.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v47.u32), 0xAA));
	// vmulfp128 v2,v0,v45
	simde_mm_store_ps(ctx.v2.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(v45.f32)));
	// vspltw128 v1,v49,2
	...
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r26.u32 + r28.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v30,v47,2
	simde_mm_store_si128((simde__m128i*)v30.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v47.u32), 0x55));
	// vmaddfp v29,v13,v12,v10
	simde_mm_store_ps(v29.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v13.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v10.f32)));
	// vmaddfp v28,v13,v7,v6
	simde_mm_store_ps(v28.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v13.f32), simde_mm_load_ps(ctx.v7.f32)), simde_mm_load_ps(ctx.v6.f32)));
...
loc_824C4154:
	...
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(v42.f32, simde_mm_add_ps(simde_mm_load_ps(v44.f32), simde_mm_load_ps(v43.f32)));
	// stvx128 v42,r0,r7
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r7.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v42.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
loc_824C4164:
	// lbz r11,293(r31)
...
PPC_WEAK_FUNC(sub_824C3DB0) {
	__imp__sub_824C3DB0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4194) {
	__imp__sub_824C4194(ctx, base);
}
...
loc_824C434C:
	...
	simde_mm_store_si128((simde__m128i*)v54.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v60.u32), 0x45));
	// vpermwi128 v52,v60,174
	simde_mm_store_si128((simde__m128i*)v52.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v60.u32), 0x51));
	// lvlx128 v58,r0,r8
	temp.u32 = ctx.r8.u32;
	...
	simde_mm_store_ps(v49.f32, simde_mm_mul_ps(simde_mm_load_ps(v53.f32), simde_mm_load_ps(v50.f32)));
	// stvx128 v49,r0,r9
	...
	// lbz r10,292(r31)
	ctx.r10.u64 = PPC_LOAD_U8(r31.u32 + 292);
	// addi r7,r29,48
	...
	// vspltw128 v11,v47,2
	simde_mm_store_si128((simde__m128i*)ctx.v11.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v47.u32), 0x55));
	// lvx128 v45,r0,r10
	...
	simde_mm_store_ps(ctx.v10.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(v46.f32)));
	// lvx128 v44,r0,r9
	...
	// vspltw128 v9,v45,0
	simde_mm_store_si128((simde__m128i*)ctx.v9.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v45.u32), 0xFF));
	// lvx128 v43,r0,r8
	simde_mm_store_si128((simde__m128i*)v43.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v42,v44,0
	...
	// vspltw128 v7,v45,1
	simde_mm_store_si128((simde__m128i*)ctx.v7.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v45.u32), 0xAA));
	// vmaddfp v6,v0,v9,v8
	simde_mm_store_ps(ctx.v6.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(ctx.v9.f32)), simde_mm_load_ps(ctx.v8.f32)));
	// vspltw128 v5,v44,1
	...
	// vspltw128 v3,v43,1
	simde_mm_store_si128((simde__m128i*)ctx.v3.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v43.u32), 0xAA));
	// vmulfp128 v2,v0,v41
	...
	// lvx128 v0,r29,r5
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r29.u32 + ctx.r5.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v30,v43,2
	simde_mm_store_si128((simde__m128i*)v30.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v43.u32), 0x55));
	// vmaddfp v29,v13,v12,v10
	simde_mm_store_ps(v29.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v13.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v10.f32)));
	// vmaddfp v28,v13,v7,v6
	simde_mm_store_ps(v28.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v13.f32), simde_mm_load_ps(ctx.v7.f32)), simde_mm_load_ps(ctx.v6.f32)));
...
loc_824C44D0:
	...
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(v38.f32, simde_mm_add_ps(simde_mm_load_ps(v40.f32), simde_mm_load_ps(v39.f32)));
	// stvx128 v38,r0,r6
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r6.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v38.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
loc_824C44E0:
	// lbz r11,293(r31)
	r11.u64 = PPC_LOAD_U8(r31.u32 + 293);
	// cmplwi cr6,r11,0
	...
	// lvx128 v36,r0,r6
	simde_mm_store_si128((simde__m128i*)v36.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r6.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
...
PPC_WEAK_FUNC(sub_824C4198) {
	__imp__sub_824C4198(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4508) {
	__imp__sub_824C4508(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4B00) {
	__imp__sub_824C4B00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4BB4) {
	__imp__sub_824C4BB4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4BB8) {
	__imp__sub_824C4BB8(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C4C38) {
	...
	// blt cr6,0x824c4c58
	if (cr6.lt) goto loc_824C4C58;
	// beq cr6,0x824c4c54
	if (cr6.eq) goto loc_824C4C54;
	// cmplwi cr6,r11,3
...
PPC_WEAK_FUNC(sub_824C4C5C) {
	__imp__sub_824C4C5C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4C60) {
	__imp__sub_824C4C60(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C4D28) {
	...
	r11.s64 = -2104688640;
	// lwz r3,22012(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 22012);
	// blr 
	return;
}
...
PPC_WEAK_FUNC(sub_824C4D34) {
	__imp__sub_824C4D34(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4D38) {
	__imp__sub_824C4D38(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4DB8) {
	__imp__sub_824C4DB8(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C4E68) {
	...
	r11.s64 = -2104688640;
	// lwz r3,22016(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 22016);
	// blr 
	return;
}

PPC_WEAK_FUNC(sub_824C4E68) {
	__imp__sub_824C4E68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4E74) {
	__imp__sub_824C4E74(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4E78) {
	__imp__sub_824C4E78(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C4F28) {
	...
	r11.s64 = -2104688640;
	// lwz r3,22020(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 22020);
	// blr 
	return;
}

PPC_WEAK_FUNC(sub_824C4F28) {
	__imp__sub_824C4F28(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4F34) {
	__imp__sub_824C4F34(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C4F38) {
	__imp__sub_824C4F38(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C500C) {
	__imp__sub_824C500C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5010) {
	__imp__sub_824C5010(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C505C) {
	__imp__sub_824C505C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5060) {
	__imp__sub_824C5060(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C50AC) {
	__imp__sub_824C50AC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C50B0) {
	__imp__sub_824C50B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C50FC) {
	__imp__sub_824C50FC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5100) {
	__imp__sub_824C5100(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C514C) {
	__imp__sub_824C514C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5150) {
	__imp__sub_824C5150(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C519C) {
	__imp__sub_824C519C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C51A0) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,22008
	r31.s64 = r11.s64 + 22008;
	// lwz r11,22008(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 22008);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824c52d8
	if (!cr6.eq) goto loc_824C52D8;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824C51C8;
...
loc_824C51E0:
	...
	r11.u64 = PPC_LOAD_U32(r31.u32 + 0);
	// addi r30,r9,24380
	r30.s64 = ctx.r9.s64 + 24380;
	// std r6,40(r11)
	PPC_STORE_U64(r11.u32 + 40, ctx.r6.u64);
	// addi r29,r8,24404
	r29.s64 = ctx.r8.s64 + 24404;
	// lwz r3,0(r31)
...
PPC_WEAK_FUNC(sub_824C51A0) {
	__imp__sub_824C51A0(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C5408) {
	...
	// lwz r11,22004(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 22004);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824c552c
	if (!cr6.eq) goto loc_824C552C;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824C5430;
...
PPC_WEAK_FUNC(sub_824C5408) {
	__imp__sub_824C5408(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5534) {
	__imp__sub_824C5534(ctx, base);
}
...
loc_824C55F4:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// addi r28,r10,24484
	r28.s64 = ctx.r10.s64 + 24484;
	// li r10,56
	ctx.r10.s64 = 56;
	// stw r10,8(r28)
	PPC_STORE_U32(r28.u32 + 8, ctx.r10.u32);
	// bne cr6,0x824c5618
	if (!cr6.eq) goto loc_824C5618;
	// bl 0x824970b0
	ctx.lr = 0x824C5614;
	sub_824970B0(ctx, base);
	// lwz r11,20464(r29)
...
loc_824C5618:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// addi r30,r10,24520
	r30.s64 = ctx.r10.s64 + 24520;
	// li r10,96
	ctx.r10.s64 = 96;
	// stw r10,8(r30)
	PPC_STORE_U32(r30.u32 + 8, ctx.r10.u32);
	// bne cr6,0x824c563c
	if (!cr6.eq) goto loc_824C563C;
	// bl 0x824970b0
	ctx.lr = 0x824C5638;
	sub_824970B0(ctx, base);
	// lwz r11,20464(r29)
...
loc_824C563C:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// addi r28,r10,24556
	r28.s64 = ctx.r10.s64 + 24556;
	// li r10,136
	ctx.r10.s64 = 136;
	// stw r10,8(r28)
	PPC_STORE_U32(r28.u32 + 8, ctx.r10.u32);
	// bne cr6,0x824c5660
	if (!cr6.eq) goto loc_824C5660;
	// bl 0x824970b0
	ctx.lr = 0x824C565C;
	sub_824970B0(ctx, base);
	// lwz r11,20464(r29)
...
loc_824C5660:
	...
	PPC_STORE_U32(r28.u32 + 20, r11.u32);
	// lwz r4,22008(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 22008);
	// cmplwi cr6,r4,0
	cr6.compare<uint32_t>(ctx.r4.u32, 0, xer);
	// bne cr6,0x824c567c
...
loc_824C567C:
	...
	sub_821D4458(ctx, base);
	// lwz r11,22008(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + 22008);
	// li r5,0
	ctx.r5.s64 = 0;
	// addi r3,r1,88
	ctx.r3.s64 = ctx.r1.s64 + 88;
...
PPC_WEAK_FUNC(sub_824C5538) {
	__imp__sub_824C5538(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C56EC) {
	__imp__sub_824C56EC(ctx, base);
}
...
loc_824C57D0:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// addi r27,r10,24684
	r27.s64 = ctx.r10.s64 + 24684;
	// li r10,96
	ctx.r10.s64 = 96;
	// stw r10,8(r27)
	PPC_STORE_U32(r27.u32 + 8, ctx.r10.u32);
	// bne cr6,0x824c57f4
	if (!cr6.eq) goto loc_824C57F4;
	// bl 0x824970b0
	ctx.lr = 0x824C57F0;
	sub_824970B0(ctx, base);
	// lwz r11,20464(r29)
...
PPC_FUNC_IMPL(__imp__sub_824C5880) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,22020
	r31.s64 = r11.s64 + 22020;
	// lwz r11,22020(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 22020);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824c59e4
	if (!cr6.eq) goto loc_824C59E4;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824C58A8;
...
loc_824C593C:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// addi r28,r10,24772
	r28.s64 = ctx.r10.s64 + 24772;
	// li r10,96
	ctx.r10.s64 = 96;
	// stw r10,8(r28)
	PPC_STORE_U32(r28.u32 + 8, ctx.r10.u32);
	// bne cr6,0x824c5960
	if (!cr6.eq) goto loc_824C5960;
	// bl 0x824970b0
	ctx.lr = 0x824C595C;
	sub_824970B0(ctx, base);
	// lwz r11,20464(r29)
...
PPC_WEAK_FUNC(sub_824C5880) {
	__imp__sub_824C5880(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C59EC) {
	__imp__sub_824C59EC(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C59F0) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,22024
	r31.s64 = r11.s64 + 22024;
	// lwz r11,22024(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 22024);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824c5b9c
	if (!cr6.eq) goto loc_824C5B9C;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824C5A18;
...
loc_824C5AF4:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// addi r28,r10,24928
	r28.s64 = ctx.r10.s64 + 24928;
	// li r10,136
	ctx.r10.s64 = 136;
	// stw r10,8(r28)
	PPC_STORE_U32(r28.u32 + 8, ctx.r10.u32);
	// bne cr6,0x824c5b18
	if (!cr6.eq) goto loc_824C5B18;
	// bl 0x824970b0
	ctx.lr = 0x824C5B14;
	sub_824970B0(ctx, base);
	// lwz r11,20464(r29)
...
PPC_WEAK_FUNC(sub_824C59F0) {
	__imp__sub_824C59F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5BA4) {
	__imp__sub_824C5BA4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5BA8) {
	__imp__sub_824C5BA8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5C40) {
	__imp__sub_824C5C40(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C5C68) {
	...
	PPCRegister r18{};
	// lwz r18,23672(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 23672);
	// lwz r18,23684(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 23684);
	// lwz r18,23696(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 23696);
	// lwz r18,23708(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 23708);
	// lis r11,-32249
	r11.s64 = -2113470464;
	// addi r3,r11,12928
	ctx.r3.s64 = r11.s64 + 12928;
	// b 0x824c52e0
...
PPC_WEAK_FUNC(sub_824C5C84) {
	__imp__sub_824C5C84(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5C9C) {
	__imp__sub_824C5C9C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5CAC) {
	__imp__sub_824C5CAC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5CB0) {
	__imp__sub_824C5CB0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5D2C) {
	__imp__sub_824C5D2C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5D30) {
	__imp__sub_824C5D30(ctx, base);
}
...
loc_824C5D9C:
	...
	r11.u64 = (__builtin_rotateleft32(ctx.r10.u32, 7) & 0xFFFFFFE0) | (r11.u64 & 0xFFFFFFFF0000001F);
	// stb r11,8(r3)
...
PPC_WEAK_FUNC(sub_824C5D60) {
	__imp__sub_824C5D60(ctx, base);
}
...
loc_824C5E18:
	...
	r30.s64 = r30.s64 + 8;
	// bge 0x824c5e18
	if (!cr0.lt) goto loc_824C5E18;
	// li r11,-1
	r11.s64 = -1;
	// stb r28,44(r29)
	PPC_STORE_U8(r29.u32 + 44, r28.u8);
	// mr r3,r29
	ctx.r3.u64 = r29.u64;
	// stw r11,40(r29)
...
PPC_WEAK_FUNC(sub_824C5DF8) {
	__imp__sub_824C5DF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C5E44) {
	__imp__sub_824C5E44(ctx, base);
}
...
loc_824C5EA0:
	...
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x824c5f00
	if (cr6.eq) goto loc_824C5F00;
	// add r30,r3,r29
	r30.u64 = ctx.r3.u64 + r29.u64;
	// cmplwi cr6,r30,1006
	cr6.compare<uint32_t>(r30.u32, 1006, xer);
	// bgt cr6,0x824c5f00
	if (cr6.gt) goto loc_824C5F00;
	// addi r11,r1,96
...
PPC_WEAK_FUNC(sub_824C5F10) {
	__imp__sub_824C5F10(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_824C5FC8) {
	...
	r11.s64 = r11.s64 + 1;
	// stw r11,3368(r31)
	PPC_STORE_U32(r31.u32 + 3368, r11.u32);
loc_824C6054:
	// addi r1,r1,112
	ctx.r1.s64 = ctx.r1.s64 + 112;
	// lwz r12,-8(r1)
...
PPC_WEAK_FUNC(sub_824C5FC8) {
	__imp__sub_824C5FC8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C606C) {
	__imp__sub_824C606C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6070) {
	__imp__sub_824C6070(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C618C) {
	__imp__sub_824C618C(ctx, base);
}
...
loc_824C61FC:
	...
	cr6.compare<int32_t>(r27.s32, r11.s32, xer);
	// blt cr6,0x824c61c0
	if (cr6.lt) goto loc_824C61C0;
	// cmplwi cr6,r28,0
	cr6.compare<uint32_t>(r28.u32, 0, xer);
	// beq cr6,0x824c6260
	if (cr6.eq) goto loc_824C6260;
	// lwz r11,12(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 12);
	// addi r30,r31,32
	r30.s64 = r31.s64 + 32;
...
PPC_WEAK_FUNC(sub_824C6190) {
	__imp__sub_824C6190(ctx, base);
}
...
loc_824C62A0:
	...
	// bgt cr6,0x824c644c
	if (cr6.gt) goto loc_824C644C;
	// lis r12,-32180
	r12.s64 = -2108948480;
	// addi r12,r12,25284
	r12.s64 = r12.s64 + 25284;
	// rlwinm r0,r11,2,0,29
	r0.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 2) & 0xFFFFFFFC;
	// lwzx r0,r12,r0
	r0.u64 = PPC_LOAD_U32(r12.u32 + r0.u32);
	...
	return;
	// lwz r18,25308(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 25308);
	// lwz r18,25488(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 25488);
	// lwz r18,25508(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 25508);
	// lwz r18,25568(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 25568);
	// lwz r18,25604(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 25604);
	// lwz r18,25640(r12)
	r18.u64 = PPC_LOAD_U32(r12.u32 + 25640);
	// lwz r11,12(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 12);
	// addi r3,r11,4400
...
loc_824C6330:
	...
	r26.s64 = r31.s64 + 32;
	// lwz r25,11584(r3)
	r25.u64 = PPC_LOAD_U32(ctx.r3.u32 + 11584);
	// bl 0x823eaef8
	ctx.lr = 0x824C6340;
...
PPC_WEAK_FUNC(sub_824C6280) {
	__imp__sub_824C6280(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6474) {
	__imp__sub_824C6474(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6478) {
	__imp__sub_824C6478(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C64A0) {
	__imp__sub_824C64A0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C64A4) {
	__imp__sub_824C64A4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C64A8) {
	__imp__sub_824C64A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C65DC) {
	__imp__sub_824C65DC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C65E0) {
	__imp__sub_824C65E0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C66DC) {
	__imp__sub_824C66DC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C66E0) {
	__imp__sub_824C66E0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6748) {
	__imp__sub_824C6748(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6784) {
	__imp__sub_824C6784(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6788) {
	__imp__sub_824C6788(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C67C4) {
	__imp__sub_824C67C4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C67C8) {
	__imp__sub_824C67C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6830) {
	__imp__sub_824C6830(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C68E4) {
	__imp__sub_824C68E4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C68E8) {
	__imp__sub_824C68E8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C69D0) {
	__imp__sub_824C69D0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C69E0) {
	__imp__sub_824C69E0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C69F0) {
	__imp__sub_824C69F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6A10) {
	__imp__sub_824C6A10(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6A20) {
	__imp__sub_824C6A20(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6A2C) {
	__imp__sub_824C6A2C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6A30) {
	__imp__sub_824C6A30(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6AD0) {
	__imp__sub_824C6AD0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6B00) {
	__imp__sub_824C6B00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6B64) {
	__imp__sub_824C6B64(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6B68) {
	__imp__sub_824C6B68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6BDC) {
	__imp__sub_824C6BDC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6BE0) {
	__imp__sub_824C6BE0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6CEC) {
	__imp__sub_824C6CEC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6CF0) {
	__imp__sub_824C6CF0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6E04) {
	__imp__sub_824C6E04(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6E08) {
	__imp__sub_824C6E08(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6F08) {
	__imp__sub_824C6F08(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C6F6C) {
	__imp__sub_824C6F6C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7064) {
	__imp__sub_824C7064(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7068) {
	__imp__sub_824C7068(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C70B0) {
	__imp__sub_824C70B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C70BC) {
	__imp__sub_824C70BC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C70C0) {
	__imp__sub_824C70C0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7180) {
	__imp__sub_824C7180(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C71C4) {
	__imp__sub_824C71C4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C71C8) {
	__imp__sub_824C71C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7244) {
	__imp__sub_824C7244(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7318) {
	__imp__sub_824C7318(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C742C) {
	__imp__sub_824C742C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C743C) {
	__imp__sub_824C743C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7440) {
	__imp__sub_824C7440(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7570) {
	__imp__sub_824C7570(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C760C) {
	__imp__sub_824C760C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7610) {
	__imp__sub_824C7610(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7668) {
	__imp__sub_824C7668(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7730) {
	__imp__sub_824C7730(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7740) {
	__imp__sub_824C7740(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7804) {
	__imp__sub_824C7804(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7808) {
	__imp__sub_824C7808(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7950) {
	__imp__sub_824C7950(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7984) {
	__imp__sub_824C7984(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7988) {
	__imp__sub_824C7988(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7994) {
	__imp__sub_824C7994(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7998) {
	__imp__sub_824C7998(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7A34) {
	__imp__sub_824C7A34(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7A38) {
	__imp__sub_824C7A38(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7A44) {
	__imp__sub_824C7A44(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7A48) {
	__imp__sub_824C7A48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7AF4) {
	__imp__sub_824C7AF4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7AF8) {
	__imp__sub_824C7AF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7BE8) {
	__imp__sub_824C7BE8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7C44) {
	__imp__sub_824C7C44(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7CCC) {
	__imp__sub_824C7CCC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7CD0) {
	__imp__sub_824C7CD0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7CDC) {
	__imp__sub_824C7CDC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7D7C) {
	__imp__sub_824C7D7C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7D80) {
	__imp__sub_824C7D80(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7DC4) {
	__imp__sub_824C7DC4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7ECC) {
	__imp__sub_824C7ECC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C7ED0) {
	__imp__sub_824C7ED0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8128) {
	__imp__sub_824C8128(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8134) {
	__imp__sub_824C8134(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C822C) {
	__imp__sub_824C822C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8230) {
	__imp__sub_824C8230(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C82C8) {
	__imp__sub_824C82C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C82E4) {
	__imp__sub_824C82E4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C82E8) {
	__imp__sub_824C82E8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C83B4) {
	__imp__sub_824C83B4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C83B8) {
	__imp__sub_824C83B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C84D8) {
	__imp__sub_824C84D8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C85B4) {
	__imp__sub_824C85B4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C85B8) {
	__imp__sub_824C85B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8628) {
	__imp__sub_824C8628(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8744) {
	__imp__sub_824C8744(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C87C4) {
	__imp__sub_824C87C4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C87C8) {
	__imp__sub_824C87C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8864) {
	__imp__sub_824C8864(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8868) {
	__imp__sub_824C8868(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C89F8) {
	__imp__sub_824C89F8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8B40) {
	__imp__sub_824C8B40(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8D38) {
	__imp__sub_824C8D38(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8DA0) {
	__imp__sub_824C8DA0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8E48) {
	__imp__sub_824C8E48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8E54) {
	__imp__sub_824C8E54(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8E58) {
	__imp__sub_824C8E58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C8FA8) {
	__imp__sub_824C8FA8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9050) {
	__imp__sub_824C9050(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C90A8) {
	__imp__sub_824C90A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9144) {
	__imp__sub_824C9144(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9148) {
	__imp__sub_824C9148(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9240) {
	__imp__sub_824C9240(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C930C) {
	__imp__sub_824C930C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9310) {
	__imp__sub_824C9310(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9394) {
	__imp__sub_824C9394(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9470) {
	__imp__sub_824C9470(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C94F0) {
	__imp__sub_824C94F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9634) {
	__imp__sub_824C9634(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9638) {
	__imp__sub_824C9638(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C96C8) {
	__imp__sub_824C96C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9754) {
	__imp__sub_824C9754(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9758) {
	__imp__sub_824C9758(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9838) {
	__imp__sub_824C9838(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C98F0) {
	__imp__sub_824C98F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9998) {
	__imp__sub_824C9998(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9A28) {
	__imp__sub_824C9A28(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9AC4) {
	__imp__sub_824C9AC4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9AC8) {
	__imp__sub_824C9AC8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9B58) {
	__imp__sub_824C9B58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9BE8) {
	__imp__sub_824C9BE8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9C98) {
	__imp__sub_824C9C98(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9D4C) {
	__imp__sub_824C9D4C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9D50) {
	__imp__sub_824C9D50(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9E38) {
	__imp__sub_824C9E38(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9EEC) {
	__imp__sub_824C9EEC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9EF0) {
	__imp__sub_824C9EF0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9FA4) {
	__imp__sub_824C9FA4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824C9FA8) {
	__imp__sub_824C9FA8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA090) {
	__imp__sub_824CA090(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA21C) {
	__imp__sub_824CA21C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA220) {
	__imp__sub_824CA220(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA308) {
	__imp__sub_824CA308(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA3BC) {
	__imp__sub_824CA3BC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA3C0) {
	__imp__sub_824CA3C0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA474) {
	__imp__sub_824CA474(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA478) {
	__imp__sub_824CA478(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA52C) {
	__imp__sub_824CA52C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA530) {
	__imp__sub_824CA530(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA598) {
	__imp__sub_824CA598(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA7C8) {
	__imp__sub_824CA7C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA844) {
	__imp__sub_824CA844(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA848) {
	__imp__sub_824CA848(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA8B0) {
	__imp__sub_824CA8B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA948) {
	__imp__sub_824CA948(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CA9B0) {
	__imp__sub_824CA9B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAAAC) {
	__imp__sub_824CAAAC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAAB0) {
	__imp__sub_824CAAB0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAB00) {
	__imp__sub_824CAB00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CABF0) {
	__imp__sub_824CABF0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAC74) {
	__imp__sub_824CAC74(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAC78) {
	__imp__sub_824CAC78(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CACF4) {
	__imp__sub_824CACF4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CACF8) {
	__imp__sub_824CACF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAD54) {
	__imp__sub_824CAD54(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAD58) {
	__imp__sub_824CAD58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAD9C) {
	__imp__sub_824CAD9C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CADFC) {
	__imp__sub_824CADFC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAE00) {
	__imp__sub_824CAE00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAE94) {
	__imp__sub_824CAE94(ctx, base);
}
...
PPC_WEAK_FUNC(sub_824CAE98) {
	__imp__sub_824CAE98(ctx, base);
}
