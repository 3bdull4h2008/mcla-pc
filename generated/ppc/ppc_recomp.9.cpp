...
PPC_WEAK_FUNC(sub_8217C570) {
	__imp__sub_8217C570(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217C5C4) {
	__imp__sub_8217C5C4(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217C5C8) {
	...
	simde_mm_store_si128((simde__m128i*)v57.u32, simde_mm_unpackhi_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), simde_mm_load_si128((simde__m128i*)v59.u32)));
	// vmrglw128 v56,v59,v62
	simde_mm_store_si128((simde__m128i*)v56.u32, simde_mm_unpacklo_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), simde_mm_load_si128((simde__m128i*)v59.u32)));
	// vmrglw128 v55,v63,v60
	simde_mm_store_si128((simde__m128i*)v55.u32, simde_mm_unpacklo_epi32(simde_mm_load_si128((simde__m128i*)v60.u32), simde_mm_load_si128((simde__m128i*)v63.u32)));
	...
	// stvx128 v53,r3,r7
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r3.u32 + ctx.r7.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v53.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// stvx128 v52,r3,r6
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r3.u32 + ctx.r6.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v52.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v48,r0,r9
	...
	simde_mm_store_ps(v46.f32, simde_mm_dp_ps(simde_mm_load_ps(v51.f32), simde_mm_load_ps(v49.f32), 0xEF));
	// vmsum3fp128 v47,v48,v49
	simde_mm_store_ps(v47.f32, simde_mm_dp_ps(simde_mm_load_ps(v48.f32), simde_mm_load_ps(v49.f32), 0xEF));
	// vmsum3fp128 v45,v50,v49
	simde_mm_store_ps(v45.f32, simde_mm_dp_ps(simde_mm_load_ps(v50.f32), simde_mm_load_ps(v49.f32), 0xEF));
	...
	simde_mm_store_ps(v40.f32, simde_mm_sub_ps(simde_mm_load_ps(v61.f32), simde_mm_load_ps(v41.f32)));
	// stvx128 v40,r0,r11
...
PPC_FUNC_IMPL(__imp__sub_8217C658) {
	...
	r27.u64 = ctx.r4.u64;
	// lwz r28,-26876(r30)
	r28.u64 = PPC_LOAD_U32(r30.u32 + -26876);
	// lwz r10,16(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 16);
	// cmpwi cr6,r10,0
	cr6.compare<int32_t>(ctx.r10.s32, 0, xer);
	// bne cr6,0x8217c69c
	if (!cr6.eq) goto loc_8217C69C;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// li r4,0
	ctx.r4.s64 = 0;
...
loc_8217C69C:
	...
	// bne cr6,0x8217c6bc
	if (!cr6.eq) goto loc_8217C6BC;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// li r4,0
	ctx.r4.s64 = 0;
	// addi r3,r11,-26892
	ctx.r3.s64 = r11.s64 + -26892;
	// bl 0x8218a4e8
	ctx.lr = 0x8217C6B8;
	sub_8218A4E8(ctx, base);
	// stw r3,0(r31)
...
loc_8217C6DC:
	...
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// bne cr6,0x8217c6fc
	if (!cr6.eq) goto loc_8217C6FC;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// li r4,0
	ctx.r4.s64 = 0;
	// addi r3,r11,-26924
	ctx.r3.s64 = r11.s64 + -26924;
	// bl 0x8218a4e8
	ctx.lr = 0x8217C6F8;
	sub_8218A4E8(ctx, base);
	// stw r3,20(r31)
...
loc_8217C6FC:
	...
	// stw r29,-26876(r30)
	PPC_STORE_U32(r30.u32 + -26876, r29.u32);
	// beq cr6,0x8217c730
	if (cr6.eq) goto loc_8217C730;
	// clrlwi r11,r27,24
...
PPC_WEAK_FUNC(sub_8217C658) {
	__imp__sub_8217C658(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217C73C) {
	__imp__sub_8217C73C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217C740) {
	...
	// fsubs f7,f0,f6
	ctx.f7.f64 = double(float(f0.f64 - ctx.f6.f64));
	// stfs f2,796(r31)
	...
	// fsubs f5,f0,f2
	ctx.f5.f64 = double(float(f0.f64 - ctx.f2.f64));
	// lfs f31,120(r1)
	...
	simde_mm_store_ps(v61.f32, simde_mm_div_ps(simde_mm_set1_ps(1), simde_mm_sqrt_ps(simde_mm_load_ps(v62.f32))));
	// vor128 v60,v63,v63
	...
	simde_mm_store_ps(ctx.v10.f32, simde_mm_cmpeq_ps(simde_mm_load_ps(v61.f32), simde_mm_load_ps(v63.f32)));
	// lis r30,-32130
	r30.s64 = -2105671680;
	// addi r5,r5,-31648
	ctx.r5.s64 = ctx.r5.s64 + -31648;
	// addi r30,r30,-31664
	r30.s64 = r30.s64 + -31664;
	// lvx128 v9,r0,r3
	...
	// vsel v0,v11,v9,v10
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_or_si128(simde_mm_andnot_si128(simde_mm_load_si128((simde__m128i*)ctx.v10.u8), simde_mm_load_si128((simde__m128i*)ctx.v11.u8)), simde_mm_and_si128(simde_mm_load_si128((simde__m128i*)ctx.v10.u8), simde_mm_load_si128((simde__m128i*)ctx.v9.u8))));
	// vmulfp128 v8,v0,v0
	...
	simde_mm_store_ps(v59.f32, simde_mm_mul_ps(simde_mm_load_ps(v60.f32), simde_mm_load_ps(ctx.v5.f32)));
	// stvx128 v59,r0,r11
	...
	simde_mm_store_si128((simde__m128i*)v63.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r5.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v3,v57,v57
	simde_mm_store_si128((simde__m128i*)ctx.v3.u8, simde_mm_load_si128((simde__m128i*)v57.u8));
	// lvx128 v4,r0,r3
	...
	simde_mm_store_ps(ctx.v2.f32, simde_mm_cmpeq_ps(simde_mm_load_ps(v56.f32), simde_mm_load_ps(v62.f32)));
	// vor128 v1,v56,v56
	simde_mm_store_si128((simde__m128i*)ctx.v1.u8, simde_mm_load_si128((simde__m128i*)v56.u8));
	// vsel v0,v1,v4,v2
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_or_si128(simde_mm_andnot_si128(simde_mm_load_si128((simde__m128i*)ctx.v2.u8), simde_mm_load_si128((simde__m128i*)ctx.v1.u8)), simde_mm_and_si128(simde_mm_load_si128((simde__m128i*)ctx.v2.u8), simde_mm_load_si128((simde__m128i*)ctx.v4.u8))));
	// vmulfp128 v31,v0,v0
	simde_mm_store_ps(v31.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(ctx.v0.f32)));
	// vmulfp128 v30,v63,v0
	simde_mm_store_ps(v30.f32, simde_mm_mul_ps(simde_mm_load_ps(v63.f32), simde_mm_load_ps(ctx.v0.f32)));
	// vnmsubfp v29,v3,v31,v13
	simde_mm_store_ps(v29.f32, simde_mm_xor_ps(simde_mm_sub_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v3.f32), simde_mm_load_ps(v31.f32)), simde_mm_load_ps(ctx.v13.f32)), simde_mm_castsi128_ps(simde_mm_set1_epi32(int(0x80000000)))));
	...
	simde_mm_store_ps(v54.f32, simde_mm_mul_ps(simde_mm_load_ps(v55.f32), simde_mm_load_ps(v28.f32)));
	// stvx128 v54,r0,r10
	...
	simde_mm_store_si128((simde__m128i*)v63.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r5.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v26,v52,v52
	simde_mm_store_si128((simde__m128i*)v26.u8, simde_mm_load_si128((simde__m128i*)v52.u8));
	// lvx128 v27,r0,r3
	...
	simde_mm_store_ps(v25.f32, simde_mm_cmpeq_ps(simde_mm_load_ps(v51.f32), simde_mm_load_ps(v62.f32)));
	// vor128 v24,v51,v51
	simde_mm_store_si128((simde__m128i*)v24.u8, simde_mm_load_si128((simde__m128i*)v51.u8));
	// vsel v0,v24,v27,v25
	...
	simde_mm_store_ps(v49.f32, simde_mm_mul_ps(simde_mm_load_ps(v50.f32), simde_mm_load_ps(v20.f32)));
	// stvx128 v49,r0,r9
	...
	simde_mm_store_si128((simde__m128i*)ctx.v13.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r30.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v18,v47,v47
	simde_mm_store_si128((simde__m128i*)v18.u8, simde_mm_load_si128((simde__m128i*)v47.u8));
	// lvx128 v19,r0,r3
	simde_mm_store_si128((simde__m128i*)v19.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r3.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v45,v48,v48
	simde_mm_store_si128((simde__m128i*)v45.u8, simde_mm_load_si128((simde__m128i*)v48.u8));
	// vcmpeqfp128 v17,v46,v62
	simde_mm_store_ps(v17.f32, simde_mm_cmpeq_ps(simde_mm_load_ps(v46.f32), simde_mm_load_ps(v62.f32)));
	// vor128 v16,v46,v46
	simde_mm_store_si128((simde__m128i*)v16.u8, simde_mm_load_si128((simde__m128i*)v46.u8));
	// vsel v0,v16,v19,v17
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_or_si128(simde_mm_andnot_si128(simde_mm_load_si128((simde__m128i*)v17.u8), simde_mm_load_si128((simde__m128i*)v16.u8)), simde_mm_and_si128(simde_mm_load_si128((simde__m128i*)v17.u8), simde_mm_load_si128((simde__m128i*)v19.u8))));
	// vmulfp128 v15,v0,v0
	simde_mm_store_ps(v15.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(ctx.v0.f32)));
	// vmulfp128 v14,v63,v0
	simde_mm_store_ps(v14.f32, simde_mm_mul_ps(simde_mm_load_ps(v63.f32), simde_mm_load_ps(ctx.v0.f32)));
	// vnmsubfp v13,v18,v15,v13
	simde_mm_store_ps(ctx.v13.f32, simde_mm_xor_ps(simde_mm_sub_ps(simde_mm_mul_ps(simde_mm_load_ps(v18.f32), simde_mm_load_ps(v15.f32)), simde_mm_load_ps(ctx.v13.f32)), simde_mm_castsi128_ps(simde_mm_set1_epi32(int(0x80000000)))));
	// vmaddfp v12,v13,v14,v0
	simde_mm_store_ps(ctx.v12.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v13.f32), simde_mm_load_ps(v14.f32)), simde_mm_load_ps(ctx.v0.f32)));
	// vmulfp128 v44,v45,v12
	simde_mm_store_ps(v44.f32, simde_mm_mul_ps(simde_mm_load_ps(v45.f32), simde_mm_load_ps(ctx.v12.f32)));
	// stvx128 v44,r0,r6
	...
	simde_mm_store_si128((simde__m128i*)v63.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r5.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v8,v42,v42
	simde_mm_store_si128((simde__m128i*)ctx.v8.u8, simde_mm_load_si128((simde__m128i*)v42.u8));
	// lvx128 v13,r0,r30
	simde_mm_store_si128((simde__m128i*)ctx.v13.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r30.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v40,v43,v43
	simde_mm_store_si128((simde__m128i*)v40.u8, simde_mm_load_si128((simde__m128i*)v43.u8));
	// vcmpeqfp128 v11,v41,v62
	simde_mm_store_ps(ctx.v11.f32, simde_mm_cmpeq_ps(simde_mm_load_ps(v41.f32), simde_mm_load_ps(v62.f32)));
	// vor128 v9,v41,v41
	simde_mm_store_si128((simde__m128i*)ctx.v9.u8, simde_mm_load_si128((simde__m128i*)v41.u8));
	// vsel v0,v9,v10,v11
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_or_si128(simde_mm_andnot_si128(simde_mm_load_si128((simde__m128i*)ctx.v11.u8), simde_mm_load_si128((simde__m128i*)ctx.v9.u8)), simde_mm_and_si128(simde_mm_load_si128((simde__m128i*)ctx.v11.u8), simde_mm_load_si128((simde__m128i*)ctx.v10.u8))));
	// vmulfp128 v7,v0,v0
	...
	simde_mm_store_ps(v39.f32, simde_mm_mul_ps(simde_mm_load_ps(v40.f32), simde_mm_load_ps(ctx.v4.f32)));
	// stvx128 v39,r0,r8
	...
	simde_mm_store_ps(v37.f32, simde_mm_dp_ps(simde_mm_load_ps(v38.f32), simde_mm_load_ps(v38.f32), 0xEF));
	...
	simde_mm_store_si128((simde__m128i*)v63.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r5.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v2,v37,v37
	simde_mm_store_si128((simde__m128i*)ctx.v2.u8, simde_mm_load_si128((simde__m128i*)v37.u8));
	// lvx128 v3,r0,r3
	...
	simde_mm_store_ps(ctx.v1.f32, simde_mm_cmpeq_ps(simde_mm_load_ps(v36.f32), simde_mm_load_ps(v62.f32)));
	// vor128 v31,v36,v36
	simde_mm_store_si128((simde__m128i*)v31.u8, simde_mm_load_si128((simde__m128i*)v36.u8));
	// vsel v0,v31,v3,v1
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_or_si128(simde_mm_andnot_si128(simde_mm_load_si128((simde__m128i*)ctx.v1.u8), simde_mm_load_si128((simde__m128i*)v31.u8)), simde_mm_and_si128(simde_mm_load_si128((simde__m128i*)ctx.v1.u8), simde_mm_load_si128((simde__m128i*)ctx.v3.u8))));
	// vmulfp128 v30,v0,v0
	simde_mm_store_ps(v30.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v0.f32), simde_mm_load_ps(ctx.v0.f32)));
	// vmulfp128 v29,v63,v0
	simde_mm_store_ps(v29.f32, simde_mm_mul_ps(simde_mm_load_ps(v63.f32), simde_mm_load_ps(ctx.v0.f32)));
	// vnmsubfp v28,v2,v30,v13
	simde_mm_store_ps(v28.f32, simde_mm_xor_ps(simde_mm_sub_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v2.f32), simde_mm_load_ps(v30.f32)), simde_mm_load_ps(ctx.v13.f32)), simde_mm_castsi128_ps(simde_mm_set1_epi32(int(0x80000000)))));
	...
	simde_mm_store_ps(v34.f32, simde_mm_mul_ps(simde_mm_load_ps(v35.f32), simde_mm_load_ps(v27.f32)));
	// stvx128 v34,r0,r7
...
PPC_WEAK_FUNC(sub_8217C740) {
	__imp__sub_8217C740(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CB48) {
	__imp__sub_8217CB48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CB64) {
	__imp__sub_8217CB64(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217CB68) {
	...
	// lfs f0,-31064(r11)
	temp.u32 = PPC_LOAD_U32(r11.u32 + -31064);
	f0.f64 = double(temp.f32);
	// fmuls f12,f13,f0
...
PPC_WEAK_FUNC(sub_8217CB68) {
	__imp__sub_8217CB68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CC80) {
	__imp__sub_8217CC80(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CD88) {
	__imp__sub_8217CD88(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CDF4) {
	__imp__sub_8217CDF4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CDF8) {
	__imp__sub_8217CDF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CE6C) {
	__imp__sub_8217CE6C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CE70) {
	__imp__sub_8217CE70(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CE78) {
	__imp__sub_8217CE78(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217CE80) {
	...
	// stvx128 v54,r9,r30
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r9.u32 + r30.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v54.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v63,r0,r29
	simde_mm_store_si128((simde__m128i*)v63.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r29.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v53,r0,r7
	...
	// stvx128 v52,r9,r5
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r5.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v52.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v63,r0,r29
	simde_mm_store_si128((simde__m128i*)v63.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r29.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v51,r0,r10
	...
	// vor128 v49,v63,v50
	simde_mm_store_si128((simde__m128i*)v49.u8, simde_mm_or_si128(simde_mm_load_si128((simde__m128i*)v63.u8), simde_mm_load_si128((simde__m128i*)v50.u8)));
	// stvx128 v49,r9,r6
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r6.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v49.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v45,r0,r7
	...
	simde_mm_store_si128((simde__m128i*)v38.u32, simde_mm_unpacklo_epi32(simde_mm_load_si128((simde__m128i*)v47.u32), simde_mm_load_si128((simde__m128i*)v48.u32)));
	// vmrghw128 v36,v43,v42
	simde_mm_store_si128((simde__m128i*)v36.u32, simde_mm_unpackhi_epi32(simde_mm_load_si128((simde__m128i*)v42.u32), simde_mm_load_si128((simde__m128i*)v43.u32)));
	// vmsum3fp128 v41,v45,v46
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(v41.f32, simde_mm_dp_ps(simde_mm_load_ps(v45.f32), simde_mm_load_ps(v46.f32), 0xEF));
	// vmrglw128 v35,v43,v42
	simde_mm_store_si128((simde__m128i*)v35.u32, simde_mm_unpacklo_epi32(simde_mm_load_si128((simde__m128i*)v42.u32), simde_mm_load_si128((simde__m128i*)v43.u32)));
	// vmsum3fp128 v39,v44,v46
	simde_mm_store_ps(v39.f32, simde_mm_dp_ps(simde_mm_load_ps(v44.f32), simde_mm_load_ps(v46.f32), 0xEF));
	// vmrghw128 v34,v40,v38
	simde_mm_store_si128((simde__m128i*)v34.u32, simde_mm_unpackhi_epi32(simde_mm_load_si128((simde__m128i*)v38.u32), simde_mm_load_si128((simde__m128i*)v40.u32)));
	// vmsum3fp128 v37,v48,v46
	simde_mm_store_ps(v37.f32, simde_mm_dp_ps(simde_mm_load_ps(v48.f32), simde_mm_load_ps(v46.f32), 0xEF));
	// vand128 v33,v36,v63
	...
	simde_mm_store_si128((simde__m128i*)v60.u32, simde_mm_unpackhi_epi32(simde_mm_load_si128((simde__m128i*)v41.u32), simde_mm_load_si128((simde__m128i*)v39.u32)));
	// lvx128 v63,r0,r29
	simde_mm_store_si128((simde__m128i*)v63.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r29.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vand128 v59,v34,v63
	...
	simde_mm_store_si128((simde__m128i*)v58.u32, simde_mm_unpackhi_epi32(simde_mm_load_si128((simde__m128i*)v60.u32), simde_mm_load_si128((simde__m128i*)v37.u32)));
	// lvx128 v62,r0,r28
	...
	simde_mm_store_ps(v56.f32, simde_mm_sub_ps(simde_mm_load_ps(v61.f32), simde_mm_load_ps(v57.f32)));
	// vand128 v55,v56,v63
...
PPC_WEAK_FUNC(sub_8217CE80) {
	__imp__sub_8217CE80(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217CFCC) {
	__imp__sub_8217CFCC(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217CFD0) {
	...
	// lvx128 v54,r30,r7
	simde_mm_store_si128((simde__m128i*)v54.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r30.u32 + ctx.r7.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// stvx128 v54,r11,r7
	...
	// lvx128 v53,r30,r8
	simde_mm_store_si128((simde__m128i*)v53.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r30.u32 + ctx.r8.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// stvx128 v53,r11,r8
	...
	// lvx128 v52,r30,r9
	simde_mm_store_si128((simde__m128i*)v52.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r30.u32 + ctx.r9.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// stvx128 v52,r11,r9
...
PPC_WEAK_FUNC(sub_8217CFD0) {
	__imp__sub_8217CFD0(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217D098) {
	...
	// fmuls f4,f0,f3
	ctx.f4.f64 = double(float(f0.f64 * ctx.f3.f64));
	// fmuls f3,f2,f3
...
PPC_WEAK_FUNC(sub_8217D098) {
	__imp__sub_8217D098(ctx, base);
}
...
loc_8217D1A8:
	...
	// std r27,120(r1)
	PPC_STORE_U64(ctx.r1.u32 + 120, r27.u64);
	// std r10,136(r1)
	PPC_STORE_U64(ctx.r1.u32 + 136, ctx.r10.u64);
	// lfd f4,136(r1)
	...
	// fdivs f5,f30,f3
	ctx.f5.f64 = double(float(f30.f64 / ctx.f3.f64));
	// stfs f5,668(r31)
	temp.f32 = float(ctx.f5.f64);
...
PPC_WEAK_FUNC(sub_8217D120) {
	__imp__sub_8217D120(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D460) {
	__imp__sub_8217D460(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D47C) {
	__imp__sub_8217D47C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217D480) {
	...
	r30.s64 = -2105278464;
	// lwz r31,-26880(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + -26880);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x8217d4c8
	if (cr6.eq) goto loc_8217D4C8;
	// lis r11,-32124
	r11.s64 = -2105278464;
	// lwz r11,-26876(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -26876);
...
loc_8217D4C8:
	...
	r11.s64 = 0;
	// stw r11,-26880(r30)
	PPC_STORE_U32(r30.u32 + -26880, r11.u32);
	// addi r1,r1,112
	ctx.r1.s64 = ctx.r1.s64 + 112;
	// lwz r12,-8(r1)
	r12.u64 = PPC_LOAD_U32(ctx.r1.u32 + -8);
...
PPC_WEAK_FUNC(sub_8217D480) {
	__imp__sub_8217D480(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217D4E8) {
	...
	ctx.r5.s64 = 0;
	// lwz r6,688(r31)
	ctx.r6.u64 = PPC_LOAD_U32(r31.u32 + 688);
	// li r4,0
	ctx.r4.s64 = 0;
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
...
PPC_WEAK_FUNC(sub_8217D4E8) {
	__imp__sub_8217D4E8(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217D548) {
	...
	// fctiwz f11,f3
	ctx.f11.s64 = (ctx.f3.f64 > double(INT_MAX)) ? INT_MAX : simde_mm_cvttsd_si32(simde_mm_load_sd(&ctx.f3.f64));
	// stfd f12,88(r1)
...
PPC_WEAK_FUNC(sub_8217D548) {
	__imp__sub_8217D548(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217D5E8) {
	...
	simde_mm_store_si128((simde__m128i*)v55.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x54));
	// stfs f30,672(r31)
	temp.f32 = float(f30.f64);
	PPC_STORE_U32(r31.u32 + 672, temp.u32);
	// vpermwi128 v54,v62,234
	simde_mm_store_si128((simde__m128i*)v54.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x15));
	// stfs f30,676(r31)
	temp.f32 = float(f30.f64);
	PPC_STORE_U32(r31.u32 + 676, temp.u32);
	// vpermwi128 v53,v62,186
	simde_mm_store_si128((simde__m128i*)v53.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x45));
	// stfs f31,680(r31)
	temp.f32 = float(f31.f64);
	PPC_STORE_U32(r31.u32 + 680, temp.u32);
	// vpermwi128 v52,v62,174
	simde_mm_store_si128((simde__m128i*)v52.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x51));
	// stfs f30,684(r31)
	temp.f32 = float(f30.f64);
	PPC_STORE_U32(r31.u32 + 684, temp.u32);
	// vpermwi128 v51,v62,234
	simde_mm_store_si128((simde__m128i*)v51.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x15));
	// stvx128 v61,r0,r31
	...
	simde_mm_store_si128((simde__m128i*)v50.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x45));
	// stvx128 v60,r31,r9
	...
	simde_mm_store_si128((simde__m128i*)v49.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x51));
	// stvx128 v63,r31,r11
	...
	simde_mm_store_si128((simde__m128i*)v48.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x54));
	// stvx128 v58,r0,r8
	...
	simde_mm_store_si128((simde__m128i*)v47.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x15));
	// stvx128 v57,r8,r9
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r8.u32 + ctx.r9.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v57.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vpermwi128 v46,v62,186
	simde_mm_store_si128((simde__m128i*)v46.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x45));
	// stvx128 v56,r8,r10
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r8.u32 + ctx.r10.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v56.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vpermwi128 v45,v62,174
	simde_mm_store_si128((simde__m128i*)v45.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x51));
	// stvx128 v55,r8,r11
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r8.u32 + r11.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v55.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// addi r8,r31,384
	...
	simde_mm_store_si128((simde__m128i*)v44.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x54));
	// stvx128 v53,r7,r9
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r7.u32 + ctx.r9.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v53.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vpermwi128 v43,v62,234
	simde_mm_store_si128((simde__m128i*)v43.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x15));
	// stvx128 v52,r7,r10
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r7.u32 + ctx.r10.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v52.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vpermwi128 v42,v62,186
	simde_mm_store_si128((simde__m128i*)v42.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x45));
	// stvx128 v63,r7,r11
	...
	simde_mm_store_si128((simde__m128i*)v41.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x51));
	// stvx128 v50,r6,r9
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r6.u32 + ctx.r9.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v50.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vpermwi128 v40,v62,171
	simde_mm_store_si128((simde__m128i*)v40.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v62.u32), 0x54));
	// stvx128 v49,r6,r10
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r6.u32 + ctx.r10.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v49.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lis r5,-32255
	ctx.r5.s64 = -2113863680;
	// stvx128 v48,r6,r11
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r6.u32 + r11.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v48.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lis r4,-32256
	...
	// stb r3,752(r31)
	PPC_STORE_U8(r31.u32 + 752, ctx.r3.u8);
	// lfs f0,-26872(r5)
	temp.u32 = PPC_LOAD_U32(ctx.r5.u32 + -26872);
	f0.f64 = double(temp.f32);
	// stw r8,692(r31)
	PPC_STORE_U32(r31.u32 + 692, ctx.r8.u32);
	// lfs f13,11364(r4)
	...
	// stw r8,688(r31)
	PPC_STORE_U32(r31.u32 + 688, ctx.r8.u32);
	// stfs f30,704(r31)
	temp.f32 = float(f30.f64);
	PPC_STORE_U32(r31.u32 + 704, temp.u32);
	// mr r3,r31
...
PPC_WEAK_FUNC(sub_8217D5E8) {
	__imp__sub_8217D5E8(ctx, base);
}
...
loc_8217D7E0:
	...
	// stw r31,-26880(r11)
	PPC_STORE_U32(r11.u32 + -26880, r31.u32);
	// bl 0x8218a4e8
	ctx.lr = 0x8217D800;
	sub_8218A4E8(ctx, base);
	// lis r9,-32255
...
PPC_WEAK_FUNC(sub_8217D7B0) {
	__imp__sub_8217D7B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D824) {
	__imp__sub_8217D824(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D88C) {
	__imp__sub_8217D88C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D8FC) {
	__imp__sub_8217D8FC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D900) {
	__imp__sub_8217D900(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D914) {
	__imp__sub_8217D914(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D918) {
	__imp__sub_8217D918(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217D928) {
	...
	r11.s64 = -2105737216;
	// beq cr6,0x8217d968
	if (cr6.eq) goto loc_8217D968;
	// lwz r4,17320(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + 17320);
	// b 0x8217d97c
	goto loc_8217D97C;
loc_8217D968:
	// lwz r11,17320(r11)
...
PPC_WEAK_FUNC(sub_8217D928) {
	__imp__sub_8217D928(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D99C) {
	__imp__sub_8217D99C(ctx, base);
}
...
loc_8217D9B4:
	...
	// stw r6,-26864(r11)
	PPC_STORE_U32(r11.u32 + -26864, ctx.r6.u32);
	// lwz r5,-28096(r10)
...
PPC_WEAK_FUNC(sub_8217D9A0) {
	__imp__sub_8217D9A0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D9D4) {
	__imp__sub_8217D9D4(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217D9D8) {
	...
	ctx.r10.s64 = -2105278464;
	// lwz r3,-26864(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + -26864);
	// lwz r11,-25360(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -25360);
	// cmplw cr6,r3,r11
...
PPC_WEAK_FUNC(sub_8217D9D8) {
	__imp__sub_8217D9D8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217D9F8) {
	__imp__sub_8217D9F8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217DA18) {
	__imp__sub_8217DA18(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217DA70) {
	...
	r24.s64 = -2105278464;
	// stw r31,-26892(r28)
	PPC_STORE_U32(r28.u32 + -26892, r31.u32);
	// lis r23,-32124
	r23.s64 = -2105278464;
	// mr r9,r31
	ctx.r9.u64 = r31.u64;
	// lfs f8,-26924(r27)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(r27.u32 + -26924);
	ctx.f8.f64 = double(temp.f32);
	// lfs f7,-26916(r26)
	temp.u32 = PPC_LOAD_U32(r26.u32 + -26916);
	ctx.f7.f64 = double(temp.f32);
	// lfs f6,-26896(r25)
	...
	// lwz r9,-26892(r28)
	ctx.r9.u64 = PPC_LOAD_U32(r28.u32 + -26892);
	// lfs f8,-26924(r27)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(r27.u32 + -26924);
	ctx.f8.f64 = double(temp.f32);
...
PPC_WEAK_FUNC(sub_8217DB0C) {
	__imp__sub_8217DB0C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217DB10) {
	...
	r26.s64 = -2105278464;
	// stw r31,-26892(r30)
	PPC_STORE_U32(r30.u32 + -26892, r31.u32);
	// lis r25,-32124
	r25.s64 = -2105278464;
	// mr r9,r31
	ctx.r9.u64 = r31.u64;
	...
	sub_8217BC28(ctx, base);
	// lwz r9,-26892(r30)
	ctx.r9.u64 = PPC_LOAD_U32(r30.u32 + -26892);
	// lfs f8,-26924(r29)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(r29.u32 + -26924);
	ctx.f8.f64 = double(temp.f32);
...
PPC_WEAK_FUNC(sub_8217DB10) {
	__imp__sub_8217DB10(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217DFA0) {
	...
	simde_mm_store_si128((simde__m128i*)v54.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v58.u32), 0x15));
	// vpermwi128 v53,v58,186
	simde_mm_store_si128((simde__m128i*)v53.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v58.u32), 0x45));
	// addi r6,r1,160
	ctx.r6.s64 = ctx.r1.s64 + 160;
	// vpermwi128 v52,v58,174
	simde_mm_store_si128((simde__m128i*)v52.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)v58.u32), 0x51));
	// addi r11,r1,96
...
PPC_WEAK_FUNC(sub_8217DFA0) {
	__imp__sub_8217DFA0(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217E030) {
	...
	// addi r27,r10,-31648
	r27.s64 = ctx.r10.s64 + -31648;
	// addi r26,r9,2240
	r26.s64 = ctx.r9.s64 + 2240;
	// addi r25,r8,2528
	r25.s64 = ctx.r8.s64 + 2528;
loc_8217E0E4:
	// extsw r11,r18
	r11.s64 = r18.s32;
	// std r11,96(r1)
	...
	// fdivs f30,f11,f24
	f30.f64 = double(float(ctx.f11.f64 / f24.f64));
	// fmr f1,f30
	ctx.f1.f64 = f30.f64;
	// bl 0x823dbbc8
	ctx.lr = 0x8217E108;
	...
	// fmuls f5,f6,f25
	ctx.f5.f64 = double(float(ctx.f6.f64 * f25.f64));
	// fdivs f28,f5,f24
	f28.f64 = double(float(ctx.f5.f64 / f24.f64));
	// fmr f1,f28
	ctx.f1.f64 = f28.f64;
	// bl 0x823dbbc8
	ctx.lr = 0x8217E138;
...
loc_8217E188:
	...
	// fmuls f4,f6,f26
	ctx.f4.f64 = double(float(ctx.f6.f64 * f26.f64));
	// fmuls f22,f5,f29
	f22.f64 = double(float(ctx.f5.f64 * f29.f64));
	// fdivs f21,f4,f27
	f21.f64 = double(float(ctx.f4.f64 / f27.f64));
	// fmr f1,f21
	ctx.f1.f64 = f21.f64;
	// bl 0x823dbbc8
	ctx.lr = 0x8217E1E4;
	...
	// fmuls f23,f0,f28
	f23.f64 = double(float(f0.f64 * f28.f64));
	// bl 0x823dbae8
	ctx.lr = 0x8217E1FC;
	sub_823DBAE8(ctx, base);
	// frsp f13,f1
	...
	// fmuls f21,f11,f12
	f21.f64 = double(float(ctx.f11.f64 * ctx.f12.f64));
	// bl 0x823dbae8
	ctx.lr = 0x8217E214;
	sub_823DBAE8(ctx, base);
	// addi r8,r1,144
	...
	// lwz r9,-26892(r24)
	ctx.r9.u64 = PPC_LOAD_U32(r24.u32 + -26892);
	// lvx128 v63,r0,r8
	...
	ctx.f2.f64 = f31.f64;
	// lfs f8,-26924(r22)
	temp.u32 = PPC_LOAD_U32(r22.u32 + -26924);
	ctx.f8.f64 = double(temp.f32);
	// lfs f7,-26916(r23)
	temp.u32 = PPC_LOAD_U32(r23.u32 + -26916);
	ctx.f7.f64 = double(temp.f32);
	// fmuls f22,f9,f6
	f22.f64 = double(float(ctx.f9.f64 * ctx.f6.f64));
	...
	// stfs f5,-26908(r20)
	temp.f32 = float(ctx.f5.f64);
	PPC_STORE_U32(r20.u32 + -26908, temp.u32);
	// stfs f4,-26928(r19)
	temp.f32 = float(ctx.f4.f64);
	PPC_STORE_U32(r19.u32 + -26928, temp.u32);
	// stfs f6,-26896(r21)
	temp.f32 = float(ctx.f6.f64);
	PPC_STORE_U32(r21.u32 + -26896, temp.u32);
	// bl 0x8217bc28
	ctx.lr = 0x8217E2B0;
	sub_8217BC28(ctx, base);
	// addi r6,r1,160
	...
	// lvx128 v5,r0,r26
	simde_mm_store_si128((simde__m128i*)ctx.v5.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((r26.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v62,r0,r27
	...
	// vor128 v4,v58,v58
	simde_mm_store_si128((simde__m128i*)ctx.v4.u8, simde_mm_load_si128((simde__m128i*)v58.u8));
	// vcmpeqfp128 v3,v57,v61
	simde_mm_store_ps(ctx.v3.f32, simde_mm_cmpeq_ps(simde_mm_load_ps(v57.f32), simde_mm_load_ps(v61.f32)));
	// vor128 v2,v57,v57
	simde_mm_store_si128((simde__m128i*)ctx.v2.u8, simde_mm_load_si128((simde__m128i*)v57.u8));
	// vsel v0,v2,v5,v3
	...
	simde_mm_store_ps(v56.f32, simde_mm_mul_ps(simde_mm_load_ps(v63.f32), simde_mm_load_ps(v29.f32)));
	// stvx128 v56,r0,r5
...
loc_8217E434:
	...
	// fdivs f25,f11,f28
	f25.f64 = double(float(ctx.f11.f64 / f28.f64));
	// fmr f1,f25
	ctx.f1.f64 = f25.f64;
	// bl 0x823dbbc8
	ctx.lr = 0x8217E458;
	...
	ctx.f8.f64 = double(temp.f32);
	// lfs f7,-26916(r27)
	temp.u32 = PPC_LOAD_U32(r27.u32 + -26916);
	ctx.f7.f64 = double(temp.f32);
	// fmr f2,f29
	ctx.f2.f64 = f29.f64;
	// lfs f6,-26896(r25)
...
loc_8217E560:
	...
	ctx.f7.f64 = double(temp.f32);
	// fmuls f3,f29,f24
	ctx.f3.f64 = double(float(f29.f64 * f24.f64));
	// lfs f6,-26896(r25)
	temp.u32 = PPC_LOAD_U32(r25.u32 + -26896);
	ctx.f6.f64 = double(temp.f32);
	// fmuls f1,f31,f24
...
PPC_WEAK_FUNC(sub_8217E030) {
	__imp__sub_8217E030(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217E5EC) {
	__imp__sub_8217E5EC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217E5F0) {
	__imp__sub_8217E5F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217E68C) {
	__imp__sub_8217E68C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217E690) {
	...
	r30.s64 = -2105278464;
	// stw r9,-26892(r31)
	PPC_STORE_U32(r31.u32 + -26892, ctx.r9.u32);
	// lis r29,-32124
	r29.s64 = -2105278464;
	// lis r28,-32124
	r28.s64 = -2105278464;
	...
	ctx.f3.f64 = f31.f64;
	// lfs f8,-26924(r30)
	temp.u32 = PPC_LOAD_U32(r30.u32 + -26924);
	ctx.f8.f64 = double(temp.f32);
	// fmr f2,f31
	ctx.f2.f64 = f31.f64;
	// lfs f7,-26916(r29)
	temp.u32 = PPC_LOAD_U32(r29.u32 + -26916);
	ctx.f7.f64 = double(temp.f32);
	// fmr f1,f31
	ctx.f1.f64 = f31.f64;
	// lfs f6,-26896(r28)
	...
	ctx.f6.f64 = double(temp.f32);
	// lfs f5,-26908(r27)
	temp.u32 = PPC_LOAD_U32(r27.u32 + -26908);
	ctx.f5.f64 = double(temp.f32);
	// lfs f4,-26928(r26)
	...
	// fsubs f27,f30,f12
	f27.f64 = double(float(f30.f64 - ctx.f12.f64));
	// fadds f26,f12,f29
	f26.f64 = double(float(ctx.f12.f64 + f29.f64));
	// fsubs f25,f28,f12
	f25.f64 = double(float(f28.f64 - ctx.f12.f64));
	// bl 0x8217bb68
	ctx.lr = 0x8217E838;
	sub_8217BB68(ctx, base);
	// lis r9,32767
	...
	// fneg f24,f25
	ctx.fpscr.disableFlushMode();
	f24.u64 = f25.u64 ^ 0x8000000000000000;
	// lwz r9,-26892(r31)
	ctx.r9.u64 = PPC_LOAD_U32(r31.u32 + -26892);
	// lfs f8,-26924(r30)
	temp.u32 = PPC_LOAD_U32(r30.u32 + -26924);
...
PPC_WEAK_FUNC(sub_8217E690) {
	__imp__sub_8217E690(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217EBF4) {
	__imp__sub_8217EBF4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217EBF8) {
	__imp__sub_8217EBF8(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217EC68) {
	...
	// fmuls f22,f2,f13
	f22.f64 = double(float(ctx.f2.f64 * ctx.f13.f64));
	// stfs f23,96(r1)
	temp.f32 = float(f23.f64);
	PPC_STORE_U32(ctx.r1.u32 + 96, temp.u32);
	// stfs f22,100(r1)
	...
	PPC_STORE_U32(ctx.r1.u32 + 152, temp.u32);
	// fneg f0,f23
	f0.u64 = f23.u64 ^ 0x8000000000000000;
	// fneg f13,f22
	...
	ctx.r3.s64 = 2;
	// stw r30,-26892(r31)
	PPC_STORE_U32(r31.u32 + -26892, r30.u32);
	// bl 0x8217bb68
	ctx.lr = 0x8217ED10;
	sub_8217BB68(ctx, base);
	// lis r30,-32124
...
PPC_WEAK_FUNC(sub_8217EE7C) {
	__imp__sub_8217EE7C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217EE80) {
	__imp__sub_8217EE80(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217EEB0) {
	__imp__sub_8217EEB0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217EF24) {
	__imp__sub_8217EF24(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217EF28) {
	...
	// blt 0x8217f0ec
	if (cr0.lt) goto loc_8217F0EC;
	// lwz r10,16(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 16);
	// cmpw cr6,r11,r10
	cr6.compare<int32_t>(r11.s32, ctx.r10.s32, xer);
	// bge cr6,0x8217f0ec
	if (!cr6.lt) goto loc_8217F0EC;
	// lwz r9,20(r31)
	...
	// fmuls f30,f3,f13
	f30.f64 = double(float(ctx.f3.f64 * ctx.f13.f64));
	// fmuls f31,f2,f0
	...
	f29.f64 = double(temp.f32);
	// fsubs f28,f11,f29
	f28.f64 = double(float(ctx.f11.f64 - f29.f64));
	// bl 0x823dba38
	ctx.lr = 0x8217F03C;
	sub_823DBA38(ctx, base);
	// lwz r30,0(r13)
...
loc_8217F068:
	...
	ctx.f3.f64 = double(float(ctx.f3.f64 * f24.f64 + f28.f64));
	// fmadds f4,f10,f23,f29
	ctx.f4.f64 = double(float(ctx.f10.f64 * f23.f64 + f29.f64));
	// bl 0x8218f138
	ctx.lr = 0x8217F0C8;
...
PPC_WEAK_FUNC(sub_8217EF28) {
	__imp__sub_8217EF28(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217F144) {
	__imp__sub_8217F144(ctx, base);
}
...
loc_8217F1B8:
	...
	// cmpwi cr6,r29,341
	cr6.compare<int32_t>(r29.s32, 341, xer);
	// bgt cr6,0x8217f200
	if (cr6.gt) goto loc_8217F200;
	// lwz r9,0(r13)
...
loc_8217F210:
	...
	f30.f64 = double(float(ctx.f12.f64 * f28.f64 + f30.f64));
	// b 0x8217f2c0
	goto loc_8217F2C0;
loc_8217F264:
	// lwz r8,24(r31)
	...
	// beq cr6,0x8217f2a4
	if (cr6.eq) goto loc_8217F2A4;
	// lwz r10,12(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 12);
	// cmpw cr6,r11,r10
	cr6.compare<int32_t>(r11.s32, ctx.r10.s32, xer);
	// blt cr6,0x8217f2a4
	if (cr6.lt) goto loc_8217F2A4;
	// lwz r9,16(r31)
...
loc_8217F2B4:
	...
	f31.f64 = double(float(ctx.f12.f64 * f29.f64 + f31.f64));
loc_8217F2C0:
	// addi r30,r30,1
	r30.s64 = r30.s64 + 1;
	// lbz r11,0(r30)
	...
	cr6.compare<int32_t>(ctx.r10.s32, 0, xer);
	// bne cr6,0x8217f210
	if (!cr6.eq) goto loc_8217F210;
loc_8217F2D4:
	// cmpwi cr6,r29,341
	cr6.compare<int32_t>(r29.s32, 341, xer);
	// bgt cr6,0x8217f2f8
	if (cr6.gt) goto loc_8217F2F8;
	// lwz r9,0(r13)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r13.u32 + 0);
	// li r10,8
	ctx.r10.s64 = 8;
...
PPC_WEAK_FUNC(sub_8217F148) {
	__imp__sub_8217F148(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217F320) {
	...
	// stw r22,44(r3)
	PPC_STORE_U32(ctx.r3.u32 + 44, r22.u32);
	// b 0x8217f3ac
	goto loc_8217F3AC;
loc_8217F3A8:
	// mr r31,r22
...
loc_8217F3AC:
	...
	// lhz r6,0(r24)
	ctx.r6.u64 = PPC_LOAD_U16(r24.u32 + 0);
	// extsw r5,r6
...
loc_8217F460:
	...
	// twlgei r11,-1
	// mullw r23,r10,r8
	r23.s64 = int64_t(ctx.r10.s32) * int64_t(ctx.r8.s32);
	// twlgei r5,-1
	// mullw r26,r7,r6
	r26.s64 = int64_t(ctx.r7.s32) * int64_t(ctx.r6.s32);
	// li r27,4
	r27.s64 = 4;
	// cmpwi cr6,r8,4
	cr6.compare<int32_t>(ctx.r8.s32, 4, xer);
	// ble cr6,0x8217f51c
	if (!cr6.gt) goto loc_8217F51C;
loc_8217F4B8:
	// lwz r11,8(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 8);
	// li r25,1
	...
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// ble cr6,0x8217f500
	if (!cr6.gt) goto loc_8217F500;
	// add r29,r27,r23
	r29.u64 = r27.u64 + r23.u64;
loc_8217F4D0:
	// add r5,r30,r26
...
PPC_WEAK_FUNC(sub_8217F320) {
	__imp__sub_8217F320(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217F540) {
	__imp__sub_8217F540(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217F58C) {
	__imp__sub_8217F58C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217F590) {
	...
	cr6.compare<int32_t>(r18.s32, 0, xer);
	// ble cr6,0x8217f6a4
	if (!cr6.gt) goto loc_8217F6A4;
loc_8217F5F0:
	// rotlwi r11,r25,1
	r11.u64 = __builtin_rotateleft32(r25.u32, 1);
	// divw r9,r25,r23
	ctx.r9.s32 = r25.s32 / r23.s32;
	// rotlwi r10,r25,1
	ctx.r10.u64 = __builtin_rotateleft32(r25.u32, 1);
	// mullw r7,r9,r23
	ctx.r7.s64 = int64_t(ctx.r9.s32) * int64_t(r23.s32);
	// addi r8,r10,-1
	ctx.r8.s64 = ctx.r10.s64 + -1;
	// addi r6,r11,-1
	ctx.r6.s64 = r11.s64 + -1;
	// andc r5,r23,r8
	ctx.r5.u64 = r23.u64 & ~ctx.r8.u64;
	// subf r4,r7,r25
	ctx.r4.s64 = r25.s64 - ctx.r7.s64;
	// divw r3,r25,r23
	ctx.r3.s32 = r25.s32 / r23.s32;
	// andc r11,r23,r6
	r11.u64 = r23.u64 & ~ctx.r6.u64;
	// twllei r23,0
	// twllei r23,0
	// twlgei r5,-1
	// mullw r27,r4,r30
	r27.s64 = int64_t(ctx.r4.s32) * int64_t(r30.s32);
	// twlgei r11,-1
	// mullw r20,r3,r21
	r20.s64 = int64_t(ctx.r3.s32) * int64_t(r21.s32);
	// li r24,0
	r24.s64 = 0;
	// cmpwi cr6,r21,0
	cr6.compare<int32_t>(r21.s32, 0, xer);
	// ble cr6,0x8217f698
	if (!cr6.gt) goto loc_8217F698;
	// srawi r19,r30,3
...
loc_8217F640:
	...
	// ble cr6,0x8217f688
	if (!cr6.gt) goto loc_8217F688;
	// add r29,r24,r20
	r29.u64 = r24.u64 + r20.u64;
loc_8217F650:
	// clrlwi r11,r31,29
	r11.u64 = r31.u32 & 0x7;
	// mr r5,r29
...
PPC_WEAK_FUNC(sub_8217F590) {
	__imp__sub_8217F590(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217F6F0) {
	...
	f31.f64 = ctx.f1.f64;
	// lwz r3,-25800(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + -25800);
	// cmpwi cr6,r3,0
	cr6.compare<int32_t>(ctx.r3.s32, 0, xer);
	// bne cr6,0x8217f72c
	if (!cr6.eq) goto loc_8217F72C;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// li r4,0
	ctx.r4.s64 = 0;
	...
	sub_8218A4E8(ctx, base);
	// stw r3,-25800(r31)
	PPC_STORE_U32(r31.u32 + -25800, ctx.r3.u32);
loc_8217F72C:
	// stfs f31,80(r1)
	ctx.fpscr.disableFlushMode();
	temp.f32 = float(f31.f64);
...
PPC_WEAK_FUNC(sub_8217F6F0) {
	__imp__sub_8217F6F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217F758) {
	__imp__sub_8217F758(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217F768) {
	...
	// bgt cr6,0x8217fd54
	if (cr6.gt) goto loc_8217FD54;
	// lis r12,-32232
	r12.s64 = -2112356352;
	// addi r12,r12,-2132
	r12.s64 = r12.s64 + -2132;
	// rlwinm r0,r3,2,0,29
	...
	return;
	// lwz r16,-1972(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1972);
	// lwz r16,-1132(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1132);
	// lwz r16,-1880(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1880);
	// lwz r16,-1280(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1280);
	// lwz r16,-1224(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1224);
	// lwz r16,-1216(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1216);
	// lwz r16,-1156(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1156);
	// lwz r16,-1888(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1888);
	// lwz r16,-1916(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1916);
	// lwz r16,-1896(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1896);
	// lwz r16,-1252(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1252);
	// lwz r16,-1164(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1164);
	// lwz r16,-1148(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1148);
	// lwz r16,-1140(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1140);
	// lwz r16,-1104(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1104);
	// lwz r16,-1096(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1096);
	// lwz r16,-1944(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1944);
	// lwz r16,-1068(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1068);
	// lwz r16,-1040(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1040);
	// lwz r16,-1012(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1012);
	// lwz r16,-984(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -984);
	// lwz r16,-976(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -976);
	// lwz r16,-952(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -952);
	// lwz r16,-928(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -928);
	// lwz r16,-904(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -904);
	// lwz r16,-876(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -876);
	// lwz r16,-868(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -868);
	// lwz r16,-860(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -860);
	// lwz r16,-852(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -852);
	// lwz r16,-844(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -844);
	// lwz r16,-836(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -836);
	// lwz r16,-828(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -828);
	// lwz r16,-804(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -804);
	// lwz r16,-780(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -780);
	// lwz r16,-756(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -756);
	// lwz r16,-728(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -728);
	// lwz r16,-720(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -720);
	// lwz r16,-712(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -712);
	// lwz r16,-704(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -704);
	// lwz r16,-696(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -696);
	// lis r11,-32255
	r11.s64 = -2113863680;
	...
	// stw r31,-25600(r11)
	PPC_STORE_U32(r11.u32 + -25600, r31.u32);
	// bgt cr6,0x8217fd54
	if (cr6.gt) goto loc_8217FD54;
	// lis r12,-32232
	r12.s64 = -2112356352;
	// addi r12,r12,-1840
	r12.s64 = r12.s64 + -1840;
	...
	return;
	// lwz r16,-1784(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1784);
	// lwz r16,-1748(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1748);
	// lwz r16,-1712(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1712);
	// lwz r16,-1676(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1676);
	// lwz r16,-1640(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1640);
	// lwz r16,-1568(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1568);
	// lwz r16,-1532(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1532);
	// lwz r16,-1496(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1496);
	// lwz r16,-1460(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1460);
	// lwz r16,-1424(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1424);
	// lwz r16,-1388(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1388);
	// lwz r16,-1352(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1352);
	// lwz r16,-1604(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1604);
	// lwz r16,-1316(r23)
	r16.u64 = PPC_LOAD_U32(r23.u32 + -1316);
	// li r4,6
	ctx.r4.s64 = 6;
	// li r3,4
	ctx.r3.s64 = 4;
...
loc_8217FB10:
	...
	r11.s64 = -2105278464;
	// stw r31,-25604(r11)
	PPC_STORE_U32(r11.u32 + -25604, r31.u32);
	// addi r1,r1,96
	ctx.r1.s64 = ctx.r1.s64 + 96;
	// lwz r12,-8(r1)
	r12.u64 = PPC_LOAD_U32(ctx.r1.u32 + -8);
...
PPC_WEAK_FUNC(sub_8217F768) {
	__imp__sub_8217F768(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FD68) {
	__imp__sub_8217FD68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FDDC) {
	__imp__sub_8217FDDC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FDE0) {
	__imp__sub_8217FDE0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FE54) {
	__imp__sub_8217FE54(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FE58) {
	__imp__sub_8217FE58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FECC) {
	__imp__sub_8217FECC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FED0) {
	__imp__sub_8217FED0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FEE4) {
	__imp__sub_8217FEE4(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_8217FEE8) {
	...
	// stvx128 v58,r10,r9
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r10.u32 + ctx.r9.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v58.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// addi r10,r3,128
	...
	// stb r11,61(r10)
	PPC_STORE_U8(ctx.r10.u32 + 61, r11.u8);
	// lbz r9,190(r4)
...
PPC_WEAK_FUNC(sub_8217FEE8) {
	__imp__sub_8217FEE8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FFF4) {
	__imp__sub_8217FFF4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8217FFF8) {
	__imp__sub_8217FFF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180044) {
	__imp__sub_82180044(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82180048) {
	...
	simde_mm_store_si128((simde__m128i*)(base + ((r31.u32 + r11.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)v63.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lhz r11,208(r30)
	r11.u64 = PPC_LOAD_U16(r30.u32 + 208);
	// sth r11,208(r31)
	PPC_STORE_U16(r31.u32 + 208, r11.u16);
	// lhz r10,210(r30)
	ctx.r10.u64 = PPC_LOAD_U16(r30.u32 + 210);
	// sth r10,210(r31)
	PPC_STORE_U16(r31.u32 + 210, ctx.r10.u16);
	// addi r1,r1,112
	ctx.r1.s64 = ctx.r1.s64 + 112;
	// lwz r12,-8(r1)
	r12.u64 = PPC_LOAD_U32(ctx.r1.u32 + -8);
...
PPC_WEAK_FUNC(sub_82180048) {
	__imp__sub_82180048(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_821800A0) {
	...
	// lhz r11,210(r31)
	r11.u64 = PPC_LOAD_U16(r31.u32 + 210);
	// sth r11,210(r30)
	PPC_STORE_U16(r30.u32 + 210, r11.u16);
	// lhz r9,208(r31)
	ctx.r9.u64 = PPC_LOAD_U16(r31.u32 + 208);
	// extsh r30,r9
	r30.s64 = ctx.r9.s16;
	// cmpwi cr6,r30,0
	cr6.compare<int32_t>(r30.s32, 0, xer);
	// ble cr6,0x82180278
	if (!cr6.gt) goto loc_82180278;
	// lis r11,-32124
	r11.s64 = -2105278464;
	// lis r7,-32256
	ctx.r7.s64 = -2113929216;
	...
	ctx.r3.s64 = -28;
	// addi r29,r11,-25600
	r29.s64 = r11.s64 + -25600;
	// addi r28,r8,-32224
	r28.s64 = ctx.r8.s64 + -32224;
loc_8218012C:
	// lfs f13,-8(r10)
	ctx.fpscr.disableFlushMode();
	...
	// blt cr6,0x82180158
	if (cr6.lt) goto loc_82180158;
	// lbz r11,0(r10)
	r11.u64 = PPC_LOAD_U8(ctx.r10.u32 + 0);
	// cmplwi cr6,r11,1
	cr6.compare<uint32_t>(r11.u32, 1, xer);
	// bne cr6,0x82180158
	if (!cr6.eq) goto loc_82180158;
	// addi r11,r10,-44
...
loc_821801FC:
	...
	// lvx128 v60,r10,r3
	simde_mm_store_si128((simde__m128i*)v60.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r10.u32 + ctx.r3.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// std r8,80(r1)
	PPC_STORE_U64(ctx.r1.u32 + 80, ctx.r8.u64);
	// lfd f13,80(r1)
	ctx.fpscr.disableFlushMode();
...
loc_82180264:
	...
	// bne 0x8218012c
	if (!cr0.eq) goto loc_8218012C;
loc_82180278:
	// lis r11,-32124
	r11.s64 = -2105278464;
	// addi r31,r11,-25616
	r31.s64 = r11.s64 + -25616;
	// lwz r11,-172(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + -172);
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// bne cr6,0x821802f4
	if (!cr6.eq) goto loc_821802F4;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// li r4,0
	ctx.r4.s64 = 0;
	// addi r3,r11,-25620
	ctx.r3.s64 = r11.s64 + -25620;
	// bl 0x8218a4e8
	ctx.lr = 0x8218029C;
	sub_8218A4E8(ctx, base);
	// stw r3,-172(r31)
...
PPC_WEAK_FUNC(sub_821800A0) {
	__imp__sub_821800A0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180360) {
	__imp__sub_82180360(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82180370) {
	...
	// lwz r10,-25232(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + -25232);
	// cmplw cr6,r10,r3
	...
	ctx.r10.s64 = 0;
	// stw r10,-25232(r11)
	PPC_STORE_U32(r11.u32 + -25232, ctx.r10.u32);
	// blr 
	return;
}

PPC_WEAK_FUNC(sub_82180370) {
	__imp__sub_82180370(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180398) {
	__imp__sub_82180398(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821803A8) {
	__imp__sub_821803A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218041C) {
	__imp__sub_8218041C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180420) {
	__imp__sub_82180420(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218042C) {
	__imp__sub_8218042C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180430) {
	__imp__sub_82180430(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821804A8) {
	__imp__sub_821804A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180570) {
	__imp__sub_82180570(ctx, base);
}
...
loc_82180624:
	...
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// beq cr6,0x82180624
	if (cr6.eq) goto loc_82180624;
loc_82180648:
	// cmpwi cr6,r9,0
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// beq cr6,0x82180678
	if (cr6.eq) goto loc_82180678;
	// lwz r8,20(r8)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r8.u32 + 20);
	// cmplwi cr6,r8,0
	cr6.compare<uint32_t>(ctx.r8.u32, 0, xer);
	// bne cr6,0x8218061c
	if (!cr6.eq) goto loc_8218061C;
loc_8218065C:
	// li r3,0
	ctx.r3.s64 = 0;
loc_82180660:
...
PPC_WEAK_FUNC(sub_821805C0) {
	__imp__sub_821805C0(ctx, base);
}
...
loc_821806D8:
	...
	cr6.compare<int32_t>(ctx.r3.s32, 0, xer);
	// beq cr6,0x82180714
	if (cr6.eq) goto loc_82180714;
	// lwz r31,8(r31)
	r31.u64 = PPC_LOAD_U32(r31.u32 + 8);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// bne cr6,0x821806d8
	if (!cr6.eq) goto loc_821806D8;
loc_821806F8:
	// li r3,0
	ctx.r3.s64 = 0;
loc_821806FC:
...
PPC_WEAK_FUNC(sub_82180680) {
	__imp__sub_82180680(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218071C) {
	__imp__sub_8218071C(ctx, base);
}
...
loc_82180764:
	...
	// bdnz 0x82180764
	--ctr.u64;
	if (ctr.u32 != 0) goto loc_82180764;
loc_82180770:
	// lhz r11,4(r25)
...
loc_821807D0:
	...
	// blt cr6,0x82180784
	if (cr6.lt) goto loc_82180784;
loc_821807E4:
	// sth r24,4(r25)
	PPC_STORE_U16(r25.u32 + 4, r24.u16);
	// lwz r3,0(r25)
...
PPC_WEAK_FUNC(sub_821807FC) {
	__imp__sub_821807FC(ctx, base);
}
...
loc_82180844:
	...
	// bdnz 0x82180844
	--ctr.u64;
	if (ctr.u32 != 0) goto loc_82180844;
loc_82180850:
	// lhz r11,4(r25)
	r11.u64 = PPC_LOAD_U16(r25.u32 + 4);
	// li r26,0
...
PPC_WEAK_FUNC(sub_821808DC) {
	__imp__sub_821808DC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821808E0) {
	__imp__sub_821808E0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180900) {
	__imp__sub_82180900(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180920) {
	__imp__sub_82180920(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180974) {
	__imp__sub_82180974(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180978) {
	__imp__sub_82180978(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180A2C) {
	__imp__sub_82180A2C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82180A30) {
	...
	// stw r11,-25360(r6)
	PPC_STORE_U32(ctx.r6.u32 + -25360, r11.u32);
	// li r5,0
	ctx.r5.s64 = 0;
	// lwz r11,0(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + 0);
...
PPC_WEAK_FUNC(sub_82180B60) {
	__imp__sub_82180B60(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180B90) {
	__imp__sub_82180B90(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82180BE0) {
	...
	// fdivs f29,f29,f7
	f29.f64 = double(float(f29.f64 / ctx.f7.f64));
	// mtctr r4
	ctr.u64 = ctx.r4.u64;
	// bctrl 
	ctx.lr = 0x82180C94;
	...
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// stw r11,-21076(r10)
	PPC_STORE_U32(ctx.r10.u32 + -21076, r11.u32);
	// beq cr6,0x82180d14
	if (cr6.eq) goto loc_82180D14;
	// lis r8,-32124
	ctx.r8.s64 = -2105278464;
	// li r10,0
	ctx.r10.s64 = 0;
	...
	r11.s64 = r11.s64 + -16;
	// stw r11,-21088(r27)
	PPC_STORE_U32(r27.u32 + -21088, r11.u32);
loc_82180D14:
	// addi r5,r31,48
...
PPC_WEAK_FUNC(sub_82180BE0) {
	__imp__sub_82180BE0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180DF4) {
	__imp__sub_82180DF4(ctx, base);
}
...
loc_82180ED4:
	...
	PPC_STORE_U32(ctx.r5.u32 + 0, temp.u32);
	// lhz r8,50(r11)
	ctx.r8.u64 = PPC_LOAD_U16(r11.u32 + 50);
	// extsw r7,r8
...
PPC_WEAK_FUNC(sub_82180DF8) {
	__imp__sub_82180DF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180FCC) {
	__imp__sub_82180FCC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82180FD0) {
	__imp__sub_82180FD0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821810B0) {
	__imp__sub_821810B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82181114) {
	__imp__sub_82181114(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82181180) {
	__imp__sub_82181180(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821811BC) {
	__imp__sub_821811BC(ctx, base);
}
...
loc_821811E4:
	...
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// beq cr6,0x821811e4
	if (cr6.eq) goto loc_821811E4;
loc_82181208:
	// cmpwi cr6,r9,0
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// bne cr6,0x82181220
	if (!cr6.eq) goto loc_82181220;
	// lis r11,-32124
	r11.s64 = -2105278464;
	// lwz r31,-25360(r11)
	r31.u64 = PPC_LOAD_U32(r11.u32 + -25360);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// bne cr6,0x82181244
	if (!cr6.eq) goto loc_82181244;
loc_82181220:
	// lis r11,-32124
	r11.s64 = -2105278464;
	// addi r4,r1,156
	...
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x82181258
	if (cr6.eq) goto loc_82181258;
	// lwz r31,0(r3)
	r31.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x82181314
	if (cr6.eq) goto loc_82181314;
loc_82181244:
	// addi r3,r31,8
	ctx.r3.s64 = r31.s64 + 8;
	// bl 0x821ce0d8
...
loc_82181258:
	...
	r11.s64 = -2105278464;
	// lwz r29,-24880(r11)
	r29.u64 = PPC_LOAD_U32(r11.u32 + -24880);
	// cmplwi cr6,r29,0
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// beq cr6,0x82181320
	if (cr6.eq) goto loc_82181320;
	// li r4,0
	ctx.r4.s64 = 0;
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
...
loc_82181288:
	...
	// beq cr6,0x821812e4
	if (cr6.eq) goto loc_821812E4;
	// bge cr6,0x821812ac
	if (!cr6.lt) goto loc_821812AC;
	// addi r9,r11,-1
	ctx.r9.s64 = r11.s64 + -1;
	// b 0x821812b0
	goto loc_821812B0;
...
loc_821812BC:
	...
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// beq cr6,0x821812fc
	if (cr6.eq) goto loc_821812FC;
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x82181274
	if (cr6.eq) goto loc_82181274;
	// addi r3,r31,8
	ctx.r3.s64 = r31.s64 + 8;
	// bl 0x821ce0d8
	ctx.lr = 0x821812D8;
...
PPC_WEAK_FUNC(sub_821811C0) {
	__imp__sub_821811C0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218132C) {
	__imp__sub_8218132C(ctx, base);
}
...
loc_82181390:
	...
	r11.s64 = -2105278464;
	// lwz r30,-24880(r11)
	r30.u64 = PPC_LOAD_U32(r11.u32 + -24880);
	// cmplwi cr6,r30,0
	cr6.compare<uint32_t>(r30.u32, 0, xer);
	// beq cr6,0x821813d4
	if (cr6.eq) goto loc_821813D4;
	// li r4,0
	ctx.r4.s64 = 0;
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
...
PPC_WEAK_FUNC(sub_82181330) {
	__imp__sub_82181330(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218145C) {
	__imp__sub_8218145C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82181460) {
	__imp__sub_82181460(ctx, base);
}
...
loc_82181688:
	...
	// bgt cr6,0x82181970
	if (cr6.gt) goto loc_82181970;
	// lis r12,-32232
	r12.s64 = -2112356352;
	// addi r12,r12,5808
	r12.s64 = r12.s64 + 5808;
	...
	return;
	// lwz r16,5824(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 5824);
	// lwz r16,5996(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 5996);
	// lwz r16,6168(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 6168);
	// lwz r16,6340(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 6340);
	// li r11,16
	r11.s64 = 16;
	// li r3,16
	ctx.r3.s64 = 16;
...
loc_8218199C:
	...
	cr6.compare<int32_t>(ctx.r10.s32, 0, xer);
	// stw r10,-21076(r11)
	PPC_STORE_U32(r11.u32 + -21076, ctx.r10.u32);
	// beq cr6,0x82181a38
	if (cr6.eq) goto loc_82181A38;
	// lis r9,-32124
	ctx.r9.s64 = -2105278464;
	// li r11,0
	r11.s64 = 0;
	...
	// stb r11,-21095(r9)
	PPC_STORE_U8(ctx.r9.u32 + -21095, r11.u8);
	// lwz r11,0(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 0);
	// add r11,r10,r11
	r11.u64 = ctx.r10.u64 + r11.u64;
	...
	r11.s64 = r11.s64 + -16;
	// stw r11,-21088(r30)
	PPC_STORE_U32(r30.u32 + -21088, r11.u32);
	// lhz r11,12(r11)
	r11.u64 = PPC_LOAD_U16(r11.u32 + 12);
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// ble cr6,0x82181a38
	if (!cr6.gt) goto loc_82181A38;
	// addi r5,r31,48
	ctx.r5.s64 = r31.s64 + 48;
	// li r4,0
	ctx.r4.s64 = 0;
...
PPC_WEAK_FUNC(sub_82181A88) {
	__imp__sub_82181A88(ctx, base);
}
...
loc_82181B78:
	...
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// beq cr6,0x82181b78
	if (cr6.eq) goto loc_82181B78;
loc_82181B9C:
	// cmpwi cr6,r9,0
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// beq cr6,0x82181c34
	if (cr6.eq) goto loc_82181C34;
	// lwz r8,20(r8)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r8.u32 + 20);
	// cmplwi cr6,r8,0
	cr6.compare<uint32_t>(ctx.r8.u32, 0, xer);
	// bne cr6,0x82181b70
	if (!cr6.eq) goto loc_82181B70;
loc_82181BB0:
	// lhz r11,6(r29)
	r11.u64 = PPC_LOAD_U16(r29.u32 + 6);
	// addi r11,r11,1
...
PPC_WEAK_FUNC(sub_82181B10) {
	__imp__sub_82181B10(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82181C68) {
	__imp__sub_82181C68(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82181D58) {
	...
	r29.s64 = -2105278464;
	// lwz r31,-25360(r29)
	r31.u64 = PPC_LOAD_U32(r29.u32 + -25360);
	// addi r3,r31,8
	ctx.r3.s64 = r31.s64 + 8;
	// bl 0x821ce100
	ctx.lr = 0x82181D78;
...
loc_82181DA0:
	...
	r30.s64 = -2105278464;
	// stw r11,-25360(r29)
	PPC_STORE_U32(r29.u32 + -25360, r11.u32);
	// lwz r31,-25356(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + -25356);
	// addi r3,r31,8
	ctx.r3.s64 = r31.s64 + 8;
	// bl 0x821ce100
	ctx.lr = 0x82181DB8;
...
loc_82181DE0:
	...
	ctx.r10.s64 = -2105278464;
	// stw r11,-25356(r30)
	PPC_STORE_U32(r30.u32 + -25356, r11.u32);
	// addi r3,r10,-25044
	...
	ctx.r9.s64 = -2105278464;
	// lwz r31,-25240(r9)
	r31.u64 = PPC_LOAD_U32(ctx.r9.u32 + -25240);
	// addi r3,r31,8
	ctx.r3.s64 = r31.s64 + 8;
	// bl 0x821ce100
	ctx.lr = 0x82181E04;
...
loc_82181E2C:
	...
	r11.s64 = -2105278464;
	// lwz r31,-25236(r11)
	r31.u64 = PPC_LOAD_U32(r11.u32 + -25236);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x82181e6c
	if (cr6.eq) goto loc_82181E6C;
	// addi r3,r31,8
	ctx.r3.s64 = r31.s64 + 8;
	// bl 0x821ce100
	ctx.lr = 0x82181E44;
...
PPC_WEAK_FUNC(sub_82181D58) {
	__imp__sub_82181D58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82181E74) {
	__imp__sub_82181E74(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82181E78) {
	...
	r11.s64 = -2113863680;
	// addi r24,r7,-24892
	r24.s64 = ctx.r7.s64 + -24892;
	// addi r30,r6,-24916
	r30.s64 = ctx.r6.s64 + -24916;
	// addi r29,r5,-24932
	r29.s64 = ctx.r5.s64 + -24932;
	// addi r28,r4,-24944
	r28.s64 = ctx.r4.s64 + -24944;
	// addi r27,r3,-24956
	r27.s64 = ctx.r3.s64 + -24956;
	// addi r26,r8,-24964
	r26.s64 = ctx.r8.s64 + -24964;
	// addi r25,r9,-24972
	r25.s64 = ctx.r9.s64 + -24972;
	// addi r31,r10,-29628
	r31.s64 = ctx.r10.s64 + -29628;
	// addi r23,r11,-29624
...
PPC_WEAK_FUNC(sub_82181E78) {
	__imp__sub_82181E78(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182120) {
	__imp__sub_82182120(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182150) {
	__imp__sub_82182150(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82182188) {
	...
	r11.s64 = -2113863680;
	// addi r10,r11,-24860
	ctx.r10.s64 = r11.s64 + -24860;
	// stw r10,0(r28)
	PPC_STORE_U32(r28.u32 + 0, ctx.r10.u32);
	// lhz r31,42(r28)
	r31.u64 = PPC_LOAD_U16(r28.u32 + 42);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x821821dc
	if (cr6.eq) goto loc_821821DC;
	// lwz r29,36(r28)
	r29.u64 = PPC_LOAD_U32(r28.u32 + 36);
	// cmpwi cr6,r31,0
	cr6.compare<int32_t>(r31.s32, 0, xer);
	// ble cr6,0x821821d4
	if (!cr6.gt) goto loc_821821D4;
	// mr r30,r29
	r30.u64 = r29.u64;
loc_821821C0:
	// lwz r3,0(r30)
...
loc_821821DC:
	// lhz r31,34(r28)
	r31.u64 = PPC_LOAD_U16(r28.u32 + 34);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x82182214
	if (cr6.eq) goto loc_82182214;
	// lwz r29,28(r28)
	r29.u64 = PPC_LOAD_U32(r28.u32 + 28);
	// cmpwi cr6,r31,0
	cr6.compare<int32_t>(r31.s32, 0, xer);
	// ble cr6,0x8218220c
	if (!cr6.gt) goto loc_8218220C;
	// mr r30,r29
	r30.u64 = r29.u64;
loc_821821F8:
	// lwz r3,0(r30)
...
PPC_WEAK_FUNC(sub_82182188) {
	__imp__sub_82182188(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182230) {
	__imp__sub_82182230(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218223C) {
	__imp__sub_8218223C(ctx, base);
}
...
loc_82182290:
	...
	r11.s64 = -2113863680;
	// addi r29,r10,-25044
	r29.s64 = ctx.r10.s64 + -25044;
	// addi r26,r11,-24588
	r26.s64 = r11.s64 + -24588;
loc_82182330:
	// li r5,128
	ctx.r5.s64 = 128;
	// addi r4,r1,96
...
PPC_WEAK_FUNC(sub_82182240) {
	__imp__sub_82182240(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218241C) {
	__imp__sub_8218241C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182420) {
	__imp__sub_82182420(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182470) {
	__imp__sub_82182470(ctx, base);
}
...
loc_821825F8:
	...
	cr6.compare<int32_t>(ctx.r3.s32, 1, xer);
	// ble cr6,0x82182660
	if (!cr6.gt) goto loc_82182660;
	// cmplwi cr6,r29,0
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// beq cr6,0x82182640
	if (cr6.eq) goto loc_82182640;
	// lbz r11,24(r29)
...
loc_82182660:
	...
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x82182778
	if (cr6.eq) goto loc_82182778;
	// cmplwi cr6,r29,0
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// beq cr6,0x82182708
	if (cr6.eq) goto loc_82182708;
	// addi r10,r1,80
	ctx.r10.s64 = ctx.r1.s64 + 80;
	// mr r11,r29
	r11.u64 = r29.u64;
...
loc_8218268C:
	...
	// bdnz 0x8218268c
	--ctr.u64;
	if (ctr.u32 != 0) goto loc_8218268C;
	// lwz r11,56(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + 56);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x821826b0
	if (!cr6.eq) goto loc_821826B0;
	// stb r26,101(r1)
	PPC_STORE_U8(ctx.r1.u32 + 101, r26.u8);
loc_821826B0:
	// lbz r11,23(r29)
	r11.u64 = PPC_LOAD_U8(r29.u32 + 23);
	// cmplwi cr6,r11,0
...
loc_821826DC:
	// lbz r11,22(r29)
	r11.u64 = PPC_LOAD_U8(r29.u32 + 22);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82182728
	if (cr6.eq) goto loc_82182728;
	// lwz r11,0(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 0);
	// mr r5,r28
	ctx.r5.u64 = r28.u64;
...
loc_82182728:
	...
	cr6.compare<int32_t>(ctx.r3.s32, 1, xer);
	// ble cr6,0x82182778
	if (!cr6.gt) goto loc_82182778;
	// cmplwi cr6,r29,0
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// beq cr6,0x82182758
	if (cr6.eq) goto loc_82182758;
	// lbz r11,24(r29)
	r11.u64 = PPC_LOAD_U8(r29.u32 + 24);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_82182778:
	...
	cr6.compare<int32_t>(r27.s32, 0, xer);
	// bne cr6,0x821827b8
	if (!cr6.eq) goto loc_821827B8;
	// lbz r11,4(r30)
	r11.u64 = PPC_LOAD_U8(r30.u32 + 4);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x8218279c
	if (cr6.eq) goto loc_8218279C;
	// lwz r3,40(r30)
...
loc_8218279C:
	...
	// stw r11,17008(r8)
	PPC_STORE_U32(ctx.r8.u32 + 17008, r11.u32);
loc_821827B8:
	// addi r11,r27,2
	r11.s64 = r27.s64 + 2;
	// mr r3,r27
...
PPC_FUNC_IMPL(__imp__sub_821827E8) {
	...
	r11.s64 = -2105278464;
	// lwz r11,-27788(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -27788);
	// addi r10,r11,17
	ctx.r10.s64 = r11.s64 + 17;
	// bne cr6,0x82182804
	if (!cr6.eq) goto loc_82182804;
	// subfic r10,r11,18
	xer.ca = r11.u32 <= 18;
	ctx.r10.s64 = 18 - r11.s64;
loc_82182804:
	// rlwinm r9,r10,2,0,29
	ctx.r9.u64 = __builtin_rotateleft64(ctx.r10.u32 | (ctx.r10.u64 << 32), 2) & 0xFFFFFFFC;
	// lwzx r3,r9,r3
...
PPC_WEAK_FUNC(sub_821827E8) {
	__imp__sub_821827E8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182810) {
	__imp__sub_82182810(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182820) {
	__imp__sub_82182820(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182830) {
	__imp__sub_82182830(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182840) {
	__imp__sub_82182840(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182898) {
	__imp__sub_82182898(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821828E4) {
	__imp__sub_821828E4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821828E8) {
	__imp__sub_821828E8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821828F8) {
	__imp__sub_821828F8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182914) {
	__imp__sub_82182914(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182918) {
	__imp__sub_82182918(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182A04) {
	__imp__sub_82182A04(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82182A08) {
	...
	// beq cr6,0x82182b10
	if (cr6.eq) goto loc_82182B10;
	// cmpwi cr6,r3,17
	cr6.compare<int32_t>(ctx.r3.s32, 17, xer);
	// beq cr6,0x82182ad0
	if (cr6.eq) goto loc_82182AD0;
	// cmpwi cr6,r3,18
	cr6.compare<int32_t>(ctx.r3.s32, 18, xer);
	// beq cr6,0x82182a98
	if (cr6.eq) goto loc_82182A98;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// addi r3,r11,-23500
	ctx.r3.s64 = r11.s64 + -23500;
	// bl 0x821bd618
	ctx.lr = 0x82182A8C;
	sub_821BD618(ctx, base);
	// li r3,0
...
PPC_WEAK_FUNC(sub_82182A08) {
	__imp__sub_82182A08(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182B44) {
	__imp__sub_82182B44(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82182B48) {
	...
	cr6.compare<int32_t>(ctx.r3.s32, 3, xer);
	// beq cr6,0x82182bc0
	if (cr6.eq) goto loc_82182BC0;
	// cmpwi cr6,r3,17
	cr6.compare<int32_t>(ctx.r3.s32, 17, xer);
	// beq cr6,0x82182bac
	if (cr6.eq) goto loc_82182BAC;
	// cmpwi cr6,r3,18
	cr6.compare<int32_t>(ctx.r3.s32, 18, xer);
	// beq cr6,0x82182b94
	if (cr6.eq) goto loc_82182B94;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// addi r3,r11,-23500
	ctx.r3.s64 = r11.s64 + -23500;
...
PPC_WEAK_FUNC(sub_82182B48) {
	__imp__sub_82182B48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182BD4) {
	__imp__sub_82182BD4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182BD8) {
	__imp__sub_82182BD8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182C04) {
	__imp__sub_82182C04(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182C08) {
	__imp__sub_82182C08(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182C24) {
	__imp__sub_82182C24(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82182C28) {
	...
	PPC_STORE_U32(r31.u32 + 0, ctx.r9.u32);
	// sth r28,34(r31)
	PPC_STORE_U16(r31.u32 + 34, r28.u16);
	// stw r30,20(r31)
	PPC_STORE_U32(r31.u32 + 20, r30.u32);
	// bl 0x82410be8
	ctx.lr = 0x82182C78;
...
PPC_WEAK_FUNC(sub_82182C28) {
	__imp__sub_82182C28(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182CD8) {
	__imp__sub_82182CD8(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82182D24) {
	...
	PPCRegister r24{};
	// lwz r16,11644(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11644);
	// lwz r16,11700(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11700);
	// lwz r16,11732(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11732);
	// lwz r16,11764(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11764);
	// lwz r16,11796(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11796);
	// lwz r16,11828(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11828);
	// lwz r16,11852(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11852);
	// lwz r16,11876(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11876);
	// lwz r16,12184(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 12184);
	// lwz r16,12184(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 12184);
	// lwz r16,11888(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11888);
	// lwz r16,11920(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11920);
	// lwz r16,11944(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11944);
	// lwz r16,11956(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11956);
	// lwz r16,11980(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11980);
	// lwz r16,12012(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 12012);
	// lwz r16,12044(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 12044);
	// lwz r16,12076(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 12076);
	// lwz r16,12108(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 12108);
	// lwz r16,12120(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 12120);
	// lwz r16,11668(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 11668);
	// lwz r16,12152(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 12152);
	// clrlwi r11,r11,24
	r11.u64 = r11.u32 & 0xFF;
	// lis r3,6184
...
PPC_WEAK_FUNC(sub_82182D24) {
	__imp__sub_82182D24(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182D94) {
	__imp__sub_82182D94(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182DB4) {
	__imp__sub_82182DB4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182DD4) {
	__imp__sub_82182DD4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182DF4) {
	__imp__sub_82182DF4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182E14) {
	__imp__sub_82182E14(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182E34) {
	__imp__sub_82182E34(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182E4C) {
	__imp__sub_82182E4C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182E64) {
	__imp__sub_82182E64(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182E70) {
	__imp__sub_82182E70(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182E90) {
	__imp__sub_82182E90(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182EB4) {
	__imp__sub_82182EB4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182ECC) {
	__imp__sub_82182ECC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182EEC) {
	__imp__sub_82182EEC(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182F0C) {
	__imp__sub_82182F0C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182F2C) {
	__imp__sub_82182F2C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182F4C) {
	__imp__sub_82182F4C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182F58) {
	__imp__sub_82182F58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82182F98) {
	__imp__sub_82182F98(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82182FA0) {
	...
	cr6.compare<uint32_t>(r31.u32, ctx.r3.u32, xer);
	// bne cr6,0x82183290
	if (!cr6.eq) goto loc_82183290;
	// lhz r11,32(r24)
	r11.u64 = PPC_LOAD_U16(r24.u32 + 32);
	// lhz r10,0(r19)
	ctx.r10.u64 = PPC_LOAD_U16(r19.u32 + 0);
	// cmplw cr6,r11,r10
	...
	r23.u64 = __builtin_rotateleft64(ctx.r9.u32 | (ctx.r9.u64 << 32), 21) & 0x1;
loc_8218303C:
	// addi r5,r1,192
	...
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// ble 0x82183240
	if (!cr0.gt) goto loc_82183240;
	// clrlwi r22,r18,24
	r22.u64 = r18.u32 & 0xFF;
loc_82183068:
	// lwz r3,28(r24)
	ctx.r3.u64 = PPC_LOAD_U32(r24.u32 + 28);
	// cmplwi cr6,r22,1
...
loc_821830B4:
	...
	// lhz r10,12(r25)
	ctx.r10.u64 = PPC_LOAD_U16(r25.u32 + 12);
	// twllei r11,0
	// divwu r9,r29,r11
	ctx.r9.u32 = r29.u32 / r11.u32;
	// clrlwi r11,r23,24
	r11.u64 = r23.u32 & 0xFF;
	// mullw r28,r9,r10
	r28.s64 = int64_t(ctx.r9.s32) * int64_t(ctx.r10.s32);
	// bne cr6,0x8218317c
	if (!cr6.eq) goto loc_8218317C;
	// lwz r27,200(r1)
	...
	// srw r8,r26,r31
	ctx.r8.u64 = r31.u8 & 0x20 ? 0 : (r26.u32 >> (r31.u8 & 0x3F));
	// lwz r17,16(r25)
	...
	// addi r15,r1,136
	r15.s64 = ctx.r1.s64 + 136;
	// stw r30,144(r1)
	PPC_STORE_U32(ctx.r1.u32 + 144, r30.u32);
	// cntlzw r14,r11
	r14.u64 = r11.u32 == 0 ? 32 : __builtin_clz(r11.u32);
	// stw r30,160(r1)
	...
	ctx.r8.u64 = __builtin_rotateleft64(r14.u32 | (r14.u64 << 32), 27) & 0x1;
	// stw r11,100(r1)
...
loc_8218317C:
	...
	// cntlzw r26,r11
	r26.u64 = r11.u32 == 0 ? 32 : __builtin_clz(r11.u32);
	// bl 0x821828f8
	ctx.lr = 0x82183188;
	sub_821828F8(ctx, base);
	// clrlwi r6,r3,26
	...
	ctx.r7.u64 = __builtin_rotateleft64(r26.u32 | (r26.u64 << 32), 27) & 0x1;
	// stw r28,84(r1)
...
loc_82183224:
	...
	ctx.r3.u64 = r21.u64;
	// lwz r25,24(r25)
	r25.u64 = PPC_LOAD_U32(r25.u32 + 24);
	// addi r31,r31,1
	r31.s64 = r31.s64 + 1;
	// bl 0x8218cd80
	ctx.lr = 0x82183234;
	...
	cr6.compare<int32_t>(r31.s32, r11.s32, xer);
	// blt cr6,0x82183068
	if (cr6.lt) goto loc_82183068;
loc_82183240:
	// lwz r21,28(r21)
	r21.u64 = PPC_LOAD_U32(r21.u32 + 28);
	// addi r20,r20,1
	r20.s64 = r20.s64 + 1;
	// cmplwi cr6,r21,0
	cr6.compare<uint32_t>(r21.u32, 0, xer);
	// bne cr6,0x8218303c
	if (!cr6.eq) goto loc_8218303C;
	// bl 0x821bbf00
	ctx.lr = 0x82183254;
	sub_821BBF00(ctx, base);
	// lfs f0,48(r19)
	...
	ctx.r3.s64 = 1;
	// lfs f13,52(r19)
	temp.u32 = PPC_LOAD_U32(r19.u32 + 52);
	ctx.f13.f64 = double(temp.f32);
	// stfs f13,44(r24)
	temp.f32 = float(ctx.f13.f64);
...
PPC_WEAK_FUNC(sub_82182FA0) {
	__imp__sub_82182FA0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218329C) {
	__imp__sub_8218329C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_821832A0) {
	...
	r26.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 20) & 0xFFFFF;
	// bl 0x82430938
	ctx.lr = 0x8218330C;
	...
	ctx.r8.u64 = (__builtin_rotateleft32(r26.u32, 12) & 0xFFFFF000) | (ctx.r8.u64 & 0xFFFFFFFF00000FFF);
	// oris r6,r7,32
...
PPC_WEAK_FUNC(sub_821832A0) {
	__imp__sub_821832A0(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82183398) {
	...
	cr6.compare<int32_t>(ctx.r3.s32, 3, xer);
	// beq cr6,0x821834a0
	if (cr6.eq) goto loc_821834A0;
	// cmpwi cr6,r3,17
	cr6.compare<int32_t>(ctx.r3.s32, 17, xer);
	// beq cr6,0x82183460
	if (cr6.eq) goto loc_82183460;
	// cmpwi cr6,r3,18
	cr6.compare<int32_t>(ctx.r3.s32, 18, xer);
	// beq cr6,0x82183428
	if (cr6.eq) goto loc_82183428;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// addi r3,r11,-23500
	ctx.r3.s64 = r11.s64 + -23500;
...
PPC_WEAK_FUNC(sub_82183398) {
	__imp__sub_82183398(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821834D4) {
	__imp__sub_821834D4(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_821834D8) {
	...
	cr6.compare<int32_t>(ctx.r3.s32, 3, xer);
	// beq cr6,0x82183550
	if (cr6.eq) goto loc_82183550;
	// cmpwi cr6,r3,17
	cr6.compare<int32_t>(ctx.r3.s32, 17, xer);
	// beq cr6,0x8218353c
	if (cr6.eq) goto loc_8218353C;
	// cmpwi cr6,r3,18
	cr6.compare<int32_t>(ctx.r3.s32, 18, xer);
	// beq cr6,0x82183524
	if (cr6.eq) goto loc_82183524;
	// lis r11,-32255
	r11.s64 = -2113863680;
	// addi r3,r11,-23500
	ctx.r3.s64 = r11.s64 + -23500;
...
PPC_WEAK_FUNC(sub_821834D8) {
	__imp__sub_821834D8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183564) {
	__imp__sub_82183564(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183568) {
	__imp__sub_82183568(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183594) {
	__imp__sub_82183594(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183598) {
	__imp__sub_82183598(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183620) {
	__imp__sub_82183620(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183638) {
	__imp__sub_82183638(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183680) {
	__imp__sub_82183680(ctx, base);
}
...
loc_8218373C:
	...
	r11.s64 = -2105278464;
	// stw r3,-24876(r11)
	PPC_STORE_U32(r11.u32 + -24876, ctx.r3.u32);
	// blr 
	return;
}

PPC_WEAK_FUNC(sub_82183710) {
	__imp__sub_82183710(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82183748) {
	...
	ctx.r9.s64 = r11.s64 + -1;
	// lwz r11,-24876(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + -24876);
	// andc r9,r9,r10
	ctx.r9.u64 = ctx.r9.u64 & ~ctx.r10.u64;
	// lwz r8,20(r11)
	...
	// lwz r5,-24876(r31)
	ctx.r5.u64 = PPC_LOAD_U32(r31.u32 + -24876);
	// lwz r11,16(r5)
...
PPC_WEAK_FUNC(sub_82183748) {
	__imp__sub_82183748(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218381C) {
	__imp__sub_8218381C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183820) {
	__imp__sub_82183820(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218386C) {
	__imp__sub_8218386C(ctx, base);
}
...
loc_8218387C:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x821838c4
	if (cr6.eq) goto loc_821838C4;
	// cmplwi cr6,r11,65
	cr6.compare<uint32_t>(r11.u32, 65, xer);
	// blt cr6,0x821838a8
	if (cr6.lt) goto loc_821838A8;
	// cmplwi cr6,r11,90
	cr6.compare<uint32_t>(r11.u32, 90, xer);
	// bgt cr6,0x821838a8
	if (cr6.gt) goto loc_821838A8;
	// addi r11,r11,32
	r11.s64 = r11.s64 + 32;
	// b 0x821838b4
	goto loc_821838B4;
...
PPC_WEAK_FUNC(sub_82183870) {
	__imp__sub_82183870(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821838D0) {
	__imp__sub_821838D0(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82183920) {
	...
	ctx.r3.s64 = 64;
	// oris r9,r11,32
	ctx.r9.u64 = r11.u64 | 2097152;
	// rlwimi r10,r26,0,0,19
	ctx.r10.u64 = (__builtin_rotateleft32(r26.u32, 0) & 0xFFFFF000) | (ctx.r10.u64 & 0xFFFFFFFF00000FFF);
	// stw r9,0(r31)
	PPC_STORE_U32(r31.u32 + 0, ctx.r9.u32);
	// stw r10,32(r31)
...
PPC_WEAK_FUNC(sub_82183920) {
	__imp__sub_82183920(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821839CC) {
	__imp__sub_821839CC(ctx, base);
}
...
loc_82183A28:
	...
	if (cr6.eq) goto loc_82183A4C;
	// lwz r27,68(r30)
	r27.u64 = PPC_LOAD_U32(r30.u32 + 68);
	// stw r29,72(r30)
...
loc_82183A50:
	...
	// bne cr6,0x82183b4c
	if (!cr6.eq) goto loc_82183B4C;
	// clrlwi r11,r24,24
	r11.u64 = r24.u32 & 0xFF;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82183a80
	if (cr6.eq) goto loc_82183A80;
	// addi r3,r26,40
...
loc_82183AA4:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82183ac4
	if (cr6.eq) goto loc_82183AC4;
	// lwz r11,17008(r28)
	r11.u64 = PPC_LOAD_U32(r28.u32 + 17008);
	// b 0x82183acc
	goto loc_82183ACC;
loc_82183AC4:
	// lis r11,-32131
...
loc_82183ACC:
	...
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
	// stw r30,17008(r28)
	PPC_STORE_U32(r28.u32 + 17008, r30.u32);
	// b 0x82183b44
	goto loc_82183B44;
loc_82183B0C:
	// cmplwi cr6,r30,0
	...
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
	// stw r29,17008(r28)
	PPC_STORE_U32(r28.u32 + 17008, r29.u32);
loc_82183B44:
	// stw r3,17004(r27)
	PPC_STORE_U32(r27.u32 + 17004, ctx.r3.u32);
loc_82183B48:
	// stb r24,4(r26)
...
loc_82183B4C:
	...
	ctx.r10.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 2) & 0xFFFFFFFC;
	// stwx r31,r10,r26
	PPC_STORE_U32(ctx.r10.u32 + r26.u32, r31.u32);
	// addi r1,r1,160
	ctx.r1.s64 = ctx.r1.s64 + 160;
	// b 0x823d9238
	return;
...
PPC_WEAK_FUNC(sub_82183B60) {
	__imp__sub_82183B60(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183C28) {
	__imp__sub_82183C28(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183C30) {
	__imp__sub_82183C30(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183C38) {
	__imp__sub_82183C38(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183C40) {
	__imp__sub_82183C40(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183C54) {
	__imp__sub_82183C54(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183C58) {
	__imp__sub_82183C58(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82183C68) {
	...
	// bne cr6,0x82183d7c
	if (!cr6.eq) goto loc_82183D7C;
	// lwz r9,44(r3)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r3.u32 + 44);
	// cmpwi cr6,r9,1
	cr6.compare<int32_t>(ctx.r9.s32, 1, xer);
	// ble cr6,0x82183cd0
	if (!cr6.gt) goto loc_82183CD0;
	// lwz r9,36(r3)
...
loc_82183CD4:
	...
	ctx.r4.s64 = 20;
	// beq cr6,0x82183d48
	if (cr6.eq) goto loc_82183D48;
	// lbz r10,21(r11)
	ctx.r10.u64 = PPC_LOAD_U8(r11.u32 + 21);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82183cf0
	if (cr6.eq) goto loc_82183CF0;
	// li r4,532
	ctx.r4.s64 = 532;
loc_82183CF0:
	// lis r10,-32131
...
loc_82183D7C:
	...
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r3.u32 + 44);
	// bne cr6,0x82183e50
	if (!cr6.eq) goto loc_82183E50;
	// cmpwi cr6,r9,1
	cr6.compare<int32_t>(ctx.r9.s32, 1, xer);
	// ble cr6,0x82183da4
	if (!cr6.gt) goto loc_82183DA4;
	// lwz r9,36(r3)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r3.u32 + 36);
	// rlwinm r8,r10,2,0,29
	ctx.r8.u64 = __builtin_rotateleft64(ctx.r10.u32 | (ctx.r10.u64 << 32), 2) & 0xFFFFFFFC;
...
loc_82183DA8:
	...
	ctx.r4.s64 = 20;
	// beq cr6,0x82183e1c
	if (cr6.eq) goto loc_82183E1C;
	// lbz r10,21(r11)
	ctx.r10.u64 = PPC_LOAD_U8(r11.u32 + 21);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82183dc4
	if (cr6.eq) goto loc_82183DC4;
	// li r4,532
	ctx.r4.s64 = 532;
loc_82183DC4:
	// lis r10,-32131
...
loc_82183EBC:
	...
	r29.u64 = __builtin_rotateleft64(ctx.r9.u32 | (ctx.r9.u64 << 32), 8) & 0xFF;
	// rlwinm r30,r9,24,24,31
	r30.u64 = __builtin_rotateleft64(ctx.r9.u32 | (ctx.r9.u64 << 32), 24) & 0xFF;
	// std r29,112(r1)
...
PPC_WEAK_FUNC(sub_82183C68) {
	__imp__sub_82183C68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82183FDC) {
	__imp__sub_82183FDC(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82183FE0) {
	...
	ctx.r5.s64 = 1;
	// sth r4,58(r31)
	PPC_STORE_U16(r31.u32 + 58, ctx.r4.u16);
	// sth r3,56(r31)
	PPC_STORE_U16(r31.u32 + 56, ctx.r3.u16);
	// lwz r11,120(r1)
...
PPC_WEAK_FUNC(sub_82183FE0) {
	__imp__sub_82183FE0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821840A8) {
	__imp__sub_821840A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821841AC) {
	__imp__sub_821841AC(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_821841B0) {
	...
	r25.u64 = ctx.r3.u64;
	// lbz r10,24712(r11)
	ctx.r10.u64 = PPC_LOAD_U8(r11.u32 + 24712);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82184204
	if (cr6.eq) goto loc_82184204;
	// lwz r11,4(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 4);
	// rlwinm r10,r11,0,0,0
	ctx.r10.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 0) & 0x80000000;
...
loc_82184208:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82184218
	if (cr6.eq) goto loc_82184218;
	// ori r25,r25,32256
	r25.u64 = r25.u64 | 32256;
loc_82184218:
	// lis r11,-32131
	r11.s64 = -2105737216;
	// lbz r10,22903(r11)
	ctx.r10.u64 = PPC_LOAD_U8(r11.u32 + 22903);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82184234
	if (cr6.eq) goto loc_82184234;
	// mr r3,r24
	ctx.r3.u64 = r24.u64;
	// bl 0x821378b8
	ctx.lr = 0x82184230;
...
loc_82184238:
	...
	// lhz r24,2(r31)
	r24.u64 = PPC_LOAD_U16(r31.u32 + 2);
	// bl 0x8218cd80
	ctx.lr = 0x82184274;
	sub_8218CD80(ctx, base);
	// addi r5,r3,1
...
loc_821842C8:
	...
	// sth r9,32(r30)
	PPC_STORE_U16(r30.u32 + 32, ctx.r9.u16);
	// lhz r8,2(r31)
	ctx.r8.u64 = PPC_LOAD_U16(r31.u32 + 2);
	// sth r8,34(r30)
	PPC_STORE_U16(r30.u32 + 34, ctx.r8.u16);
	// bl 0x8218cd80
	ctx.lr = 0x821842F4;
	sub_8218CD80(ctx, base);
	// lwz r7,0(r30)
...
loc_8218438C:
	...
	// lhz r23,14(r31)
	r23.u64 = PPC_LOAD_U16(r31.u32 + 14);
	// addi r29,r30,28
	r29.s64 = r30.s64 + 28;
	// lhz r22,2(r31)
	r22.u64 = PPC_LOAD_U16(r31.u32 + 2);
	// bl 0x8218cd80
	ctx.lr = 0x821843A4;
	sub_8218CD80(ctx, base);
	// stw r29,84(r1)
...
PPC_WEAK_FUNC(sub_821841B0) {
	__imp__sub_821841B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821843F8) {
	__imp__sub_821843F8(ctx, base);
}
...
loc_82184518:
	...
	r11.u64 = __builtin_rotateleft64(ctx.r5.u32 | (ctx.r5.u64 << 32), 20) & 0xFFFFF;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82184574
	if (cr6.eq) goto loc_82184574;
	// rlwinm r4,r11,12,0,19
	ctx.r4.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 12) & 0xFFFFF000;
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// bl 0x8217d890
	ctx.lr = 0x82184558;
...
loc_82184694:
	...
	ctx.r10.u64 = PPC_LOAD_U16(r31.u32 + 56);
	// lhz r9,58(r31)
	ctx.r9.u64 = PPC_LOAD_U16(r31.u32 + 58);
	// stw r29,160(r1)
...
loc_82184760:
	...
	r11.s64 = -2105278464;
	// addi r22,r11,-25200
	r22.s64 = r11.s64 + -25200;
	// lbz r11,112(r22)
	r11.u64 = PPC_LOAD_U8(r22.u32 + 112);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x8218477c
	if (!cr6.eq) goto loc_8218477C;
	// mr r3,r22
	ctx.r3.u64 = r22.u64;
	// bl 0x821804a8
	ctx.lr = 0x8218477C;
...
loc_8218477C:
	...
	// ble cr6,0x82184960
	if (!cr6.gt) goto loc_82184960;
	// lis r10,6690
	ctx.r10.s64 = 438435840;
	// lis r11,-32131
	r11.s64 = -2105737216;
	// ori r25,r10,407
	r25.u64 = ctx.r10.u64 | 407;
	// lis r28,-32124
	r28.s64 = -2105278464;
	// lis r23,-32131
	r23.s64 = -2105737216;
	// addi r26,r11,23416
	r26.s64 = r11.s64 + 23416;
loc_821847B8:
	// lwz r11,120(r1)
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 120);
	// lwz r10,124(r1)
...
loc_82184800:
	...
	cr6.compare<uint32_t>(r27.u32, 0, xer);
	// beq cr6,0x8218489c
	if (cr6.eq) goto loc_8218489C;
	// lwz r11,17068(r23)
	r11.u64 = PPC_LOAD_U32(r23.u32 + 17068);
	// lfs f1,0(r27)
	ctx.fpscr.disableFlushMode();
...
loc_82184850:
	...
	// lwzx r11,r8,r26
	r11.u64 = PPC_LOAD_U32(ctx.r8.u32 + r26.u32);
	// mr r8,r30
	ctx.r8.u64 = r30.u64;
...
PPC_WEAK_FUNC(sub_82184588) {
	__imp__sub_82184588(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218498C) {
	__imp__sub_8218498C(ctx, base);
}
...
loc_82184AB4:
	...
	r11.s64 = -2105278464;
	// addi r30,r11,-25200
	r30.s64 = r11.s64 + -25200;
	// lbz r11,112(r30)
	r11.u64 = PPC_LOAD_U8(r30.u32 + 112);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82184ad0
	if (!cr6.eq) goto loc_82184AD0;
	// mr r3,r30
	ctx.r3.u64 = r30.u64;
	// bl 0x821804a8
	ctx.lr = 0x82184AD0;
...
loc_82184B08:
	...
	ctx.r4.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 0) & 0x100;
	// bl 0x82420ba8
	ctx.lr = 0x82184B48;
	sub_82420BA8(ctx, base);
	// addi r1,r1,240
...
PPC_WEAK_FUNC(sub_82184990) {
	__imp__sub_82184990(ctx, base);
}
...
loc_82184BF8:
	...
	return;
	// lwz r16,19768(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 19768);
	// lwz r16,19768(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 19768);
	// lwz r16,19992(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 19992);
	// lwz r16,19768(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 19768);
	// lwz r16,19992(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 19992);
	// lwz r16,19508(r24)
	r16.u64 = PPC_LOAD_U32(r24.u32 + 19508);
	// lwz r11,44(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 44);
	// cmpwi cr6,r11,1
	cr6.compare<int32_t>(r11.s32, 1, xer);
...
PPC_WEAK_FUNC(sub_82184E40) {
	__imp__sub_82184E40(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82184ED0) {
	__imp__sub_82184ED0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82184F54) {
	__imp__sub_82184F54(ctx, base);
}
...
loc_82184FB8:
	...
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// addi r30,r11,-25076
	r30.s64 = r11.s64 + -25076;
	// beq cr6,0x82185008
	if (cr6.eq) goto loc_82185008;
	// mr r10,r30
	ctx.r10.u64 = r30.u64;
	// mr r11,r29
	r11.u64 = r29.u64;
...
loc_82185008:
	...
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// bne cr6,0x82185034
	if (!cr6.eq) goto loc_82185034;
	// clrlwi r11,r6,30
	r11.u64 = ctx.r6.u32 & 0x3;
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// beq cr6,0x821850f8
	if (cr6.eq) goto loc_821850F8;
loc_82185034:
	// lis r11,-32255
	r11.s64 = -2113863680;
	// mr r4,r29
...
loc_82185074:
	...
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// beq cr6,0x82185074
	if (cr6.eq) goto loc_82185074;
loc_82185098:
	// cmpwi cr6,r9,0
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// beq cr6,0x821850a8
	if (cr6.eq) goto loc_821850A8;
	// li r30,-1
	r30.s64 = -1;
	// b 0x821850b0
	goto loc_821850B0;
...
loc_821850EC:
	...
	// bdnz 0x821850ec
	--ctr.u64;
	if (ctr.u32 != 0) goto loc_821850EC;
loc_821850F8:
	// mr r6,r27
	ctx.r6.u64 = r27.u64;
	// mr r5,r31
...
PPC_WEAK_FUNC(sub_82184F58) {
	__imp__sub_82184F58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218518C) {
	__imp__sub_8218518C(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82185190) {
	...
	cr6.compare<uint32_t>(r11.u32, 1, xer);
	// blt cr6,0x821851c0
	if (cr6.lt) goto loc_821851C0;
	// beqlr cr6
	if (cr6.eq) return;
	// cmplwi cr6,r11,3
	cr6.compare<uint32_t>(r11.u32, 3, xer);
	// blt cr6,0x821851bc
	if (cr6.lt) goto loc_821851BC;
	// lis r10,-32255
	ctx.r10.s64 = -2113863680;
	// mr r4,r11
	ctx.r4.u64 = r11.u64;
...
PPC_WEAK_FUNC(sub_82185190) {
	__imp__sub_82185190(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821851C4) {
	__imp__sub_821851C4(ctx, base);
}
...
loc_8218527C:
	...
	// stwx r28,r8,r11
	PPC_STORE_U32(ctx.r8.u32 + r11.u32, r28.u32);
	// addi r11,r11,4
	r11.s64 = r11.s64 + 4;
	// bne 0x8218527c
	if (!cr0.eq) goto loc_8218527C;
loc_82185298:
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// addi r1,r1,128
...
PPC_WEAK_FUNC(sub_821851C8) {
	__imp__sub_821851C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821852A4) {
	__imp__sub_821852A4(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821852A8) {
	__imp__sub_821852A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82185304) {
	__imp__sub_82185304(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82185308) {
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x8218534c
	if (!cr6.eq) goto loc_8218534C;
	// cmplwi cr6,r30,0
	cr6.compare<uint32_t>(r30.u32, 0, xer);
	// sth r30,6(r31)
	PPC_STORE_U16(r31.u32 + 6, r30.u16);
	// beq cr6,0x82185344
	if (cr6.eq) goto loc_82185344;
	// bl 0x82195e48
	ctx.lr = 0x82185340;
...
PPC_WEAK_FUNC(sub_82185308) {
	__imp__sub_82185308(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82185368) {
	__imp__sub_82185368(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218540C) {
	__imp__sub_8218540C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82185410) {
	__imp__sub_82185410(ctx, base);
}
...
PPC_WEAK_FUNC(sub_821854C4) {
	__imp__sub_821854C4(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82185538) {
	...
	// sth r10,58(r31)
	PPC_STORE_U16(r31.u32 + 58, ctx.r10.u16);
	// mullw r9,r5,r6
...
PPC_WEAK_FUNC(sub_82185538) {
	__imp__sub_82185538(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82185648) {
	...
	r14.s64 = r19.s64 + 80;
	// stw r17,24(r19)
	PPC_STORE_U32(r19.u32 + 24, r17.u32);
	// addi r30,r19,68
	r30.s64 = r19.s64 + 68;
	// sth r21,56(r19)
	PPC_STORE_U16(r19.u32 + 56, r21.u16);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// sth r20,58(r19)
	PPC_STORE_U16(r19.u32 + 58, r20.u16);
	// stw r18,80(r19)
	PPC_STORE_U32(r19.u32 + 80, r18.u32);
	// stw r18,68(r19)
	PPC_STORE_U32(r19.u32 + 68, r18.u32);
	// beq cr6,0x821856c0
	if (cr6.eq) goto loc_821856C0;
	// lbz r8,0(r31)
...
loc_821856CC:
	...
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x821856f0
	if (cr6.eq) goto loc_821856F0;
	// lbz r29,8(r31)
	r29.u64 = PPC_LOAD_U8(r31.u32 + 8);
	// lbz r3,16(r31)
...
loc_82185724:
	...
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x82185738
	if (cr6.eq) goto loc_82185738;
	// lwz r9,40(r31)
	ctx.r9.u64 = PPC_LOAD_U32(r31.u32 + 40);
	// cmpwi cr6,r9,0
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// bne cr6,0x82185758
	if (!cr6.eq) goto loc_82185758;
loc_82185738:
	// clrlwi r11,r8,24
...
loc_82185758:
	...
	r11.s64 = -2113863680;
	// stw r9,60(r19)
	PPC_STORE_U32(r19.u32 + 60, ctx.r9.u32);
	// lis r10,-32255
	ctx.r10.s64 = -2113863680;
	// addi r7,r11,-22392
	...
	// addi r11,r10,-22472
	r11.s64 = ctx.r10.s64 + -22472;
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// lwzx r5,r8,r7
	ctx.r5.u64 = PPC_LOAD_U32(ctx.r8.u32 + ctx.r7.u32);
	// lwzx r16,r8,r11
	r16.u64 = PPC_LOAD_U32(ctx.r8.u32 + r11.u32);
	// beq cr6,0x821857ac
	if (cr6.eq) goto loc_821857AC;
	// lbz r11,36(r31)
...
loc_821857AC:
	...
	// addi r28,r11,5119
	r28.s64 = r11.s64 + 5119;
	// clrlwi r11,r10,20
	r11.u64 = ctx.r10.u32 & 0xFFF;
	// divwu r10,r28,r8
	ctx.r10.u32 = r28.u32 / ctx.r8.u32;
	// add r8,r10,r11
...
loc_82185808:
	...
	r11.s64 = -2105278464;
	// lwz r11,-27812(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -27812);
	// lwz r10,28(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 28);
	// clrlwi r8,r10,20
...
loc_82185824:
	...
	// beq cr6,0x82185b24
	if (cr6.eq) goto loc_82185B24;
	// cmpwi cr6,r17,1
	cr6.compare<int32_t>(r17.s32, 1, xer);
	// beq cr6,0x82185b2c
	if (cr6.eq) goto loc_82185B2C;
	// cmpwi cr6,r17,4
	...
	// beq cr6,0x82185854
	if (cr6.eq) goto loc_82185854;
	// cmpwi cr6,r17,5
	cr6.compare<int32_t>(r17.s32, 5, xer);
	// bne cr6,0x82185d6c
	if (!cr6.eq) goto loc_82185D6C;
loc_82185854:
	// clrlwi r11,r4,24
	r11.u64 = ctx.r4.u32 & 0xFF;
	// cmplwi cr6,r11,0
...
loc_82185868:
	...
	// beq cr6,0x821858a8
	if (cr6.eq) goto loc_821858A8;
	// cmpwi cr6,r25,32
	cr6.compare<int32_t>(r25.s32, 32, xer);
	// bne cr6,0x821858a0
	if (!cr6.eq) goto loc_821858A0;
	// lwz r11,17068(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 17068);
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// beq cr6,0x82185894
	if (cr6.eq) goto loc_82185894;
	// lis r5,6690
	ctx.r5.s64 = 438435840;
	// ori r5,r5,407
...
loc_821858E0:
	...
	cr6.compare<int32_t>(ctx.r4.s32, 1, xer);
	// ble cr6,0x82185aa4
	if (!cr6.gt) goto loc_82185AA4;
	// cmpwi cr6,r17,5
	cr6.compare<int32_t>(r17.s32, 5, xer);
	// bne cr6,0x82185aa4
	if (!cr6.eq) goto loc_82185AA4;
	// mr r11,r4
	r11.u64 = ctx.r4.u64;
	// srawi r10,r11,1
	xer.ca = (r11.s32 < 0) & ((r11.u32 & 0x1) != 0);
	...
	// mullw r24,r29,r21
	r24.s64 = int64_t(r29.s32) * int64_t(r21.s32);
	// sth r24,48(r19)
	PPC_STORE_U16(r19.u32 + 48, r24.u16);
	// mullw r22,r27,r20
	r22.s64 = int64_t(r27.s32) * int64_t(r20.s32);
	// sth r22,50(r19)
	PPC_STORE_U16(r19.u32 + 50, r22.u16);
	// cmpwi cr6,r24,4096
	cr6.compare<int32_t>(r24.s32, 4096, xer);
	// bgt cr6,0x82185970
	if (cr6.gt) goto loc_82185970;
	// cmpwi cr6,r22,4096
	cr6.compare<int32_t>(r22.s32, 4096, xer);
	// ble cr6,0x8218597c
	if (!cr6.gt) goto loc_8218597C;
loc_82185970:
	// lis r11,-32255
	r11.s64 = -2113863680;
	// addi r3,r11,-22572
...
loc_8218597C:
	// lhz r11,40(r19)
	r11.u64 = PPC_LOAD_U16(r19.u32 + 40);
	// mr r28,r18
	r28.u64 = r18.u64;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82185a04
	if (cr6.eq) goto loc_82185A04;
	// mr r31,r18
	r31.u64 = r18.u64;
	// li r23,1600
	r23.s64 = 1600;
loc_82185994:
	...
	// stw r18,12(r3)
	PPC_STORE_U32(ctx.r3.u32 + 12, r18.u32);
	// stw r18,16(r3)
	PPC_STORE_U32(ctx.r3.u32 + 16, r18.u32);
	// b 0x821859c0
	goto loc_821859C0;
loc_821859BC:
	// mr r4,r18
...
loc_821859C0:
	...
	r28.s64 = r28.s64 + 1;
	// lhz r5,40(r19)
	ctx.r5.u64 = PPC_LOAD_U16(r19.u32 + 40);
	// cmpw cr6,r28,r5
	cr6.compare<int32_t>(r28.s32, ctx.r5.s32, xer);
	// blt cr6,0x82185994
	if (cr6.lt) goto loc_82185994;
loc_82185A04:
	// mr r8,r18
	ctx.r8.u64 = r18.u64;
	// mr r5,r18
...
loc_82185A14:
	...
	cr6.compare<int32_t>(r29.s32, 0, xer);
	// ble cr6,0x82185a88
	if (!cr6.gt) goto loc_82185A88;
	// rotlwi r11,r22,1
	r11.u64 = __builtin_rotateleft32(r22.u32, 1);
	// rotlwi r10,r24,1
...
loc_82185AB8:
	...
	cr6.compare<int32_t>(r25.s32, 32, xer);
	// bne cr6,0x82185ae4
	if (!cr6.eq) goto loc_82185AE4;
	// lwz r11,17068(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 17068);
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// beq cr6,0x82185ad8
	if (cr6.eq) goto loc_82185AD8;
	// lis r8,6690
	ctx.r8.s64 = 438435840;
	// ori r8,r8,407
...
loc_82185B24:
	...
	cr6.compare<int32_t>(r17.s32, 1, xer);
	// bne cr6,0x82185b44
	if (!cr6.eq) goto loc_82185B44;
loc_82185B2C:
	// lis r10,-32124
	ctx.r10.s64 = -2105278464;
	// lwz r11,-28080(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -28080);
	// stw r11,0(r30)
...
loc_82185B60:
	...
	PPC_STORE_U16(r19.u32 + 48, r24.u16);
	// mullw r22,r25,r20
	r22.s64 = int64_t(r25.s32) * int64_t(r20.s32);
	// sth r22,50(r19)
	PPC_STORE_U16(r19.u32 + 50, r22.u16);
	// cmpwi cr6,r24,4096
	cr6.compare<int32_t>(r24.s32, 4096, xer);
	// bgt cr6,0x82185be8
	if (cr6.gt) goto loc_82185BE8;
	// cmpwi cr6,r22,4096
	cr6.compare<int32_t>(r22.s32, 4096, xer);
	// ble cr6,0x82185bf4
	if (!cr6.gt) goto loc_82185BF4;
loc_82185BE8:
	// lis r11,-32255
	r11.s64 = -2113863680;
	// addi r3,r11,-22572
...
loc_82185BF4:
	// lhz r11,32(r19)
	r11.u64 = PPC_LOAD_U16(r19.u32 + 32);
	// mr r28,r18
	r28.u64 = r18.u64;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82185c88
	if (cr6.eq) goto loc_82185C88;
	// mr r31,r18
	r31.u64 = r18.u64;
	// li r23,1600
	r23.s64 = 1600;
...
loc_82185C4C:
	...
	r28.s64 = r28.s64 + 1;
	// lhz r5,32(r19)
	ctx.r5.u64 = PPC_LOAD_U16(r19.u32 + 32);
	// cmpw cr6,r28,r5
	cr6.compare<int32_t>(r28.s32, ctx.r5.s32, xer);
	// blt cr6,0x82185c0c
	if (cr6.lt) goto loc_82185C0C;
loc_82185C88:
	// mr r8,r18
	ctx.r8.u64 = r18.u64;
	// mr r5,r18
...
loc_82185C98:
	...
	ctx.r10.s64 = ctx.r10.s64 + -1;
	// andc r7,r25,r11
	ctx.r7.u64 = r25.u64 & ~r11.u64;
	// divw r9,r22,r25
	ctx.r9.s32 = r22.s32 / r25.s32;
	// andc r4,r29,r10
	ctx.r4.u64 = r29.u64 & ~ctx.r10.u64;
	// twlgei r7,-1
	// rlwinm r11,r8,2,0,29
...
PPC_FUNC_IMPL(__imp__sub_82185D80) {
	...
	PPC_STORE_U32(r31.u32 + 16, r11.u32);
	// stwx r30,r3,r31
	PPC_STORE_U32(ctx.r3.u32 + r31.u32, r30.u32);
	// lwz r11,48(r31)
	...
	PPC_STORE_U32(r31.u32 + 44, r11.u32);
	// stwx r30,r3,r7
	PPC_STORE_U32(ctx.r3.u32 + ctx.r7.u32, r30.u32);
	// lwz r11,76(r31)
	...
	// stwx r30,r7,r6
	PPC_STORE_U32(ctx.r7.u32 + ctx.r6.u32, r30.u32);
	// lwz r11,104(r31)
	...
	// stwx r30,r8,r5
	PPC_STORE_U32(ctx.r8.u32 + ctx.r5.u32, r30.u32);
	// lwz r11,132(r31)
	...
	r11.s64 = r29.s64 + 24;
	// stwx r30,r9,r4
	PPC_STORE_U32(ctx.r9.u32 + ctx.r4.u32, r30.u32);
loc_82185EB8:
	// stw r30,-16(r11)
	...
	cr6.compare<uint32_t>(r28.u32, 0, xer);
	// addi r27,r11,-23260
	r27.s64 = r11.s64 + -23260;
	// beq cr6,0x82185f48
	if (cr6.eq) goto loc_82185F48;
	// bl 0x821d2970
	ctx.lr = 0x82185EF0;
	sub_821D2970(ctx, base);
	// stw r26,8(r28)
	...
	// sth r26,12(r28)
	PPC_STORE_U16(r28.u32 + 12, r26.u16);
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// sth r30,14(r28)
	...
	// sth r30,32(r28)
	PPC_STORE_U16(r28.u32 + 32, r30.u16);
	// sth r30,34(r28)
	PPC_STORE_U16(r28.u32 + 34, r30.u16);
	// stw r30,36(r28)
	PPC_STORE_U32(r28.u32 + 36, r30.u32);
	// sth r30,40(r28)
	PPC_STORE_U16(r28.u32 + 40, r30.u16);
	// sth r30,42(r28)
	PPC_STORE_U16(r28.u32 + 42, r30.u16);
	// stw r27,0(r28)
	PPC_STORE_U32(r28.u32 + 0, r27.u32);
	// stw r30,52(r28)
	PPC_STORE_U32(r28.u32 + 52, r30.u32);
	// sth r30,56(r28)
	PPC_STORE_U16(r28.u32 + 56, r30.u16);
	// sth r30,58(r28)
	PPC_STORE_U16(r28.u32 + 58, r30.u16);
	// stw r25,60(r28)
	PPC_STORE_U32(r28.u32 + 60, r25.u32);
	// stw r30,64(r28)
	PPC_STORE_U32(r28.u32 + 64, r30.u32);
	// stw r30,68(r28)
	PPC_STORE_U32(r28.u32 + 68, r30.u32);
	// stw r30,72(r28)
	PPC_STORE_U32(r28.u32 + 72, r30.u32);
	// stw r30,76(r28)
...
loc_82185F4C:
	...
	r28.s64 = -2105278464;
	// lwz r4,-28080(r28)
	ctx.r4.u64 = PPC_LOAD_U32(r28.u32 + -28080);
	// bl 0x821840a8
	ctx.lr = 0x82185F5C;
	sub_821840A8(ctx, base);
	// lwz r3,-28080(r28)
	ctx.r3.u64 = PPC_LOAD_U32(r28.u32 + -28080);
	// bl 0x82422160
	ctx.lr = 0x82185F64;
	sub_82422160(ctx, base);
	// lwz r11,16(r31)
...
loc_82185FE8:
	...
	r31.s64 = -2105278464;
	// lwz r4,-27812(r31)
	ctx.r4.u64 = PPC_LOAD_U32(r31.u32 + -27812);
	// bl 0x82183fe0
	ctx.lr = 0x82185FF8;
...
PPC_WEAK_FUNC(sub_82185D80) {
	__imp__sub_82185D80(ctx, base);
}
...
PPC_WEAK_FUNC(sub_8218606C) {
	__imp__sub_8218606C(ctx, base);
}
...
loc_821860CC:
	...
	r11.s64 = -2105278464;
	// lwz r4,-24876(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + -24876);
	// cmplwi cr6,r4,0
	cr6.compare<uint32_t>(ctx.r4.u32, 0, xer);
	// beq cr6,0x821860f4
	if (cr6.eq) goto loc_821860F4;
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// lwz r5,20(r4)
...
PPC_WEAK_FUNC(sub_82186070) {
	__imp__sub_82186070(ctx, base);
}
