...
PPC_FUNC_IMPL(__imp__sub_824827B0) {
	...
	ctx.r10.s64 = -2104688640;
	// lwz r11,19876(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 19876);
	// clrlwi r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	// cmplwi cr6,r9,0
	cr6.compare<uint32_t>(ctx.r9.u32, 0, xer);
	// bne cr6,0x82482810
	if (!cr6.eq) goto loc_82482810;
	// ori r11,r11,1
	r11.u64 = r11.u64 | 1;
	// lis r9,-32115
	ctx.r9.s64 = -2104688640;
	// stw r11,19876(r10)
	PPC_STORE_U32(ctx.r10.u32 + 19876, r11.u32);
	// addi r31,r9,19852
	r31.s64 = ctx.r9.s64 + 19852;
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// bl 0x824fa970
	ctx.lr = 0x824827EC;
...
PPC_FUNC_IMPL(__imp__sub_824828F0) {
	...
	cr6.compare<uint32_t>(ctx.r5.u32, 0, xer);
	// bne cr6,0x82482934
	if (!cr6.eq) goto loc_82482934;
	// lwz r11,4(r4)
	r11.u64 = PPC_LOAD_U32(ctx.r4.u32 + 4);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82482928
	if (cr6.eq) goto loc_82482928;
	// stw r6,16(r11)
...
PPC_FUNC_IMPL(__imp__sub_82482A20) {
	...
	cr6.compare<uint32_t>(ctx.r5.u32, 0, xer);
	// bne cr6,0x82482a64
	if (!cr6.eq) goto loc_82482A64;
	// lwz r11,4(r4)
	r11.u64 = PPC_LOAD_U32(ctx.r4.u32 + 4);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82482a58
	if (cr6.eq) goto loc_82482A58;
	// stw r6,84(r11)
	PPC_STORE_U32(r11.u32 + 84, ctx.r6.u32);
	// lwz r11,4(r4)
	r11.u64 = PPC_LOAD_U32(ctx.r4.u32 + 4);
	// stw r11,88(r6)
	PPC_STORE_U32(ctx.r6.u32 + 88, r11.u32);
	// lwz r10,0(r4)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r4.u32 + 0);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
