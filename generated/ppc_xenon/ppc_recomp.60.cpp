...
loc_8238FB3C:
	...
	cr6.compare<int32_t>(ctx.r3.s32, 0, xer);
	// beq cr6,0x8238fb3c
	if (cr6.eq) goto loc_8238FB3C;
	// cmpwi cr6,r3,-1
	cr6.compare<int32_t>(ctx.r3.s32, -1, xer);
	// beq cr6,0x8238fbbc
	if (cr6.eq) goto loc_8238FBBC;
	// addi r10,r30,8109
	ctx.r10.s64 = r30.s64 + 8109;
	// addi r11,r1,80
	r11.s64 = ctx.r1.s64 + 80;
loc_8238FB6C:
	// lbz r9,0(r11)
...
loc_8238FC14:
	...
	ctx.r5.u64 = r29.u64;
	// stb r10,5724(r31)
	PPC_STORE_U8(r31.u32 + 5724, ctx.r10.u8);
	// addi r4,r1,80
	ctx.r4.s64 = ctx.r1.s64 + 80;
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	...
	ctx.r3.s64 = ctx.r1.s64 + 80;
	// stw r8,8092(r30)
	PPC_STORE_U32(r30.u32 + 8092, ctx.r8.u32);
	// bl 0x821c9790
	ctx.lr = 0x8238FC84;
	sub_821C9790(ctx, base);
	// stw r3,8104(r30)
	PPC_STORE_U32(r30.u32 + 8104, ctx.r3.u32);
	// bl 0x821bbea8
	ctx.lr = 0x8238FC8C;
	sub_821BBEA8(ctx, base);
	// lwz r7,0(r31)
...
PPC_FUNC_IMPL(__imp__sub_8238FD38) {
	...
	r30.u64 = ctx.r4.u64;
	// addi r28,r31,8109
	r28.s64 = r31.s64 + 8109;
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// lwz r11,8100(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 8100);
	// lwz r29,8088(r31)
	r29.u64 = PPC_LOAD_U32(r31.u32 + 8088);
	// cntlzw r10,r11
	ctx.r10.u64 = r11.u32 == 0 ? 32 : __builtin_clz(r11.u32);
...
loc_8238FD90:
	...
	ctx.r5.s64 = 32;
	// lwz r4,8096(r31)
	ctx.r4.u64 = PPC_LOAD_U32(r31.u32 + 8096);
	// mr r3,r30
	ctx.r3.u64 = r30.u64;
	// bl 0x8226b338
	ctx.lr = 0x8238FE20;
...
PPC_FUNC_IMPL(__imp__sub_8238FE90) {
	...
	sub_82130000(ctx, base);
	// lwz r9,8100(r29)
	ctx.r9.u64 = PPC_LOAD_U32(r29.u32 + 8100);
	// cmpwi cr6,r9,0
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// bne cr6,0x8238ff04
	if (!cr6.eq) goto loc_8238FF04;
loc_8238FEF8:
	// li r3,0
	ctx.r3.s64 = 0;
	// addi r1,r1,144
...
loc_8238FF04:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x8238fef8
	if (cr6.eq) goto loc_8238FEF8;
	// cmpwi cr6,r27,4
	cr6.compare<int32_t>(r27.s32, 4, xer);
	// bne cr6,0x8238ff64
	if (!cr6.eq) goto loc_8238FF64;
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// bl 0x82396408
	ctx.lr = 0x8238FF3C;
