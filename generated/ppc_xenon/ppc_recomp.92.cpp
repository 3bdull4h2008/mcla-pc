...
loc_824B88D0:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x824b88fc
	if (cr6.eq) goto loc_824B88FC;
	// subf. r5,r31,r4
	ctx.r5.s64 = ctx.r4.s64 - r31.s64;
	cr0.compare<int32_t>(ctx.r5.s32, 0, xer);
	// ble 0x824b88f4
	if (!cr0.gt) goto loc_824B88F4;
	// subf r11,r5,r4
...
PPC_FUNC_IMPL(__imp__sub_824B89E0) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20892
	r31.s64 = r11.s64 + 20892;
	// lwz r11,20892(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20892);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824b8af0
	if (!cr6.eq) goto loc_824B8AF0;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824B8A10;
...
loc_824B8B98:
	...
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x824b8bc4
	if (cr6.eq) goto loc_824B8BC4;
	// lis r11,-32249
	r11.s64 = -2113470464;
	// li r5,0
	ctx.r5.s64 = 0;
	// addi r4,r11,8876
	ctx.r4.s64 = r11.s64 + 8876;
	// bl 0x821c6a20
	ctx.lr = 0x824B8BC4;
	sub_821C6A20(ctx, base);
loc_824B8BC4:
...
loc_824B8C1C:
	...
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// bne cr6,0x824b8d88
	if (!cr6.eq) goto loc_824B8D88;
	// lwz r3,828(r21)
	ctx.r3.u64 = PPC_LOAD_U32(r21.u32 + 828);
	// bl 0x82130588
	ctx.lr = 0x824B8C48;
	sub_82130588(ctx, base);
	// stw r27,828(r21)
	PPC_STORE_U32(r21.u32 + 828, r27.u32);
	// addi r3,r1,96
	ctx.r3.s64 = ctx.r1.s64 + 96;
	// sth r27,832(r21)
	PPC_STORE_U16(r21.u32 + 832, r27.u16);
	// sth r27,834(r21)
	PPC_STORE_U16(r21.u32 + 834, r27.u16);
	// bl 0x82495cf0
	ctx.lr = 0x824B8C5C;
	sub_82495CF0(ctx, base);
	// bl 0x821bbea8
	...
	ctx.r3.u64 = r22.u64;
	// lwz r31,2828(r9)
	r31.u64 = PPC_LOAD_U32(ctx.r9.u32 + 2828);
	// addi r29,r1,96
...
loc_824B8DAC:
	...
	sub_821C6A20(ctx, base);
	// lwz r28,28(r22)
	r28.u64 = PPC_LOAD_U32(r22.u32 + 28);
	// cmplwi cr6,r28,0
	cr6.compare<uint32_t>(r28.u32, 0, xer);
	// beq cr6,0x824b8ec4
	if (cr6.eq) goto loc_824B8EC4;
	// lis r11,-32249
	r11.s64 = -2113470464;
	// lis r10,-32249
	ctx.r10.s64 = -2113470464;
	...
	ctx.r9.s64 = -2113470464;
	// addi r26,r11,4264
	r26.s64 = r11.s64 + 4264;
	// addi r23,r10,-10240
	r23.s64 = ctx.r10.s64 + -10240;
	// addi r24,r9,-2972
	r24.s64 = ctx.r9.s64 + -2972;
loc_824B8DE4:
	// mr r30,r28
	r30.u64 = r28.u64;
	// lwz r28,24(r28)
...
PPC_FUNC_IMPL(__imp__sub_824B9138) {
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824b917c
	if (!cr6.eq) goto loc_824B917C;
	// cmplwi cr6,r30,0
	cr6.compare<uint32_t>(r30.u32, 0, xer);
	// sth r30,6(r31)
	PPC_STORE_U16(r31.u32 + 6, r30.u16);
	// beq cr6,0x824b9174
	if (cr6.eq) goto loc_824B9174;
	// bl 0x824b8770
	ctx.lr = 0x824B9170;
...
PPC_FUNC_IMPL(__imp__sub_824B92A8) {
	...
	// stb r30,429(r31)
	PPC_STORE_U8(r31.u32 + 429, r30.u8);
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// bl 0x82495cf0
	ctx.lr = 0x824B9404;
	...
	// stb r30,533(r31)
	PPC_STORE_U8(r31.u32 + 533, r30.u8);
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// bl 0x82495cf0
	ctx.lr = 0x824B944C;
	...
	// stb r30,585(r31)
	PPC_STORE_U8(r31.u32 + 585, r30.u8);
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// bl 0x82495cf0
	ctx.lr = 0x824B9470;
	...
	r28.s64 = r31.s64 + 640;
	// stw r7,632(r31)
	PPC_STORE_U32(r31.u32 + 632, ctx.r7.u32);
	// stb r30,637(r31)
	PPC_STORE_U8(r31.u32 + 637, r30.u8);
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// bl 0x82495cf0
	ctx.lr = 0x824B9494;
	...
	r28.s64 = r31.s64 + 744;
	// stw r5,736(r31)
	PPC_STORE_U32(r31.u32 + 736, ctx.r5.u32);
	// stb r30,741(r31)
	PPC_STORE_U8(r31.u32 + 741, r30.u8);
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// bl 0x82495cf0
	ctx.lr = 0x824B94DC;
	...
	ctx.r3.u64 = r31.u64;
	// stw r4,788(r31)
	PPC_STORE_U32(r31.u32 + 788, ctx.r4.u32);
	// stb r30,793(r31)
	PPC_STORE_U8(r31.u32 + 793, r30.u8);
	// addi r1,r1,128
	ctx.r1.s64 = ctx.r1.s64 + 128;
	// b 0x823d9248
	return;
