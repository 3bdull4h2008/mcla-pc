...
PPC_FUNC_IMPL(__imp__sub_826DF0C0) {
	...
	PPC_STORE_U32(r31.u32 + 8, r30.u32);
	// stb r8,284(r31)
	PPC_STORE_U8(r31.u32 + 284, ctx.r8.u8);
	// lwz r7,4(r9)
	...
	simde_mm_store_si128((simde__m128i*)v63.u32, simde_mm_set1_epi32(int(0x0)));
	// lbz r4,284(r31)
	ctx.r4.u64 = PPC_LOAD_U8(r31.u32 + 284);
	// li r6,48
	ctx.r6.s64 = 48;
	// stfs f31,244(r31)
	ctx.fpscr.disableFlushMode();
	...
	PPC_STORE_U32(r31.u32 + 252, r30.u32);
	// stb r3,284(r31)
	PPC_STORE_U8(r31.u32 + 284, ctx.r3.u8);
	// addi r1,r1,112
	ctx.r1.s64 = ctx.r1.s64 + 112;
	// lwz r12,-8(r1)
	r12.u64 = PPC_LOAD_U32(ctx.r1.u32 + -8);
...
PPC_FUNC_IMPL(__imp__sub_826DF190) {
	...
	PPCRegister r11{};
	// lbz r11,284(r4)
	r11.u64 = PPC_LOAD_U8(ctx.r4.u32 + 284);
	// rlwinm r10,r11,0,25,25
	ctx.r10.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 0) & 0x40;
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x826df1bc
	if (cr6.eq) goto loc_826DF1BC;
	// lwz r11,256(r4)
...
PPC_FUNC_IMPL(__imp__sub_826DF1C8) {
	...
	cr6.compare<uint32_t>(ctx.r7.u32, 0, xer);
	// beq cr6,0x826df218
	if (cr6.eq) goto loc_826DF218;
	// lwz r4,4(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + 4);
	// cmplwi cr6,r4,0
	cr6.compare<uint32_t>(ctx.r4.u32, 0, xer);
	// beq cr6,0x826df244
	if (cr6.eq) goto loc_826DF244;
	// addi r3,r1,80
	ctx.r3.s64 = ctx.r1.s64 + 80;
	// lwz r5,12(r11)
	ctx.r5.u64 = PPC_LOAD_U32(r11.u32 + 12);
...
loc_826DF328:
	...
	r11.s64 = 1;
	// stb r11,836(r31)
	PPC_STORE_U8(r31.u32 + 836, r11.u8);
loc_826DF330:
	// lwz r11,788(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 788);
	// addi r4,r31,544
	...
	r11.u64 = __builtin_rotateleft64(ctx.r8.u32 | (ctx.r8.u64 << 32), 0) & 0xFFFFFFFFFFFFFFFB;
	// addi r7,r11,5
...
PPC_FUNC_IMPL(__imp__sub_826DF370) {
	...
	// stb r10,500(r30)
	PPC_STORE_U8(r30.u32 + 500, ctx.r10.u8);
	// bl 0x826df0c0
	ctx.lr = 0x826DF398;
	...
	ctx.r9.u64 = PPC_LOAD_U8(r31.u32 + 284);
	// lbz r8,242(r31)
	ctx.r8.u64 = PPC_LOAD_U8(r31.u32 + 242);
	// ori r7,r9,64
	ctx.r7.u64 = ctx.r9.u64 | 64;
	// ori r6,r8,80
	ctx.r6.u64 = ctx.r8.u64 | 80;
	// stb r7,284(r31)
	PPC_STORE_U8(r31.u32 + 284, ctx.r7.u8);
	// lwz r5,476(r30)
	...
	// stb r6,242(r31)
	PPC_STORE_U8(r31.u32 + 242, ctx.r6.u8);
	// stw r30,256(r31)
	PPC_STORE_U32(r31.u32 + 256, r30.u32);
	// stw r29,260(r31)
...
PPC_FUNC_IMPL(__imp__sub_826DF3E8) {
	...
	PPC_STORE_U32(r31.u32 + 260, r29.u32);
	// stb r9,284(r31)
	PPC_STORE_U8(r31.u32 + 284, ctx.r9.u8);
	// lfs f0,7444(r11)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(r11.u32 + 7444);
	f0.f64 = double(temp.f32);
...
PPC_FUNC_IMPL(__imp__sub_826DF430) {
	...
	// stb r5,242(r31)
	PPC_STORE_U8(r31.u32 + 242, ctx.r5.u8);
	// lwz r9,0(r30)
	ctx.r9.u64 = PPC_LOAD_U32(r30.u32 + 0);
	// stw r9,4(r31)
...
PPC_FUNC_IMPL(__imp__sub_826DF590) {
	...
	ctx.r10.u64 = PPC_LOAD_U8(r31.u32 + 284);
	// lbz r9,242(r31)
	ctx.r9.u64 = PPC_LOAD_U8(r31.u32 + 242);
	// mr r4,r29
	ctx.r4.u64 = r29.u64;
	// ori r8,r10,32
	...
	f0.f64 = double(temp.f32);
	// stb r7,242(r31)
	PPC_STORE_U8(r31.u32 + 242, ctx.r7.u8);
	// stfs f0,0(r31)
	temp.f32 = float(f0.f64);
	PPC_STORE_U32(r31.u32 + 0, temp.u32);
	// lwz r6,476(r30)
	ctx.r6.u64 = PPC_LOAD_U32(r30.u32 + 476);
	// stw r6,272(r31)
	PPC_STORE_U32(r31.u32 + 272, ctx.r6.u32);
	// lwz r5,480(r30)
	ctx.r5.u64 = PPC_LOAD_U32(r30.u32 + 480);
	// stw r5,280(r31)
	PPC_STORE_U32(r31.u32 + 280, ctx.r5.u32);
	// stw r30,264(r31)
	PPC_STORE_U32(r31.u32 + 264, r30.u32);
	// bl 0x8224f818
	ctx.lr = 0x826DF5F8;
...
loc_826DF61C:
	...
	// sth r9,240(r31)
	PPC_STORE_U16(r31.u32 + 240, ctx.r9.u16);
loc_826DF654:
	// addi r1,r1,128
	ctx.r1.s64 = ctx.r1.s64 + 128;
	// lfd f31,-40(r1)
...
PPC_FUNC_IMPL(__imp__sub_826DF700) {
	...
	r12.s64 = 91;
	// lbz r7,284(r31)
	ctx.r7.u64 = PPC_LOAD_U8(r31.u32 + 284);
	// lis r9,-32256
	ctx.r9.s64 = -2113929216;
	// and r6,r8,r12
	ctx.r6.u64 = ctx.r8.u64 & r12.u64;
	// stfs f31,0(r31)
	ctx.fpscr.disableFlushMode();
	temp.f32 = float(f31.f64);
	PPC_STORE_U32(r31.u32 + 0, temp.u32);
	...
	f31.f64 = double(temp.f32);
	// stb r4,242(r31)
	PPC_STORE_U8(r31.u32 + 242, ctx.r4.u8);
	// stfs f31,72(r31)
	temp.f32 = float(f31.f64);
	PPC_STORE_U32(r31.u32 + 72, temp.u32);
	// lbz r3,80(r31)
	...
	// sth r7,240(r31)
	PPC_STORE_U16(r31.u32 + 240, ctx.r7.u16);
	// addi r1,r1,144
	ctx.r1.s64 = ctx.r1.s64 + 144;
	// lfd f30,-64(r1)
	ctx.fpscr.disableFlushModeUnconditional();
