...
PPC_FUNC_IMPL(__imp__sub_823715E8) {
	...
	PPCRegister r11{};
	// lwz r11,6636(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6636);
	// cmpwi cr6,r11,3
	cr6.compare<int32_t>(r11.s32, 3, xer);
	// bne cr6,0x8237163c
	if (!cr6.eq) goto loc_8237163C;
	// lwz r11,6612(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6612);
	// lis r10,12288
	ctx.r10.s64 = 805306368;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x8237161c
	if (cr6.eq) goto loc_8237161C;
	// lwz r11,8(r11)
...
loc_8237161C:
	// lwz r11,6616(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6616);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x8237163c
	if (cr6.eq) goto loc_8237163C;
...
PPC_FUNC_IMPL(__imp__sub_82371648) {
	...
	PPCRegister r11{};
	// lwz r11,6624(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6624);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82371670
	if (cr6.eq) goto loc_82371670;
	// lwz r11,8(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 8);
	// lis r10,12288
	ctx.r10.s64 = 805306368;
...
PPC_FUNC_IMPL(__imp__sub_82371678) {
	...
	// beq cr6,0x823716e8
	if (cr6.eq) goto loc_823716E8;
	// addi r11,r11,3314
	r11.s64 = r11.s64 + 3314;
	...
	// ble cr6,0x823716e8
	if (!cr6.gt) goto loc_823716E8;
	// addi r11,r10,1664
	r11.s64 = ctx.r10.s64 + 1664;
...
loc_823716F4:
	...
	// bne cr6,0x82371708
	if (!cr6.eq) goto loc_82371708;
	// lbz r11,6652(r3)
	r11.u64 = PPC_LOAD_U8(ctx.r3.u32 + 6652);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x8237172c
	if (cr6.eq) goto loc_8237172C;
loc_82371708:
	// addi r11,r10,1650
	r11.s64 = ctx.r10.s64 + 1650;
...
loc_82371788:
	...
	// beq cr6,0x823717f8
	if (cr6.eq) goto loc_823717F8;
	// addi r11,r25,3314
	r11.s64 = r25.s64 + 3314;
	// rlwinm r10,r11,2,0,29
	ctx.r10.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 2) & 0xFFFFFFFC;
	// lwzx r9,r10,r28
...
loc_823717F8:
	...
	r24.s64 = r24.s64 + 10;
	// cmpwi cr6,r27,1650
	cr6.compare<int32_t>(r27.s32, 1650, xer);
	// blt cr6,0x82371770
	if (cr6.lt) goto loc_82371770;
	// addi r1,r1,176
...
PPC_FUNC_IMPL(__imp__sub_82371838) {
	...
	r11.s64 = 5;
	// stw r11,18208(r3)
	PPC_STORE_U32(ctx.r3.u32 + 18208, r11.u32);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_82371868) {
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82371890
	if (!cr6.eq) goto loc_82371890;
	// cmpwi cr6,r4,1
	cr6.compare<int32_t>(ctx.r4.s32, 1, xer);
	// bge cr6,0x82371884
	if (!cr6.lt) goto loc_82371884;
	// li r4,1
	ctx.r4.s64 = 1;
	// b 0x82371890
	goto loc_82371890;
loc_82371884:
	...
	// ble cr6,0x82371890
	if (!cr6.gt) goto loc_82371890;
	// li r4,3
	ctx.r4.s64 = 3;
loc_82371890:
	// addi r11,r4,1650
	r11.s64 = ctx.r4.s64 + 1650;
	// rlwinm r10,r11,2,0,29
	ctx.r10.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 2) & 0xFFFFFFFC;
	// lwzx r10,r10,r3
	...
	// beq cr6,0x823718ec
	if (cr6.eq) goto loc_823718EC;
	// lwz r9,6636(r3)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6636);
	// cmpwi cr6,r9,3
	cr6.compare<int32_t>(ctx.r9.s32, 3, xer);
	// bne cr6,0x823718cc
	if (!cr6.eq) goto loc_823718CC;
	// lwz r11,8(r10)
...
PPC_FUNC_IMPL(__imp__sub_823718F8) {
	...
	cr6.compare<int32_t>(ctx.r10.s32, 3, xer);
	// bne cr6,0x8237194c
	if (!cr6.eq) goto loc_8237194C;
	// lwz r11,6612(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6612);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x8237192c
	if (cr6.eq) goto loc_8237192C;
	// lwz r11,8(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 8);
	// rlwinm r8,r11,0,2,3
...
PPC_FUNC_IMPL(__imp__sub_823719B0) {
	...
	cr6.compare<uint32_t>(ctx.r8.u32, 0, xer);
	// beq cr6,0x82371a30
	if (cr6.eq) goto loc_82371A30;
	// lwz r9,6636(r3)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6636);
	// cmpwi cr6,r9,3
	cr6.compare<int32_t>(ctx.r9.s32, 3, xer);
	// bne cr6,0x82371a10
	if (!cr6.eq) goto loc_82371A10;
	// lwz r11,6612(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6612);
	// lis r10,12288
	ctx.r10.s64 = 805306368;
...
PPC_FUNC_IMPL(__imp__sub_82371A38) {
	...
	r30.u64 = ctx.r3.u64;
	// lbz r11,6652(r30)
	r11.u64 = PPC_LOAD_U8(r30.u32 + 6652);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82371a70
	if (!cr6.eq) goto loc_82371A70;
	// cmpwi cr6,r6,1
	cr6.compare<int32_t>(ctx.r6.s32, 1, xer);
	// bge cr6,0x82371a64
	if (!cr6.lt) goto loc_82371A64;
	// li r6,1
	ctx.r6.s64 = 1;
	// b 0x82371a70
	goto loc_82371A70;
...
loc_82371A70:
	...
	ctx.r9.u64 = __builtin_rotateleft64(ctx.r10.u32 | (ctx.r10.u64 << 32), 2) & 0xFFFFFFFC;
	// lwzx r29,r9,r30
	r29.u64 = PPC_LOAD_U32(ctx.r9.u32 + r30.u32);
	// cmplwi cr6,r29,0
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// beq cr6,0x82371ad0
	if (cr6.eq) goto loc_82371AD0;
	// mr r3,r30
	ctx.r3.u64 = r30.u64;
	// bl 0x82371678
	ctx.lr = 0x82371AA4;
...
PPC_FUNC_IMPL(__imp__sub_82371AE0) {
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82371b08
	if (!cr6.eq) goto loc_82371B08;
	// lwz r11,6640(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 6640);
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// bne cr6,0x82371b0c
	if (!cr6.eq) goto loc_82371B0C;
	// stb r5,6653(r3)
	PPC_STORE_U8(ctx.r3.u32 + 6653, ctx.r5.u8);
	// stb r11,6652(r3)
	PPC_STORE_U8(ctx.r3.u32 + 6652, r11.u8);
	// b 0x82371b0c
	goto loc_82371B0C;
loc_82371B08:
	// stb r10,6652(r3)
...
loc_82371B2C:
	...
	// lwz r11,-8224(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + -8224);
	// lwz r5,12(r11)
