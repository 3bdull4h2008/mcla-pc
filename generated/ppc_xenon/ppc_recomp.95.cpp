...
PPC_FUNC_IMPL(__imp__sub_824D4758) {
	...
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x824d4790
	if (cr6.eq) goto loc_824D4790;
	// lis r11,-32249
	r11.s64 = -2113470464;
	// addi r10,r11,18272
	ctx.r10.s64 = r11.s64 + 18272;
	// stw r10,0(r3)
	PPC_STORE_U32(ctx.r3.u32 + 0, ctx.r10.u32);
	// addi r1,r1,96
	ctx.r1.s64 = ctx.r1.s64 + 96;
...
PPC_FUNC_IMPL(__imp__sub_824D47A8) {
	...
	ctx.r4.u64 = r30.u64;
	// lbz r6,68(r29)
	ctx.r6.u64 = PPC_LOAD_U8(r29.u32 + 68);
	// lwz r5,8(r28)
	ctx.r5.u64 = PPC_LOAD_U32(r28.u32 + 8);
	// lwz r3,20(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + 20);
...
PPC_FUNC_IMPL(__imp__sub_824D4908) {
	...
	r11.s64 = -2104688640;
	// lwz r3,29960(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 29960);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_824D50C0) {
	...
	r11.s64 = -2104688640;
	// lwz r3,29924(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 29924);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_824D50D0) {
	...
	ctx.r4.u64 = r30.u64;
	// lbz r6,108(r29)
	ctx.r6.u64 = PPC_LOAD_U8(r29.u32 + 108);
	// lwz r5,28(r28)
...
PPC_FUNC_IMPL(__imp__sub_824D5330) {
	...
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x824d5368
	if (cr6.eq) goto loc_824D5368;
	// lis r11,-32249
	r11.s64 = -2113470464;
	// addi r10,r11,18468
	ctx.r10.s64 = r11.s64 + 18468;
	// stw r10,0(r3)
	PPC_STORE_U32(ctx.r3.u32 + 0, ctx.r10.u32);
	// addi r1,r1,96
	ctx.r1.s64 = ctx.r1.s64 + 96;
...
PPC_FUNC_IMPL(__imp__sub_824D54A0) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29920
	r31.s64 = r11.s64 + 29920;
	// lwz r11,29920(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29920);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d55f4
...
loc_824D54E0:
	...
	// addi r29,r9,27752
	r29.s64 = ctx.r9.s64 + 27752;
	// lwz r4,20588(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 20588);
	// addi r11,r8,27776
	r11.s64 = ctx.r8.s64 + 27776;
	// li r10,112
	ctx.r10.s64 = 112;
	// li r9,120
	ctx.r9.s64 = 120;
...
PPC_FUNC_IMPL(__imp__sub_824D5600) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29928
	r31.s64 = r11.s64 + 29928;
	// lwz r11,29928(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29928);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d57cc
	if (!cr6.eq) goto loc_824D57CC;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824D5630;
...
PPC_FUNC_IMPL(__imp__sub_824D57E8) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29932
	r31.s64 = r11.s64 + 29932;
	// lwz r11,29932(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29932);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d593c
	if (!cr6.eq) goto loc_824D593C;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824D5810;
...
loc_824D5828:
	...
	// addi r29,r9,28268
	r29.s64 = ctx.r9.s64 + 28268;
	// lwz r4,20588(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 20588);
	// addi r11,r8,28292
	r11.s64 = ctx.r8.s64 + 28292;
	// li r10,20
	ctx.r10.s64 = 20;
	// li r9,16
	ctx.r9.s64 = 16;
...
PPC_FUNC_IMPL(__imp__sub_824D5948) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29936
	r31.s64 = r11.s64 + 29936;
	// lwz r11,29936(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29936);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d5aac
	if (!cr6.eq) goto loc_824D5AAC;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824D5970;
...
loc_824D5988:
	...
	PPC_STORE_U64(r11.u32 + 40, ctx.r6.u64);
	// addi r29,r10,28372
	r29.s64 = ctx.r10.s64 + 28372;
	// addi r6,r9,28408
	ctx.r6.s64 = ctx.r9.s64 + 28408;
	// lwz r4,20588(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 20588);
	// addi r28,r8,28444
	r28.s64 = ctx.r8.s64 + 28444;
	// addi r3,r3,28336
...
PPC_FUNC_IMPL(__imp__sub_824D5AB8) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29940
	r31.s64 = r11.s64 + 29940;
	// lwz r11,29940(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29940);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d5c04
	if (!cr6.eq) goto loc_824D5C04;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824D5AE8;
...
PPC_FUNC_IMPL(__imp__sub_824D5C20) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29944
	r31.s64 = r11.s64 + 29944;
	// lwz r11,29944(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29944);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d5d4c
	if (!cr6.eq) goto loc_824D5D4C;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824D5C50;
...
PPC_FUNC_IMPL(__imp__sub_824D5D68) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29948
	r31.s64 = r11.s64 + 29948;
	// lwz r11,29948(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29948);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d5ea4
	if (!cr6.eq) goto loc_824D5EA4;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824D5D98;
...
PPC_FUNC_IMPL(__imp__sub_824D6018) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29960
	r31.s64 = r11.s64 + 29960;
	// lwz r11,29960(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29960);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d6134
	if (!cr6.eq) goto loc_824D6134;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824D6048;
...
PPC_FUNC_IMPL(__imp__sub_824D6198) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,29924
	r31.s64 = r11.s64 + 29924;
	// lwz r11,29924(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29924);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824d62e4
	if (!cr6.eq) goto loc_824D62E4;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824D61C8;
