...
PPC_FUNC_IMPL(__imp__sub_826CBBC0) {
	...
	ctx.r4.s64 = ctx.r1.s64 + 80;
	// lwz r31,24996(r29)
	r31.u64 = PPC_LOAD_U32(r29.u32 + 24996);
	// addi r3,r31,12
	...
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x826cbc00
	if (cr6.eq) goto loc_826CBC00;
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x826cbc88
	if (!cr6.eq) goto loc_826CBC88;
loc_826CBC00:
	// lwz r10,4(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 4);
	// lwz r11,12(r10)
...
PPC_FUNC_IMPL(__imp__sub_826CBC90) {
	...
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x826cbcd0
	if (cr6.eq) goto loc_826CBCD0;
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x826cbd54
	if (!cr6.eq) goto loc_826CBD54;
loc_826CBCD0:
	// lwz r10,8(r30)
...
PPC_FUNC_IMPL(__imp__sub_826CBD60) {
	...
	r11.u64 = r31.u32 & 0xFF;
	// stb r31,8(r5)
	PPC_STORE_U8(ctx.r5.u32 + 8, r31.u8);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x826cbdc4
	if (cr6.eq) goto loc_826CBDC4;
...
PPC_FUNC_IMPL(__imp__sub_826CBDD8) {
	...
	cr6.compare<uint32_t>(r30.u32, 0, xer);
	// beq cr6,0x826cbe2c
	if (cr6.eq) goto loc_826CBE2C;
	// lbz r11,16(r30)
	r11.u64 = PPC_LOAD_U8(r30.u32 + 16);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x826cbe0c
	if (cr6.eq) goto loc_826CBE0C;
	// lwz r3,0(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + 0);
	// bl 0x82130588
	ctx.lr = 0x826CBE0C;
...
loc_826CBE2C:
	...
	cr6.compare<uint32_t>(r30.u32, 0, xer);
	// beq cr6,0x826cbe6c
	if (cr6.eq) goto loc_826CBE6C;
	// lbz r11,16(r30)
	r11.u64 = PPC_LOAD_U8(r30.u32 + 16);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x826cbe4c
	if (cr6.eq) goto loc_826CBE4C;
	// lwz r3,0(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + 0);
	// bl 0x82130588
	ctx.lr = 0x826CBE4C;
...
loc_826CBE6C:
	...
	cr6.compare<uint32_t>(r30.u32, 0, xer);
	// beq cr6,0x826cbeac
	if (cr6.eq) goto loc_826CBEAC;
	// lbz r11,16(r30)
	r11.u64 = PPC_LOAD_U8(r30.u32 + 16);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x826cbe8c
	if (cr6.eq) goto loc_826CBE8C;
	// lwz r3,0(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + 0);
	// bl 0x82130588
	ctx.lr = 0x826CBE8C;
...
PPC_FUNC_IMPL(__imp__sub_826CBF48) {
	...
	ctx.r4.u64 = r31.u64;
	// lwz r3,24996(r29)
	ctx.r3.u64 = PPC_LOAD_U32(r29.u32 + 24996);
	// bl 0x826cb9f8
	ctx.lr = 0x826CBFAC;
...
PPC_FUNC_IMPL(__imp__sub_826CBFD8) {
	...
	ctx.r9.u64 = PPC_LOAD_U32(r11.u32 + 0);
	// lwz r11,24996(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 24996);
	// addi r3,r11,12
	ctx.r3.s64 = r11.s64 + 12;
	// stw r9,80(r1)
...
loc_826CC1A8:
	...
	r31.s64 = r31.s64 + 4;
	// stb r28,84(r7)
	PPC_STORE_U8(ctx.r7.u32 + 84, r28.u8);
	// lhz r6,128(r30)
	ctx.r6.u64 = PPC_LOAD_U16(r30.u32 + 128);
	// cmpw cr6,r29,r6
	cr6.compare<int32_t>(r29.s32, ctx.r6.s32, xer);
	// blt cr6,0x826cc1a8
	if (cr6.lt) goto loc_826CC1A8;
loc_826CC1E0:
	// li r11,1
	r11.s64 = 1;
	// stb r28,116(r30)
	...
	// stb r11,118(r30)
	PPC_STORE_U8(r30.u32 + 118, r11.u8);
	// addi r1,r1,128
	ctx.r1.s64 = ctx.r1.s64 + 128;
	// b 0x823d9248
	return;
...
PPC_FUNC_IMPL(__imp__sub_826CC1F8) {
	...
	PPCRegister r11{};
	// lhz r11,128(r3)
	r11.u64 = PPC_LOAD_U16(ctx.r3.u32 + 128);
	// li r9,0
	ctx.r9.s64 = 0;
	// mr r10,r9
...
loc_826CC25C:
	...
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
	// lhz r8,128(r31)
	ctx.r8.u64 = PPC_LOAD_U16(r31.u32 + 128);
	// addi r29,r29,1
	r29.s64 = r29.s64 + 1;
	// addi r30,r30,4
	r30.s64 = r30.s64 + 4;
	...
	cr6.compare<int32_t>(r29.s32, ctx.r8.s32, xer);
	// blt cr6,0x826cc25c
	if (cr6.lt) goto loc_826CC25C;
loc_826CC288:
	// lhz r11,136(r31)
	r11.u64 = PPC_LOAD_U16(r31.u32 + 136);
	// li r29,0
	r29.s64 = 0;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x826cc2c8
	if (cr6.eq) goto loc_826CC2C8;
	// li r30,0
	r30.s64 = 0;
loc_826CC29C:
	// lwz r11,132(r31)
	...
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
	// lhz r8,136(r31)
	ctx.r8.u64 = PPC_LOAD_U16(r31.u32 + 136);
	// addi r29,r29,1
	r29.s64 = r29.s64 + 1;
	// addi r30,r30,4
	r30.s64 = r30.s64 + 4;
...
PPC_FUNC_IMPL(__imp__sub_826CC350) {
	...
	cr6.compare<uint32_t>(r28.u32, 0, xer);
	// beq cr6,0x826cc3ec
	if (cr6.eq) goto loc_826CC3EC;
	// cmpwi cr6,r27,0
	cr6.compare<int32_t>(r27.s32, 0, xer);
	// ble cr6,0x826cc3ec
	if (!cr6.gt) goto loc_826CC3EC;
	// lis r11,-32121
	r11.s64 = -2105081856;
	// addi r4,r31,40
...
PPC_FUNC_IMPL(__imp__sub_826CC3F8) {
	...
	r11.u64 = PPC_LOAD_U32(r31.u32 + 0);
	// lbz r10,118(r30)
	ctx.r10.u64 = PPC_LOAD_U8(r30.u32 + 118);
	// stbx r10,r11,r29
	...
	PPC_STORE_U32(r31.u32 + 0, r11.u32);
	// lhz r27,128(r30)
	r27.u64 = PPC_LOAD_U16(r30.u32 + 128);
	// cmpwi cr6,r27,0
	cr6.compare<int32_t>(r27.s32, 0, xer);
	// stwx r27,r11,r29
...
loc_826CC4D8:
	...
	ctx.r5.u64 = r28.u64;
	// lbz r4,119(r31)
	ctx.r4.u64 = PPC_LOAD_U8(r31.u32 + 119);
	// lwzx r3,r11,r29
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + r29.u32);
	// lwz r10,0(r3)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
...
PPC_FUNC_IMPL(__imp__sub_826CC540) {
	...
	r30.s64 = 0;
	// lhz r11,128(r29)
	r11.u64 = PPC_LOAD_U16(r29.u32 + 128);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x826cc590
	if (cr6.eq) goto loc_826CC590;
	// li r31,0
	r31.s64 = 0;
loc_826CC564:
	// lwz r11,124(r29)
	...
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
	// lhz r8,128(r29)
	ctx.r8.u64 = PPC_LOAD_U16(r29.u32 + 128);
	// addi r30,r30,1
	r30.s64 = r30.s64 + 1;
	// addi r31,r31,4
	r31.s64 = r31.s64 + 4;
...
PPC_FUNC_IMPL(__imp__sub_826CC708) {
	...
	ctx.r10.s64 = 1;
	// stb r10,116(r29)
	PPC_STORE_U8(r29.u32 + 116, ctx.r10.u8);
	// lwz r11,-10020(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -10020);
	// lwz r9,360(r11)
	ctx.r9.u64 = PPC_LOAD_U32(r11.u32 + 360);
	...
	cr6.compare<int32_t>(ctx.r9.s32, 0, xer);
	// beq cr6,0x826cc768
	if (cr6.eq) goto loc_826CC768;
	// lis r11,-32244
	r11.s64 = -2113142784;
	// li r4,64
	ctx.r4.s64 = 64;
	// addi r5,r11,-3660
	ctx.r5.s64 = r11.s64 + -3660;
	// addi r3,r1,80
	ctx.r3.s64 = ctx.r1.s64 + 80;
	// bl 0x82137a08
	ctx.lr = 0x826CC748;
...
loc_826CC768:
	// lhz r11,136(r29)
	r11.u64 = PPC_LOAD_U16(r29.u32 + 136);
	// li r30,0
	r30.s64 = 0;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x826cc7a4
	if (cr6.eq) goto loc_826CC7A4;
	// li r31,0
	r31.s64 = 0;
	// lis r28,-32121
	r28.s64 = -2105081856;
loc_826CC780:
	...
	sub_826B5CF0(ctx, base);
	// lhz r10,136(r29)
	ctx.r10.u64 = PPC_LOAD_U16(r29.u32 + 136);
	// addi r30,r30,1
	r30.s64 = r30.s64 + 1;
	// addi r31,r31,4
	r31.s64 = r31.s64 + 4;
...
PPC_FUNC_IMPL(__imp__sub_826CC810) {
	...
	if (cr6.eq) return;
	// stb r10,117(r11)
	PPC_STORE_U8(r11.u32 + 117, ctx.r10.u8);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_826CC8A0) {
	...
	if (!cr6.eq) return;
	// stb r10,118(r11)
	PPC_STORE_U8(r11.u32 + 118, ctx.r10.u8);
	// blr 
	return;
}
