...
PPC_FUNC_IMPL(__imp__sub_824AD130) {
	...
	// bgt cr6,0x824ad24c
	if (cr6.gt) goto loc_824AD24C;
	// lis r12,-32181
	r12.s64 = -2109014016;
	// addi r12,r12,-11856
	r12.s64 = r12.s64 + -11856;
	...
	// lwz r18,-11840(r10)
	r18.u64 = PPC_LOAD_U32(ctx.r10.u32 + -11840);
	// lwz r18,-11832(r10)
	r18.u64 = PPC_LOAD_U32(ctx.r10.u32 + -11832);
	// lwz r18,-11780(r10)
	r18.u64 = PPC_LOAD_U32(ctx.r10.u32 + -11780);
	// lwz r18,-11724(r10)
	r18.u64 = PPC_LOAD_U32(ctx.r10.u32 + -11724);
loc_824AD1C0:
	// li r7,4
	ctx.r7.s64 = 4;
	// b 0x824ad238
...
PPC_FUNC_IMPL(__imp__sub_824AD2E8) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20824
	r31.s64 = r11.s64 + 20824;
	// lwz r11,20824(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20824);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824ad3f8
	if (!cr6.eq) goto loc_824AD3F8;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824AD318;
...
PPC_FUNC_IMPL(__imp__sub_824AD410) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20828
	r31.s64 = r11.s64 + 20828;
	// lwz r11,20828(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20828);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824ad53c
	if (!cr6.eq) goto loc_824AD53C;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824AD440;
...
loc_824AD458:
	...
	PPC_STORE_U64(r11.u32 + 40, ctx.r6.u64);
	// lwz r4,20824(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 20824);
	// cmplwi cr6,r4,0
	cr6.compare<uint32_t>(ctx.r4.u32, 0, xer);
	// stw r10,8(r9)
	PPC_STORE_U32(ctx.r9.u32 + 8, ctx.r10.u32);
...
PPC_FUNC_IMPL(__imp__sub_824AD558) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20832
	r31.s64 = r11.s64 + 20832;
	// lwz r11,20832(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20832);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824ad684
	if (!cr6.eq) goto loc_824AD684;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824AD588;
...
PPC_FUNC_IMPL(__imp__sub_824AD6A0) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20836
	r31.s64 = r11.s64 + 20836;
	// lwz r11,20836(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20836);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824ad7cc
	if (!cr6.eq) goto loc_824AD7CC;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824AD6D0;
...
PPC_FUNC_IMPL(__imp__sub_824AD7E8) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20840
	r31.s64 = r11.s64 + 20840;
	// lwz r11,20840(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20840);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824ad914
	if (!cr6.eq) goto loc_824AD914;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824AD818;
...
PPC_FUNC_IMPL(__imp__sub_824AD930) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20844
	r31.s64 = r11.s64 + 20844;
	// lwz r11,20844(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20844);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824ada5c
	if (!cr6.eq) goto loc_824ADA5C;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824AD960;
...
PPC_FUNC_IMPL(__imp__sub_824ADA78) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20848
	r31.s64 = r11.s64 + 20848;
	// lwz r11,20848(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20848);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824adba4
	if (!cr6.eq) goto loc_824ADBA4;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824ADAA8;
...
PPC_FUNC_IMPL(__imp__sub_824ADBC0) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20852
	r31.s64 = r11.s64 + 20852;
	// lwz r11,20852(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20852);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824add74
	if (!cr6.eq) goto loc_824ADD74;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824ADBE8;
...
PPC_FUNC_IMPL(__imp__sub_824ADD80) {
	...
	r11.s64 = -2104688640;
	// addi r31,r11,20856
	r31.s64 = r11.s64 + 20856;
	// lwz r11,20856(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 20856);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x824adec0
	if (!cr6.eq) goto loc_824ADEC0;
	// li r3,64
	ctx.r3.s64 = 64;
	// bl 0x82130528
	ctx.lr = 0x824ADDA8;
...
loc_824ADE3C:
	...
	// lwz r4,20824(r29)
	ctx.r4.u64 = PPC_LOAD_U32(r29.u32 + 20824);
	// cmplwi cr6,r4,0
	cr6.compare<uint32_t>(ctx.r4.u32, 0, xer);
	// bne cr6,0x824ade58
	if (!cr6.eq) goto loc_824ADE58;
	// bl 0x824ad2e8
	ctx.lr = 0x824ADE54;
	sub_824AD2E8(ctx, base);
	// lwz r4,20824(r29)
...
loc_824ADE58:
	...
	sub_821D4458(ctx, base);
	// lwz r11,20824(r29)
	r11.u64 = PPC_LOAD_U32(r29.u32 + 20824);
	// li r5,0
	ctx.r5.s64 = 0;
	// addi r3,r1,88
	ctx.r3.s64 = ctx.r1.s64 + 88;
