...
PPC_FUNC_IMPL(__imp__sub_8215C4E0) {
	...
	PPCRegister temp{};
	// lhz r11,228(r3)
	r11.u64 = PPC_LOAD_U16(ctx.r3.u32 + 228);
	// lis r10,-32256
...
loc_8215C714:
	...
	// lbz r5,235(r31)
	ctx.r5.u64 = PPC_LOAD_U8(r31.u32 + 235);
	// addi r4,r11,7216
	...
	cr6.compare<uint32_t>(r11.u32, 4, xer);
	// bne cr6,0x8215c7e8
	if (!cr6.eq) goto loc_8215C7E8;
	// cmpwi cr6,r7,0
	cr6.compare<int32_t>(ctx.r7.s32, 0, xer);
	// blt cr6,0x8215c7d4
	if (cr6.lt) goto loc_8215C7D4;
	// lwz r11,196(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 196);
	// cmpw cr6,r30,r11
	cr6.compare<int32_t>(r30.s32, r11.s32, xer);
	// ble cr6,0x8215c77c
	if (!cr6.gt) goto loc_8215C77C;
	// lbz r11,236(r31)
...
loc_8215C814:
	...
	ctx.f12.f64 = double(ctx.f13.s64);
	// stb r10,234(r31)
	PPC_STORE_U8(r31.u32 + 234, ctx.r10.u8);
	// frsp f11,f12
	ctx.f11.f64 = double(float(ctx.f12.f64));
	// li r3,1
	ctx.r3.s64 = 1;
...
loc_8215C894:
	...
	ctx.r9.s64 = r30.s32;
	// stb r8,234(r31)
	PPC_STORE_U8(r31.u32 + 234, ctx.r8.u8);
	// extsw r7,r11
	ctx.r7.s64 = r11.s32;
	// std r9,96(r1)
...
loc_8215C9B0:
	...
	// stb r10,141(r31)
	PPC_STORE_U8(r31.u32 + 141, ctx.r10.u8);
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// stw r8,152(r31)
...
loc_8215CA78:
	...
	r11.s64 = 255;
	// stb r11,235(r31)
	PPC_STORE_U8(r31.u32 + 235, r11.u8);
loc_8215CA98:
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// bl 0x8213ba48
...
loc_8215CB18:
	...
	// bdnz 0x8215cb18
	--ctr.u64;
	if (ctr.u32 != 0) goto loc_8215CB18;
	// lbz r10,64(r31)
	ctx.r10.u64 = PPC_LOAD_U8(r31.u32 + 64);
	// lwz r11,232(r29)
	...
	// lwz r4,45(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 45);
	// cmpwi cr6,r4,-1
	cr6.compare<int32_t>(ctx.r4.s32, -1, xer);
	// beq cr6,0x8215cbcc
	if (cr6.eq) goto loc_8215CBCC;
	// cmpwi cr6,r4,0
...
loc_8215CBCC:
	...
	// sth r9,230(r31)
	PPC_STORE_U16(r31.u32 + 230, ctx.r9.u16);
	// lbz r8,4(r30)
	ctx.r8.u64 = PPC_LOAD_U8(r30.u32 + 4);
	// stb r8,232(r31)
	PPC_STORE_U8(r31.u32 + 232, ctx.r8.u8);
	// lwz r7,5(r30)
	ctx.r7.u64 = PPC_LOAD_U32(r30.u32 + 5);
	// stw r7,220(r31)
	PPC_STORE_U32(r31.u32 + 220, ctx.r7.u32);
	// lwz r6,9(r30)
	ctx.r6.u64 = PPC_LOAD_U32(r30.u32 + 9);
	// stw r6,224(r31)
	PPC_STORE_U32(r31.u32 + 224, ctx.r6.u32);
	// lwz r4,25(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 25);
	// lwz r5,20(r10)
	...
	ctx.r3.u64 = r31.u64;
	// lwz r4,29(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 29);
	// lwz r10,20(r11)
	...
	ctx.r3.u64 = r31.u64;
	// lwz r4,37(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 37);
	// lwz r8,20(r9)
	...
	ctx.r3.u64 = r31.u64;
	// lwz r4,33(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 33);
	// lwz r6,20(r7)
	...
	ctx.r3.u64 = r31.u64;
	// lwz r4,41(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 41);
	// lwz r11,20(r5)
	...
	// lwz r4,17(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 17);
	// bl 0x82164840
	ctx.lr = 0x8215CC98;
	sub_82164840(ctx, base);
	// addi r3,r28,80
	...
	// lwz r4,21(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 21);
	// bl 0x82164840
	ctx.lr = 0x8215CCA4;
	sub_82164840(ctx, base);
	// lbz r10,38(r28)
	ctx.r10.u64 = PPC_LOAD_U8(r28.u32 + 38);
	// cmplwi cr6,r10,0
	...
	if (cr6.eq) goto loc_8215CCCC;
	// lbz r11,78(r28)
	r11.u64 = PPC_LOAD_U8(r28.u32 + 78);
	// li r3,1
	ctx.r3.s64 = 1;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x8215ccd0
	if (!cr6.eq) goto loc_8215CCD0;
loc_8215CCCC:
	// li r3,0
	ctx.r3.s64 = 0;
loc_8215CCD0:
...
loc_8215CD20:
	...
	// blt cr6,0x8215cd68
	if (cr6.lt) goto loc_8215CD68;
	// lbz r9,56(r31)
	ctx.r9.u64 = PPC_LOAD_U8(r31.u32 + 56);
	// lbz r8,236(r31)
	ctx.r8.u64 = PPC_LOAD_U8(r31.u32 + 236);
	// lbz r7,234(r31)
	ctx.r7.u64 = PPC_LOAD_U8(r31.u32 + 234);
	// ori r6,r9,2
	...
	// stb r9,234(r31)
	PPC_STORE_U8(r31.u32 + 234, ctx.r9.u8);
	// stw r8,196(r31)
...
loc_8215CD68:
	...
	// stb r6,236(r31)
	PPC_STORE_U8(r31.u32 + 236, ctx.r6.u8);
loc_8215CD98:
	// addi r1,r1,128
	ctx.r1.s64 = ctx.r1.s64 + 128;
	// lwz r12,-8(r1)
...
PPC_FUNC_IMPL(__imp__sub_8215CDB0) {
	...
	// lbz r8,235(r30)
	ctx.r8.u64 = PPC_LOAD_U8(r30.u32 + 235);
	// mulli r9,r10,11488
	ctx.r9.s64 = ctx.r10.s64 * 11488;
	// lwz r11,232(r31)
	...
	ctx.r10.s64 = int64_t(ctx.r8.s32) * int64_t(ctx.r10.s32);
	// lwz r9,11444(r11)
	ctx.r9.u64 = PPC_LOAD_U32(r11.u32 + 11444);
	// add r29,r10,r9
	...
	// bne cr6,0x8215ceb4
	if (!cr6.eq) goto loc_8215CEB4;
	// lbz r10,72(r30)
	ctx.r10.u64 = PPC_LOAD_U8(r30.u32 + 72);
	// cmplwi cr6,r10,255
	cr6.compare<uint32_t>(ctx.r10.u32, 255, xer);
	// beq cr6,0x8215cea8
	if (cr6.eq) goto loc_8215CEA8;
	// lwz r9,196(r31)
...
loc_8215CEB4:
	...
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// bne cr6,0x8215cf04
	if (!cr6.eq) goto loc_8215CF04;
	// lbz r8,72(r30)
	ctx.r8.u64 = PPC_LOAD_U8(r30.u32 + 72);
	// cmplwi cr6,r8,255
	cr6.compare<uint32_t>(ctx.r8.u32, 255, xer);
	// beq cr6,0x8215cef0
	if (cr6.eq) goto loc_8215CEF0;
	// lwz r10,196(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 196);
	// lwz r9,11440(r11)
...
PPC_FUNC_IMPL(__imp__sub_8215CF10) {
	...
	cr6.compare<uint32_t>(ctx.r8.u32, 0, xer);
	// bne cr6,0x8215cf7c
	if (!cr6.eq) goto loc_8215CF7C;
loc_8215CF60:
	// cmplwi cr6,r29,0
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// beq cr6,0x8215cf70
	if (cr6.eq) goto loc_8215CF70;
	// li r11,0
	r11.s64 = 0;
	// stb r11,0(r29)
...
loc_8215CFF8:
	...
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// bne cr6,0x8215d018
	if (!cr6.eq) goto loc_8215D018;
	// cmpwi cr6,r30,0
	cr6.compare<int32_t>(r30.s32, 0, xer);
	// blt cr6,0x8215d018
	if (cr6.lt) goto loc_8215D018;
	// cmpw cr6,r30,r11
	cr6.compare<int32_t>(r30.s32, r11.s32, xer);
	// bge cr6,0x8215d018
	if (!cr6.lt) goto loc_8215D018;
...
loc_8215D0A8:
	...
	cr6.compare<uint32_t>(r11.u32, 4, xer);
	// bne cr6,0x8215d0e0
	if (!cr6.eq) goto loc_8215D0E0;
	// lwz r11,80(r1)
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 80);
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// bge cr6,0x8215d0e0
	if (!cr6.lt) goto loc_8215D0E0;
	// lbz r11,233(r31)
...
loc_8215D1C8:
	...
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x8215d1fc
	if (cr6.eq) goto loc_8215D1FC;
	// stb r3,233(r31)
	PPC_STORE_U8(r31.u32 + 233, ctx.r3.u8);
	// b 0x8215d1fc
	goto loc_8215D1FC;
loc_8215D1EC:
	// cmplwi cr6,r11,2
...
PPC_FUNC_IMPL(__imp__sub_8215D220) {
	...
	ctx.r10.u64 = PPC_LOAD_U8(r31.u32 + 64);
	// lbz r8,235(r31)
	ctx.r8.u64 = PPC_LOAD_U8(r31.u32 + 235);
	// mulli r9,r10,11488
	ctx.r9.s64 = ctx.r10.s64 * 11488;
	// lwz r10,232(r30)
	ctx.r10.u64 = PPC_LOAD_U32(r30.u32 + 232);
	...
	r11.u64 = ctx.r10.u64 + r11.u64;
	// lbz r6,161(r11)
	ctx.r6.u64 = PPC_LOAD_U8(r11.u32 + 161);
	// cmplwi cr6,r6,0
	cr6.compare<uint32_t>(ctx.r6.u32, 0, xer);
	// beq cr6,0x8215d2a0
	if (cr6.eq) goto loc_8215D2A0;
	// lhz r10,156(r11)
	...
	// sth r10,228(r31)
	PPC_STORE_U16(r31.u32 + 228, ctx.r10.u16);
	// lhz r7,158(r11)
	ctx.r7.u64 = PPC_LOAD_U16(r11.u32 + 158);
	// sth r7,230(r31)
	PPC_STORE_U16(r31.u32 + 230, ctx.r7.u16);
	// lbz r6,160(r11)
	ctx.r6.u64 = PPC_LOAD_U8(r11.u32 + 160);
	// stb r6,232(r31)
	PPC_STORE_U8(r31.u32 + 232, ctx.r6.u8);
	// lwz r5,144(r11)
...
loc_8215D2A0:
	// lhz r11,228(r31)
	r11.u64 = PPC_LOAD_U16(r31.u32 + 228);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x8215d318
	if (!cr6.eq) goto loc_8215D318;
	// lhz r11,230(r31)
...
loc_8215D318:
	...
	// stb r10,233(r31)
	PPC_STORE_U8(r31.u32 + 233, ctx.r10.u8);
	// stb r9,236(r31)
	PPC_STORE_U8(r31.u32 + 236, ctx.r9.u8);
loc_8215D32C:
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// bl 0x8215c5b8
...
PPC_FUNC_IMPL(__imp__sub_8215D490) {
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x8215d544
	if (!cr6.eq) goto loc_8215D544;
	// cmplwi cr6,r8,255
	cr6.compare<uint32_t>(ctx.r8.u32, 255, xer);
	// beq cr6,0x8215d530
	if (cr6.eq) goto loc_8215D530;
	// lbz r11,64(r30)
...
loc_8215D544:
	...
	ctx.f7.f64 = double(float(ctx.f8.f64 * ctx.f13.f64));
	// fsel f1,f9,f7,f0
	ctx.f1.f64 = ctx.f9.f64 >= 0.0 ? ctx.f7.f64 : f0.f64;
	// beq cr6,0x8215d5dc
	if (cr6.eq) goto loc_8215D5DC;
	// lbz r11,64(r30)
	r11.u64 = PPC_LOAD_U8(r30.u32 + 64);
	// lwz r10,232(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 232);
