...
## Context Budget
The active model has a 220k window and **auto-compaction/pruning are disabled** in this project so long conversations are never silently summarized. That makes context discipline mandatory, not optional.
...
3. Update `docs/ARCHITECTURE.md` if phase landed
