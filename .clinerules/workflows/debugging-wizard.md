...
(Ported from `.opencode/skills/debugging-wizard.md`)
...
- RenderDoc/PIX capture for frame analysis (MCP servers `renderdoc` / `pix` in Cline)
- `ghidra` MCP for guest memory forensics
